...
@dataclass(kw_only=True)
class BrDecisionPendingElemType:
    class Meta:
        name = "brDecisionPendingElemType"


class BrDecisionPointPriorityAttType(Enum):
    BRPR01 = "brpr01"
    BRPR02 = "brpr02"
    BRPR03 = "brpr03"
    BRPR04 = "brpr04"
...
class BrDecisionValueSelectionAttType(Enum):
    SINGLE = "single"
    MULTIPLE = "multiple"


@dataclass(kw_only=True)
class BrRequiredDateElemType:
    class Meta:
        name = "brRequiredDateElemType"
...
class BrSeverityLevelAttType(Enum):
    BRSL01 = "brsl01"
    BRSL02 = "brsl02"
    BRSL03 = "brsl03"
    BRSL04 = "brsl04"
...
@dataclass(kw_only=True)
class BrStatusDateElemType:
    class Meta:
        name = "brStatusDateElemType"
...
@dataclass(kw_only=True)
class NarrativeExampleElemType:
    class Meta:
        name = "narrativeExampleElemType"
...
@dataclass(kw_only=True)
class BrDecisionPending(BrDecisionPendingElemType):
    class Meta:
        name = "brDecisionPending"


@dataclass(kw_only=True)
class BrRequiredDate(BrRequiredDateElemType):
    class Meta:
        name = "brRequiredDate"


@dataclass(kw_only=True)
class BrStatusDate(BrStatusDateElemType):
    class Meta:
        name = "brStatusDate"
...
@dataclass(kw_only=True)
class ConfigAttributesElemType:
    class Meta:
        name = "configAttributesElemType"

    access_point_type_value_att_relation: str = field(
        default="0",
        metadata={
            "name": "accessPointTypeValueAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    acronym_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "acronymTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    action_ident_type_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "actionIdentTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    bar_code_symbology_att_relation: str = field(
        default="0",
        metadata={
            "name": "barCodeSymbologyAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    br_decision_point_priority_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "brDecisionPointPriorityAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    br_severity_level_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "brSeverityLevelAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    br_status_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "brStatusAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    cancel_caption_att_relation: str = field(
        default="0",
        metadata={
            "name": "cancelCaptionAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    caveat_att_relation: str = field(
        default="0",
        metadata={
            "name": "caveatAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    check_list_category_att_relation: str = field(
        default="0",
        metadata={
            "name": "checkListCategoryAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    circuit_breaker_ref_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "circuitBreakerRefTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    circuit_breaker_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "circuitBreakerTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    color_att_relation: str = field(
        default="0",
        metadata={
            "name": "colorAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    comment_priority_code_att_relation: str = field(
        default="0",
        metadata={
            "name": "commentPriorityCodeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    commercial_classification_att_relation: str = field(
        default="0",
        metadata={
            "name": "commercialClassificationAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    control_authority_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "controlAuthorityTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    crew_member_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "crewMemberTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    crew_step_condition_att_relation: str = field(
        default="0",
        metadata={
            "name": "crewStepConditionAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    default_br_severity_level_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "defaultBrSeverityLevelAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    drill_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "drillTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    emphasis_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "emphasisTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    front_matter_info_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "frontMatterInfoTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    front_matter_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "frontMatterTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    function_att_relation: str = field(
        default="0",
        metadata={
            "name": "functionAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    functional_item_ref_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "functionalItemRefTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    functional_item_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "functionalItemTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    generic_property_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "genericPropertyTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    hazardous_class_value_att_relation: str = field(
        default="0",
        metadata={
            "name": "hazardousClassValueAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    icn_info_item_type_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "icnInfoItemTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    icn_resource_file_type_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "icnResourceFileTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    icn_source_file_type_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "icnSourceFileTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    installation_location_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "installationLocationTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    internal_ref_target_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "internalRefTargetTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    item_characteristic_att_relation: str = field(
        default="0",
        metadata={
            "name": "itemCharacteristicAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    item_originator_att_relation: str = field(
        default="0",
        metadata={
            "name": "itemOriginatorAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    limit_unit_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "limitUnitTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    list_item_prefix_att_relation: str = field(
        default="0",
        metadata={
            "name": "listItemPrefixAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    lowest_level_att_relation: str = field(
        default="0",
        metadata={
            "name": "lowestLevelAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    maint_level_code_att_relation: str = field(
        default="0",
        metadata={
            "name": "maintLevelCodeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    material_usage_att_relation: str = field(
        default="0",
        metadata={
            "name": "materialUsageAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    operation_type_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "operationTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    part_characteristic_att_relation: str = field(
        default="0",
        metadata={
            "name": "partCharacteristicAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    part_status_att_relation: str = field(
        default="0",
        metadata={
            "name": "partStatusAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    part_usage_code_att_relation: str = field(
        default="0",
        metadata={
            "name": "partUsageCodeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    pm_entry_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "pmEntryTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    pm_type_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "pmTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    product_category_att_relation: str = field(
        default="0",
        metadata={
            "name": "productCategoryAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    product_item_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "productItemTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    quantity_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "quantityTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    quantity_unit_of_measure_att_relation: str = field(
        default="0",
        metadata={
            "name": "quantityUnitOfMeasureAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    reference_usage_att_relation: str = field(
        default="0",
        metadata={
            "name": "referenceUsageAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    ref_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "refTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    req_cond_category_att_relation: str = field(
        default="0",
        metadata={
            "name": "reqCondCategoryAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    req_tech_info_category_att_relation: str = field(
        default="0",
        metadata={
            "name": "reqTechInfoCategoryAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    reset_caption_att_relation: str = field(
        default="0",
        metadata={
            "name": "resetCaptionAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    response_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "responseTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    sb_compliance_category_att_relation: str = field(
        default="0",
        metadata={
            "name": "sbComplianceCategoryAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    sb_impact_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "sbImpactTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    sb_material_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "sbMaterialTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    sb_task_category_att_relation: str = field(
        default="0",
        metadata={
            "name": "sbTaskCategoryAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    sb_time_compliance_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "sbTimeComplianceTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    sb_topic_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "sbTopicTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    sco_entry_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "scoEntryTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    security_classification_att_relation: str = field(
        default="0",
        metadata={
            "name": "securityClassificationAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    significant_para_data_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "significantParaDataTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    skill_level_code_att_relation: str = field(
        default="0",
        metadata={
            "name": "skillLevelCodeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    skill_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "skillTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    software_classification_value_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "softwareClassificationValueAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    software_customization_status_value_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "softwareCustomizationStatusValueAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    source_criticality_att_relation: str = field(
        default="0",
        metadata={
            "name": "sourceCriticalityAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    source_type_code_att_relation: str = field(
        default="0",
        metadata={
            "name": "sourceTypeCodeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    sourcing_type_value_att_relation: None | str = field(
        default=None,
        metadata={
            "name": "sourcingTypeValueAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    submit_caption_att_relation: str = field(
        default="0",
        metadata={
            "name": "submitCaptionAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    supervisor_level_code_att_relation: str = field(
        default="0",
        metadata={
            "name": "supervisorLevelCodeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    supplemental_safety_category_att_relation: str = field(
        default="0",
        metadata={
            "name": "supplementalSafetyCategoryAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    supply_category_att_relation: str = field(
        default="0",
        metadata={
            "name": "supplyCategoryAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    supply_number_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "supplyNumberTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    task_code_att_relation: str = field(
        default="0",
        metadata={
            "name": "taskCodeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    term_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "termTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    threshold_frequency_start_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "thresholdFrequencyStartTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    threshold_unit_of_measure_att_relation: str = field(
        default="0",
        metadata={
            "name": "thresholdUnitOfMeasureAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    update_reason_type_att_relation: str = field(
        default="0",
        metadata={
            "name": "updateReasonTypeAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    verbatim_style_att_relation: str = field(
        default="0",
        metadata={
            "name": "verbatimStyleAttRelation",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
...
@dataclass(kw_only=True)
class NarrativeExample(NarrativeExampleElemType):
    class Meta:
        name = "narrativeExample"
...
@dataclass(kw_only=True)
class S1000DSchemasElemType:
    class Meta:
        name = "s1000dSchemasElemType"

    appliccrossreftable_xsd: str = field(
        default="0",
        metadata={
            "name": "appliccrossreftableXsd",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    ...
    condcrossreftable_xsd: str = field(
        default="0",
        metadata={
            "name": "condcrossreftableXsd",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    container_xsd: str = field(
        default="0",
        metadata={
            "name": "containerXsd",
            "type": "Attribute",
    ...
    prdcrossreftable_xsd: str = field(
        default="0",
        metadata={
            "name": "prdcrossreftableXsd",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    proced_xsd: str = field(
        default="0",
        metadata={
            "name": "procedXsd",
            "type": "Attribute",
    ...
    scormcontentpackage_xsd: str = field(
        default="0",
        metadata={
            "name": "scormcontentpackageXsd",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    update_xsd: str = field(
        default="0",
        metadata={
            "name": "updateXsd",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class ConfigAttributes(ConfigAttributesElemType):
    class Meta:
...
@dataclass(kw_only=True)
class S1000DSchemas(S1000DSchemasElemType):
    class Meta:
        name = "s1000dSchemas"
...
@dataclass(kw_only=True)
class MarkupExampleElemType:
    class Meta:
        name = "markupExampleElemType"
...
@dataclass(kw_only=True)
class MarkupExample(MarkupExampleElemType):
    class Meta:
        name = "markupExample"
...
@dataclass(kw_only=True)
class ExampleElemType:
    class Meta:
        name = "exampleElemType"

    markup_example: list[MarkupExample] = field(
        default_factory=list,
        metadata={
            "name": "markupExample",
            "type": "Element",
    ...
    narrative_example: list[NarrativeExample] = field(
        default_factory=list,
        metadata={
            "name": "narrativeExample",
            "type": "Element",
...
@dataclass(kw_only=True)
class SourceDocRefElemType:
    class Meta:
        name = "sourceDocRefElemType"
...
@dataclass(kw_only=True)
class SourceDocRef(SourceDocRefElemType):
    class Meta:
        name = "sourceDocRef"
...
@dataclass(kw_only=True)
class BrDecisionPointRefElemType:
    class Meta:
        name = "brDecisionPointRefElemType"
    ...
    br_decision_point_unique_ident: None | str = field(
        default=None,
        metadata={
            "name": "brDecisionPointUniqueIdent",
            "type": "Attribute",
            "pattern": r"BRDP-(S1-|[A-Za-z0-9]{1,20})-[0-9]{5}",
        },
    )
    id: None | str = field(
        default=None,
...
@dataclass(kw_only=True)
class BrDecisionRefElemType:
    class Meta:
        name = "brDecisionRefElemType"
    ...
    br_decision_ident_number: None | str = field(
        default=None,
        metadata={
            "name": "brDecisionIdentNumber",
            "type": "Attribute",
        },
    )
    id: None | str = field(
...
@dataclass(kw_only=True)
class BrDecisionPointRef(BrDecisionPointRefElemType):
    class Meta:
        name = "brDecisionPointRef"


@dataclass(kw_only=True)
class BrDecisionRef(BrDecisionRefElemType):
    class Meta:
        name = "brDecisionRef"
...
@dataclass(kw_only=True)
class BrCurrentStatusElemType:
    class Meta:
        name = "brCurrentStatusElemType"

    br_decision_ref: list[BrDecisionRef] = field(
        default_factory=list,
        metadata={
            "name": "brDecisionRef",
            "type": "Element",
    ...
    br_decision_point_ref: list[BrDecisionPointRef] = field(
        default_factory=list,
        metadata={
            "name": "brDecisionPointRef",
            "type": "Element",
    ...
    br_required_date: None | BrRequiredDate = field(
        default=None,
        metadata={
            "name": "brRequiredDate",
            "type": "Element",
    ...
    br_status_date: None | BrStatusDate = field(
        default=None,
        metadata={
            "name": "brStatusDate",
            "type": "Element",
    ...
    br_status: BrStatusAttType = field(
        metadata={
            "name": "brStatus",
            "type": "Attribute",
        }
    )
    br_decision_point_ref_unique_ident: None | str = field(
        default=None,
        metadata={
            "name": "brDecisionPointRefUniqueIdent",
            "type": "Attribute",
            "pattern": r"BRDP-(S1-|[A-Za-z0-9]{1,20})-[0-9]{5}",
        },
    )
...
@dataclass(kw_only=True)
class BrCurrentStatus(BrCurrentStatusElemType):
    class Meta:
        name = "brCurrentStatus"
...
@dataclass(kw_only=True)
class BrCategoryDescriptionElemType:
    class Meta:
        name = "brCategoryDescriptionElemType"
...
@dataclass(kw_only=True)
class BrDecisionPointValueElemType:
    class Meta:
        name = "brDecisionPointValueElemType"
    ...
    br_decision_value_allowed: str = field(
        metadata={
            "name": "brDecisionValueAllowed",
            "type": "Attribute",
        }
    )
...
@dataclass(kw_only=True)
class BrDecisionValueElemType:
    class Meta:
        name = "brDecisionValueElemType"
    ...
    br_decision_value_registered: str = field(
        metadata={
            "name": "brDecisionValueRegistered",
            "type": "Attribute",
        }
    )
...
@dataclass(kw_only=True)
class BrCategoryDescription(BrCategoryDescriptionElemType):
    class Meta:
        name = "brCategoryDescription"


@dataclass(kw_only=True)
class BrDecisionPointValue(BrDecisionPointValueElemType):
    class Meta:
        name = "brDecisionPointValue"


@dataclass(kw_only=True)
class BrDecisionValue(BrDecisionValueElemType):
    class Meta:
        name = "brDecisionValue"
...
@dataclass(kw_only=True)
class BrDecisionPointValueGroupElemType:
    class Meta:
        name = "brDecisionPointValueGroupElemType"

    br_decision_point_value: list[BrDecisionPointValue] = field(
        default_factory=list,
        metadata={
            "name": "brDecisionPointValue",
            "type": "Element",
    ...
    br_decision_value_selection: BrDecisionValueSelectionAttType = field(
        metadata={
            "name": "brDecisionValueSelection",
            "type": "Attribute",
        }
    )
...
@dataclass(kw_only=True)
class BrDecisionValueGroupElemType:
    class Meta:
        name = "brDecisionValueGroupElemType"

    br_decision_value: list[BrDecisionValue] = field(
        default_factory=list,
        metadata={
            "name": "brDecisionValue",
            "type": "Element",
...
@dataclass(kw_only=True)
class BrDecisionPointValueGroup(BrDecisionPointValueGroupElemType):
    class Meta:
        name = "brDecisionPointValueGroup"


@dataclass(kw_only=True)
class BrDecisionValueGroup(BrDecisionValueGroupElemType):
    class Meta:
        name = "brDecisionValueGroup"
...
@dataclass(kw_only=True)
class BrCategoryElemType:
    class Meta:
        name = "brCategoryElemType"
    ...
    br_category_description: None | BrCategoryDescription = field(
        default=None,
        metadata={
            "name": "brCategoryDescription",
            "type": "Element",
    ...
    br_category_number: None | str = field(
        default=None,
        metadata={
            "name": "brCategoryNumber",
            "type": "Attribute",
        },
    )
    id: None | str = field(
...
@dataclass(kw_only=True)
class BrCategory(BrCategoryElemType):
    class Meta:
        name = "brCategory"
...
@dataclass(kw_only=True)
class BrCategoryGroupElemType:
    class Meta:
        name = "brCategoryGroupElemType"

    br_category: list[BrCategory] = field(
        default_factory=list,
        metadata={
            "name": "brCategory",
            "type": "Element",
...
@dataclass(kw_only=True)
class BrCategoryGroup(BrCategoryGroupElemType):
    class Meta:
        name = "brCategoryGroup"
...
@dataclass(kw_only=True)
class BrRelatedToElemType:
    class Meta:
        name = "brRelatedToElemType"

    source_doc_ref: SourceDocRef = field(
        metadata={
            "name": "sourceDocRef",
            "type": "Element",
        }
    )
    br_category_group: BrCategoryGroup = field(
        metadata={
            "name": "brCategoryGroup",
            "type": "Element",
        }
    )
    s1000d_schemas: None | S1000DSchemas = field(
        default=None,
        metadata={
            "name": "s1000dSchemas",
            "type": "Element",
    ...
    config_attributes: None | ConfigAttributes = field(
        default=None,
        metadata={
            "name": "configAttributes",
            "type": "Element",
...
@dataclass(kw_only=True)
class BrRelatedTo(BrRelatedToElemType):
    class Meta:
        name = "brRelatedTo"
...
@dataclass(kw_only=True)
class BrDecisionTextElemType:
    class Meta:
        name = "brDecisionTextElemType"
...
@dataclass(kw_only=True)
class BrDecisionText(BrDecisionTextElemType):
    class Meta:
        name = "brDecisionText"
...
@dataclass(kw_only=True)
class BrActionElemType:
    class Meta:
        name = "brActionElemType"
    ...
    br_action_owner: str = field(
        metadata={
            "name": "brActionOwner",
            "type": "Attribute",
        }
    )
    br_action_completed: None | str = field(
        default=None,
        metadata={
            "name": "brActionCompleted",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
...
@dataclass(kw_only=True)
class BrDecisionExplanationElemType:
    class Meta:
        name = "brDecisionExplanationElemType"
...
@dataclass(kw_only=True)
class BrDecisionPointExplanationElemType:
    class Meta:
        name = "brDecisionPointExplanationElemType"
...
@dataclass(kw_only=True)
class BrDecisionPointTextElemType:
    class Meta:
        name = "brDecisionPointTextElemType"
...
@dataclass(kw_only=True)
class BrAction(BrActionElemType):
    class Meta:
        name = "brAction"


@dataclass(kw_only=True)
class BrDecisionExplanation(BrDecisionExplanationElemType):
    class Meta:
        name = "brDecisionExplanation"


@dataclass(kw_only=True)
class BrDecisionPointExplanation(BrDecisionPointExplanationElemType):
    class Meta:
        name = "brDecisionPointExplanation"


@dataclass(kw_only=True)
class BrDecisionPointText(BrDecisionPointTextElemType):
    class Meta:
        name = "brDecisionPointText"
...
@dataclass(kw_only=True)
class BrAuditElemType:
    class Meta:
        name = "brAuditElemType"
    ...
    br_current_status: BrCurrentStatus = field(
        metadata={
            "name": "brCurrentStatus",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class BrDecisionElemType:
    class Meta:
        name = "brDecisionElemType"
    ...
    br_decision_pending: None | BrDecisionPending = field(
        default=None,
        metadata={
            "name": "brDecisionPending",
            "type": "Element",
    ...
    br_decision_text: None | BrDecisionText = field(
        default=None,
        metadata={
            "name": "brDecisionText",
            "type": "Element",
    ...
    br_decision_value_group: None | BrDecisionValueGroup = field(
        default=None,
        metadata={
            "name": "brDecisionValueGroup",
            "type": "Element",
    ...
    br_decision_explanation: None | BrDecisionExplanation = field(
        default=None,
        metadata={
            "name": "brDecisionExplanation",
            "type": "Element",
    ...
    br_severity_level: None | BrSeverityLevelAttType = field(
        default=None,
        metadata={
            "name": "brSeverityLevel",
            "type": "Attribute",
        },
    )
    change_type: None | ChangeTypeAttType = field(
...
@dataclass(kw_only=True)
class BrDecisionPointContentElemType:
    class Meta:
        name = "brDecisionPointContentElemType"
    ...
    br_decision_point_text: BrDecisionPointText = field(
        metadata={
            "name": "brDecisionPointText",
            "type": "Element",
        }
    )
    br_decision_point_value_group: None | BrDecisionPointValueGroup = field(
        default=None,
        metadata={
            "name": "brDecisionPointValueGroup",
            "type": "Element",
    ...
    br_decision_point_explanation: None | BrDecisionPointExplanation = field(
        default=None,
        metadata={
            "name": "brDecisionPointExplanation",
            "type": "Element",
...
@dataclass(kw_only=True)
class BrAudit(BrAuditElemType):
    class Meta:
        name = "brAudit"


@dataclass(kw_only=True)
class BrDecision(BrDecisionElemType):
    class Meta:
        name = "brDecision"


@dataclass(kw_only=True)
class BrDecisionPointContent(BrDecisionPointContentElemType):
    class Meta:
        name = "brDecisionPointContent"
...
class BrParaElemType:
    ...
    br_related_to: None | BrRelatedTo = field(
        default=None,
        metadata={
            "name": "brRelatedTo",
            "type": "Element",
    ...
    br_decision_point_content: None | BrDecisionPointContent = field(
        default=None,
        metadata={
            "name": "brDecisionPointContent",
            "type": "Element",
    ...
    br_decision: list[BrDecision] = field(
        default_factory=list,
        metadata={
            "name": "brDecision",
            "type": "Element",
    ...
    br_decision_point_unique_ident: str = field(
        metadata={
            "name": "brDecisionPointUniqueIdent",
            "type": "Attribute",
            "pattern": r"BRDP-(S1-|[A-Za-z0-9]{1,20})-[0-9]{5}",
    ...
    br_decision_point_priority: None | BrDecisionPointPriorityAttType = field(
        default=None,
        metadata={
            "name": "brDecisionPointPriority",
            "type": "Attribute",
        },
    )
    change_type: None | ChangeTypeAttType = field(
...
@dataclass(kw_only=True)
class BrPara(BrParaElemType):
    class Meta:
        name = "brPara"


@dataclass(kw_only=True)
class BrLevelledParaElemType:
    class Meta:
        name = "brLevelledParaElemType"
    ...
    br_levelled_para: list[BrLevelledPara] = field(
        default_factory=list,
        metadata={
            "name": "brLevelledPara",
            "type": "Element",
...
@dataclass(kw_only=True)
class BrLevelledPara(BrLevelledParaElemType):
    class Meta:
        name = "brLevelledPara"
...
class BrDocElemType:
    ...
    default_br_severity_level: None | BrSeverityLevelAttType = field(
        default=None,
        metadata={
            "name": "defaultBrSeverityLevel",
            "type": "Attribute",
        },
    )
