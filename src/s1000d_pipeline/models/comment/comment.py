...
class CommentPriorityCodeAttType(Enum):
    CP01 = "cp01"
    CP02 = "cp02"
    CP03 = "cp03"
    CP04 = "cp04"
...
@dataclass(kw_only=True)
class DdnCodeElemType:
    class Meta:
        name = "ddnCodeElemType"
    ...
    year_of_data_issue: str = field(
        metadata={
            "name": "yearOfDataIssue",
            "type": "Attribute",
            "pattern": r"[0-9]{4}",
        }
    )
    seq_number: str = field(
        metadata={
            "name": "seqNumber",
            "type": "Attribute",
            "pattern": r"[0-9]{5}",
...
@dataclass(kw_only=True)
class NoReferencesElemType:
    class Meta:
        name = "noReferencesElemType"
...
class ResponseTypeAttType(Enum):
    RT01 = "rt01"
    RT02 = "rt02"
    RT03 = "rt03"
    RT04 = "rt04"
...
@dataclass(kw_only=True)
class AttachmentRefElemType:
    class Meta:
        name = "attachmentRefElemType"
...
@dataclass(kw_only=True)
class CommentCodeElemType:
    class Meta:
        name = "commentCodeElemType"
    ...
    comment_type: CommentTypeAttType = field(
        metadata={
            "name": "commentType",
            "type": "Attribute",
        }
...
@dataclass(kw_only=True)
class CommentPriorityElemType:
    class Meta:
        name = "commentPriorityElemType"

    comment_priority_code: CommentPriorityCodeAttType = field(
        metadata={
...
@dataclass(kw_only=True)
class CommentResponseElemType:
    class Meta:
        name = "commentResponseElemType"

    response_type: ResponseTypeAttType = field(
        metadata={
            "name": "responseType",
            "type": "Attribute",
        }
...
@dataclass(kw_only=True)
class DdnCode(DdnCodeElemType):
    class Meta:
        name = "ddnCode"


@dataclass(kw_only=True)
class DispatchPersonElemType:
    class Meta:
        name = "dispatchPersonElemType"
...
@dataclass(kw_only=True)
class DmlCodeElemType:
    class Meta:
        name = "dmlCodeElemType"
...
@dataclass(kw_only=True)
class EnterpriseElemType:
    class Meta:
        name = "enterpriseElemType"
    ...
    enterprise_unit: None | EnterpriseUnit = field(
        default=None,
        metadata={
            "name": "enterpriseUnit",
            "type": "Element",
...
@dataclass(kw_only=True)
class NoReferences(NoReferencesElemType):
    class Meta:
        name = "noReferences"
...
@dataclass(kw_only=True)
class AttachmentRef(AttachmentRefElemType):
    class Meta:
        name = "attachmentRef"
...
@dataclass(kw_only=True)
class CommentCode(CommentCodeElemType):
    class Meta:
        name = "commentCode"


@dataclass(kw_only=True)
class CommentPriority(CommentPriorityElemType):
    class Meta:
        name = "commentPriority"


@dataclass(kw_only=True)
class CommentResponse(CommentResponseElemType):
    class Meta:
...
@dataclass(kw_only=True)
class DdnRefAddressItemsElemType:
    class Meta:
        name = "ddnRefAddressItemsElemType"
...
@dataclass(kw_only=True)
class DdnRefIdentElemType:
    class Meta:
        name = "ddnRefIdentElemType"

    ddn_code: DdnCode = field(
        metadata={
            "name": "ddnCode",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class DispatchPerson(DispatchPersonElemType):
    class Meta:
        name = "dispatchPerson"
...
@dataclass(kw_only=True)
class DmlCode(DmlCodeElemType):
    class Meta:
        name = "dmlCode"


@dataclass(kw_only=True)
class Enterprise(EnterpriseElemType):
    class Meta:
        name = "enterprise"
...
@dataclass(kw_only=True)
class CommentContentElemType:
    class Meta:
        name = "commentContentElemType"
...
@dataclass(kw_only=True)
class CommentIdentElemType:
    class Meta:
        name = "commentIdentElemType"

    comment_code: CommentCode = field(
        metadata={
            "name": "commentCode",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class DdnRefAddressItems(DdnRefAddressItemsElemType):
    class Meta:
        name = "ddnRefAddressItems"


@dataclass(kw_only=True)
class DdnRefIdent(DdnRefIdentElemType):
    class Meta:
        name = "ddnRefIdent"
...
@dataclass(kw_only=True)
class DmlRefIdentElemType:
    class Meta:
        name = "dmlRefIdentElemType"

    dml_code: DmlCode = field(
        metadata={
            "name": "dmlCode",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class CommentContent(CommentContentElemType):
    class Meta:
        name = "commentContent"


@dataclass(kw_only=True)
class CommentIdent(CommentIdentElemType):
    class Meta:
        name = "commentIdent"


@dataclass(kw_only=True)
class DdnRefElemType:
    class Meta:
        name = "ddnRefElemType"

    ddn_ref_ident: DdnRefIdent = field(
        metadata={
            "name": "ddnRefIdent",
            "type": "Element",
        }
    )
    ddn_ref_address_items: None | DdnRefAddressItems = field(
        default=None,
        metadata={
            "name": "ddnRefAddressItems",
            "type": "Element",
...
@dataclass(kw_only=True)
class DispatchAddressElemType:
    class Meta:
        name = "dispatchAddressElemType"
    ...
    dispatch_person: None | DispatchPerson = field(
        default=None,
        metadata={
            "name": "dispatchPerson",
            "type": "Element",
...
@dataclass(kw_only=True)
class DmlRefIdent(DmlRefIdentElemType):
    class Meta:
        name = "dmlRefIdent"
...
@dataclass(kw_only=True)
class DdnRef(DdnRefElemType):
    class Meta:
        name = "ddnRef"


@dataclass(kw_only=True)
class DispatchAddress(DispatchAddressElemType):
    class Meta:
...
@dataclass(kw_only=True)
class DmlRefElemType:
    class Meta:
        name = "dmlRefElemType"

    dml_ref_ident: DmlRefIdent = field(
        metadata={
            "name": "dmlRefIdent",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class CommentOriginatorElemType:
    class Meta:
        name = "commentOriginatorElemType"

    dispatch_address: DispatchAddress = field(
        metadata={
            "name": "dispatchAddress",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class DdnRefGroupElemType:
    class Meta:
        name = "ddnRefGroupElemType"

    ddn_ref: list[DdnRef] = field(
        default_factory=list,
        metadata={
            "name": "ddnRef",
            "type": "Element",
...
@dataclass(kw_only=True)
class CommentOriginator(CommentOriginatorElemType):
    class Meta:
        name = "commentOriginator"


@dataclass(kw_only=True)
class DdnRefGroup(DdnRefGroupElemType):
    class Meta:
        name = "ddnRefGroup"
...
@dataclass(kw_only=True)
class DmlRefGroupElemType:
    class Meta:
        name = "dmlRefGroupElemType"

    dml_ref: list[DmlRef] = field(
        default_factory=list,
        metadata={
            "name": "dmlRef",
            "type": "Element",
...
@dataclass(kw_only=True)
class PmRefGroupElemType:
    class Meta:
        name = "pmRefGroupElemType"
...
@dataclass(kw_only=True)
class CommentAddressItemsElemType:
    class Meta:
        name = "commentAddressItemsElemType"

    comment_title: None | CommentTitle = field(
        default=None,
        metadata={
            "name": "commentTitle",
            "type": "Element",
    ...
    comment_originator: CommentOriginator = field(
        metadata={
            "name": "commentOriginator",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class DmlRefGroup(DmlRefGroupElemType):
    class Meta:
        name = "dmlRefGroup"
...
@dataclass(kw_only=True)
class PmRefGroup(PmRefGroupElemType):
    class Meta:
        name = "pmRefGroup"
...
@dataclass(kw_only=True)
class CommentAddressItems(CommentAddressItemsElemType):
    class Meta:
        name = "commentAddressItems"


@dataclass(kw_only=True)
class DmRefGroupElemType:
    class Meta:
        name = "dmRefGroupElemType"
...
@dataclass(kw_only=True)
class CommentAddressElemType:
    class Meta:
        name = "commentAddressElemType"

    comment_ident: CommentIdent = field(
        metadata={
            "name": "commentIdent",
            "type": "Element",
        }
    )
    comment_address_items: CommentAddressItems = field(
        metadata={
            "name": "commentAddressItems",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class DmRefGroup(DmRefGroupElemType):
    class Meta:
        name = "dmRefGroup"
...
@dataclass(kw_only=True)
class CommentAddress(CommentAddressElemType):
    class Meta:
        name = "commentAddress"


@dataclass(kw_only=True)
class CommentRefsElemType:
    class Meta:
        name = "commentRefsElemType"

    no_references: None | NoReferences = field(
        default=None,
        metadata={
            "name": "noReferences",
            "type": "Element",
    ...
    dm_ref_group: None | DmRefGroup = field(
        default=None,
        metadata={
            "name": "dmRefGroup",
            "type": "Element",
    ...
    dml_ref_group: None | DmlRefGroup = field(
        default=None,
        metadata={
            "name": "dmlRefGroup",
            "type": "Element",
    ...
    pm_ref_group: None | PmRefGroup = field(
        default=None,
        metadata={
            "name": "pmRefGroup",
            "type": "Element",
    ...
    ddn_ref_group: None | DdnRefGroup = field(
        default=None,
        metadata={
            "name": "ddnRefGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class CommentRefs(CommentRefsElemType):
    class Meta:
        name = "commentRefs"
...
@dataclass(kw_only=True)
class CommentStatusElemType:
    class Meta:
        name = "commentStatusElemType"
    ...
    comment_priority: CommentPriority = field(
        metadata={
            "name": "commentPriority",
            "type": "Element",
        }
    )
    comment_response: None | CommentResponse = field(
        default=None,
        metadata={
            "name": "commentResponse",
            "type": "Element",
    ...
    comment_refs: CommentRefs = field(
        metadata={
            "name": "commentRefs",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class CommentStatus(CommentStatusElemType):
    class Meta:
        name = "commentStatus"
...
class IdentAndStatusSectionElemType:
    ...
    comment_address: CommentAddress = field(
        metadata={
            "name": "commentAddress",
            "type": "Element",
        }
    )
    comment_status: CommentStatus = field(
        metadata={
            "name": "commentStatus",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class CommentElemType:
    class Meta:
        name = "commentElemType"
    ...
    comment_content: CommentContent = field(
        metadata={
            "name": "commentContent",
            "type": "Element",
        }
