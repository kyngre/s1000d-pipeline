...
from s1000d_pipeline.models.pm.rdf import Description
from s1000d_pipeline.models.pm.xlink import (
    ActuateValue,
    ShowValue,
    TypeValue,
)
from s1000d_pipeline.models.pm.xml import SpaceValue
...
@dataclass(kw_only=True)
class PmIdentElemType:
    class Meta:
        name = "pmIdentElemType"
...
@dataclass(kw_only=True)
class SourcePmIdentElemType:
    class Meta:
        name = "sourcePmIdentElemType"
...
@dataclass(kw_only=True)
class SourcePmIdent(SourcePmIdentElemType):
    class Meta:
        name = "sourcePmIdent"
...
@dataclass(kw_only=True)
class PmAddressItemsElemType:
    class Meta:
        name = "pmAddressItemsElemType"
...
@dataclass(kw_only=True)
class PmAddressItems(PmAddressItemsElemType):
    class Meta:
        name = "pmAddressItems"
...
@dataclass(kw_only=True)
class PmAddressElemType:
    class Meta:
        name = "pmAddressElemType"

    pm_ident: PmIdent = field(
        metadata={
            "name": "pmIdent",
            "type": "Element",
        }
    )
    pm_address_items: PmAddressItems = field(
        metadata={
            "name": "pmAddressItems",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class PmAddress(PmAddressElemType):
    class Meta:
        name = "pmAddress"
...
@dataclass(kw_only=True)
class PmEntryElemType:
    class Meta:
        name = "pmEntryElemType"

    pm_entry_title: None | PmEntryTitle = field(
        default=None,
        metadata={
            "name": "pmEntryTitle",
            "type": "Element",
    ...
    pm_entry_type: None | PmEntryTypeAttType = field(
        default=None,
        metadata={
            "name": "pmEntryType",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class PmStatusElemType:
    class Meta:
        name = "pmStatusElemType"

    source_pm_ident: None | SourcePmIdent = field(
        default=None,
        metadata={
            "name": "sourcePmIdent",
            "type": "Element",
...
@dataclass(kw_only=True)
class PmStatus(PmStatusElemType):
    class Meta:
        name = "pmStatus"
...
class IdentAndStatusSectionElemType:
    ...
    pm_address: PmAddress = field(
        metadata={
            "name": "pmAddress",
            "type": "Element",
        }
    )
    pm_status: PmStatus = field(
        metadata={
            "name": "pmStatus",
            "type": "Element",
        }
...
class PmElemType:
    ...
    pm_type: None | PmTypeAttType = field(
        default=None,
        metadata={
            "name": "pmType",
            "type": "Attribute",
