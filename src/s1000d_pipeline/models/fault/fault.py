...
@dataclass(kw_only=True)
class ContactIdentificationElemType:
    class Meta:
        name = "contactIdentificationElemType"
...
@dataclass(kw_only=True)
class ChoiceElemType:
    class Meta:
        name = "choiceElemType"

    next_action_ref_id: str = field(
        metadata={
            "name": "nextActionRefId",
            "type": "Attribute",
        }
    )
    change_type: None | ChangeTypeAttType = field(
...
@dataclass(kw_only=True)
class ContactIdentification(ContactIdentificationElemType):
    class Meta:
...
@dataclass(kw_only=True)
class Fault(FaultElemType):
    class Meta:
        name = "fault"


@dataclass(kw_only=True)
class FaultCondElemType:
    class Meta:
        name = "faultCondElemType"
...
@dataclass(kw_only=True)
class FaultEquipElemType:
    class Meta:
        name = "faultEquipElemType"
...
@dataclass(kw_only=True)
class FaultMessageIndicationElemType:
    class Meta:
        name = "faultMessageIndicationElemType"
...
@dataclass(kw_only=True)
class FaultySubSystemElemType:
    class Meta:
        name = "faultySubSystemElemType"
...
@dataclass(kw_only=True)
class IsolationStepQuestionElemType:
    class Meta:
        name = "isolationStepQuestionElemType"
...
@dataclass(kw_only=True)
class NoAnswerElemType:
    class Meta:
        name = "noAnswerElemType"
...
@dataclass(kw_only=True)
class OtherPossibleCauseElemType:
    class Meta:
        name = "otherPossibleCauseElemType"
...
@dataclass(kw_only=True)
class SystemIdentElemType:
    class Meta:
        name = "systemIdentElemType"
...
@dataclass(kw_only=True)
class SystemLocationElemType:
    class Meta:
        name = "systemLocationElemType"
...
@dataclass(kw_only=True)
class SystemNameElemType:
    class Meta:
        name = "systemNameElemType"
...
@dataclass(kw_only=True)
class SystemPositionElemType:
    class Meta:
        name = "systemPositionElemType"
...
@dataclass(kw_only=True)
class TestParametersElemType:
    class Meta:
        name = "testParametersElemType"
...
@dataclass(kw_only=True)
class ViewLocationElemType:
    class Meta:
        name = "viewLocationElemType"
...
@dataclass(kw_only=True)
class YesAnswerElemType:
    class Meta:
        name = "yesAnswerElemType"
...
@dataclass(kw_only=True)
class FaultCond(FaultCondElemType):
    class Meta:
        name = "faultCond"


@dataclass(kw_only=True)
class FaultEquip(FaultEquipElemType):
    class Meta:
        name = "faultEquip"


@dataclass(kw_only=True)
class FaultMessageIndication(FaultMessageIndicationElemType):
    class Meta:
        name = "faultMessageIndication"


@dataclass(kw_only=True)
class FaultySubSystem(FaultySubSystemElemType):
    class Meta:
...
@dataclass(kw_only=True)
class IsolationStepQuestion(IsolationStepQuestionElemType):
    class Meta:
...
@dataclass(kw_only=True)
class NoAnswer(NoAnswerElemType):
    class Meta:
        name = "noAnswer"
...
@dataclass(kw_only=True)
class OtherPossibleCause(OtherPossibleCauseElemType):
    class Meta:
        name = "otherPossibleCause"
...
@dataclass(kw_only=True)
class SystemIdent(SystemIdentElemType):
    class Meta:
        name = "systemIdent"


@dataclass(kw_only=True)
class SystemLocation(SystemLocationElemType):
    class Meta:
        name = "systemLocation"


@dataclass(kw_only=True)
class SystemName(SystemNameElemType):
    class Meta:
        name = "systemName"


@dataclass(kw_only=True)
class SystemPosition(SystemPositionElemType):
    class Meta:
        name = "systemPosition"
...
@dataclass(kw_only=True)
class TestParameters(TestParametersElemType):
    class Meta:
        name = "testParameters"
...
@dataclass(kw_only=True)
class ViewLocation(ViewLocationElemType):
    class Meta:
        name = "viewLocation"
...
@dataclass(kw_only=True)
class YesAnswer(YesAnswerElemType):
    class Meta:
        name = "yesAnswer"
...
@dataclass(kw_only=True)
class ListOfChoicesElemType:
    class Meta:
        name = "listOfChoicesElemType"
...
@dataclass(kw_only=True)
class YesNoAnswerElemType:
    class Meta:
        name = "yesNoAnswerElemType"

    yes_answer: YesAnswer = field(
        metadata={
            "name": "yesAnswer",
            "type": "Element",
        }
    )
    no_answer: NoAnswer = field(
        metadata={
            "name": "noAnswer",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class ListOfChoices(ListOfChoicesElemType):
    class Meta:
        name = "listOfChoices"
...
@dataclass(kw_only=True)
class YesNoAnswer(YesNoAnswerElemType):
    class Meta:
        name = "yesNoAnswer"
...
@dataclass(kw_only=True)
class IsolationStepAnswerElemType:
    class Meta:
        name = "isolationStepAnswerElemType"

    yes_no_answer: None | YesNoAnswer = field(
        default=None,
        metadata={
            "name": "yesNoAnswer",
            "type": "Element",
    ...
    list_of_choices: None | ListOfChoices = field(
        default=None,
        metadata={
            "name": "listOfChoices",
            "type": "Element",
...
@dataclass(kw_only=True)
class IsolationStepAnswer(IsolationStepAnswerElemType):
    class Meta:
...
@dataclass(kw_only=True)
class FaultIsolationRefElemType:
    class Meta:
        name = "faultIsolationRefElemType"
...
@dataclass(kw_only=True)
class TestDescrElemType:
    class Meta:
        name = "testDescrElemType"

    test_name: TestName = field(
        metadata={
            "name": "testName",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class TestProcedureElemType:
    class Meta:
        name = "testProcedureElemType"
...
@dataclass(kw_only=True)
class FaultIsolationRef(FaultIsolationRefElemType):
    class Meta:
        name = "faultIsolationRef"
...
@dataclass(kw_only=True)
class TestDescr(TestDescrElemType):
    class Meta:
        name = "testDescr"


@dataclass(kw_only=True)
class TestProcedure(TestProcedureElemType):
    class Meta:
        name = "testProcedure"
...
@dataclass(kw_only=True)
class FaultIsolationTestElemType:
    class Meta:
        name = "faultIsolationTestElemType"

    test_descr: None | TestDescr = field(
        default=None,
        metadata={
            "name": "testDescr",
            "type": "Element",
    ...
    test_parameters: list[TestParameters] = field(
        default_factory=list,
        metadata={
            "name": "testParameters",
            "type": "Element",
    ...
    test_procedure: None | TestProcedure = field(
        default=None,
        metadata={
            "name": "testProcedure",
            "type": "Element",
...
@dataclass(kw_only=True)
class FaultMessageBodyElemType:
    class Meta:
        name = "faultMessageBodyElemType"
...
@dataclass(kw_only=True)
class WiringPossibleCauseFromElemType:
    class Meta:
        name = "wiringPossibleCauseFromElemType"
    ...
    functional_item_ref: None | FunctionalItemRef = field(
        default=None,
        metadata={
            "name": "functionalItemRef",
            "type": "Element",
    ...
    contact_identification: None | ContactIdentification = field(
        default=None,
        metadata={
            "name": "contactIdentification",
            "type": "Element",
...
@dataclass(kw_only=True)
class WiringPossibleCauseToElemType:
    class Meta:
        name = "wiringPossibleCauseToElemType"
...
@dataclass(kw_only=True)
class FaultIsolationTest(FaultIsolationTestElemType):
    class Meta:
        name = "faultIsolationTest"


@dataclass(kw_only=True)
class FaultMessageBody(FaultMessageBodyElemType):
    class Meta:
        name = "faultMessageBody"
...
@dataclass(kw_only=True)
class Lru(LruElemType):
    class Meta:
        name = "lru"


@dataclass(kw_only=True)
class Sru(SruElemType):
    class Meta:
        name = "sru"


@dataclass(kw_only=True)
class WiringPossibleCauseFrom(WiringPossibleCauseFromElemType):
    class Meta:
        name = "wiringPossibleCauseFrom"


@dataclass(kw_only=True)
class WiringPossibleCauseTo(WiringPossibleCauseToElemType):
    class Meta:
        name = "wiringPossibleCauseTo"
...
@dataclass(kw_only=True)
class DetailedFaultDescrElemType:
    class Meta:
        name = "detailedFaultDescrElemType"

    view_location: None | ViewLocation = field(
        default=None,
        metadata={
            "name": "viewLocation",
            "type": "Element",
    ...
    system_location: None | SystemLocation = field(
        default=None,
        metadata={
            "name": "systemLocation",
            "type": "Element",
    ...
    faulty_sub_system: None | FaultySubSystem = field(
        default=None,
        metadata={
            "name": "faultySubSystem",
            "type": "Element",
    ...
    system_ident: None | SystemIdent = field(
        default=None,
        metadata={
            "name": "systemIdent",
            "type": "Element",
    ...
    system_position: None | SystemPosition = field(
        default=None,
        metadata={
            "name": "systemPosition",
            "type": "Element",
    ...
    fault_equip: None | FaultEquip = field(
        default=None,
        metadata={
            "name": "faultEquip",
            "type": "Element",
    ...
    fault_message_indication: None | FaultMessageIndication = field(
        default=None,
        metadata={
            "name": "faultMessageIndication",
            "type": "Element",
    ...
    fault_message_body: FaultMessageBody = field(
        metadata={
            "name": "faultMessageBody",
            "type": "Element",
        }
    )
    fault_cond: None | FaultCond = field(
        default=None,
        metadata={
            "name": "faultCond",
            "type": "Element",
...
@dataclass(kw_only=True)
class DetectedSruItemElemType:
    class Meta:
        name = "detectedSruItemElemType"
    ...
    fault_probability: None | str = field(
        default=None,
        metadata={
...
@dataclass(kw_only=True)
class LocateAndRepairSruItemElemType:
    class Meta:
        name = "locateAndRepairSruItemElemType"
...
@dataclass(kw_only=True)
class SruItemElemType:
    class Meta:
        name = "sruItemElemType"
    ...
    fault_isolation_test: list[FaultIsolationTest] = field(
        default_factory=list,
        metadata={
            "name": "faultIsolationTest",
            "type": "Element",
...
@dataclass(kw_only=True)
class WiringPossibleCauseElemType:
    class Meta:
        name = "wiringPossibleCauseElemType"

    wiring_possible_cause_from: WiringPossibleCauseFrom = field(
        metadata={
            "name": "wiringPossibleCauseFrom",
            "type": "Element",
        }
    )
    wiring_possible_cause_to: None | WiringPossibleCauseTo = field(
        default=None,
        metadata={
            "name": "wiringPossibleCauseTo",
            "type": "Element",
...
@dataclass(kw_only=True)
class DetailedFaultDescr(DetailedFaultDescrElemType):
    class Meta:
        name = "detailedFaultDescr"


@dataclass(kw_only=True)
class DetectedSruItem(DetectedSruItemElemType):
    class Meta:
        name = "detectedSruItem"
...
@dataclass(kw_only=True)
class LocateAndRepairSruItem(LocateAndRepairSruItemElemType):
    class Meta:
        name = "locateAndRepairSruItem"
...
@dataclass(kw_only=True)
class WiringPossibleCause(WiringPossibleCauseElemType):
    class Meta:
        name = "wiringPossibleCause"
...
@dataclass(kw_only=True)
class DetectedLruItemElemType:
    class Meta:
        name = "detectedLruItemElemType"
    ...
    detected_sru_item: None | DetectedSruItem = field(
        default=None,
        metadata={
            "name": "detectedSruItem",
            "type": "Element",
...
@dataclass(kw_only=True)
class FaultDescrElemType:
    class Meta:
        name = "faultDescrElemType"
    ...
    detailed_fault_descr: None | DetailedFaultDescr = field(
        default=None,
        metadata={
            "name": "detailedFaultDescr",
            "type": "Element",
...
@dataclass(kw_only=True)
class LocateAndRepairLruItemElemType:
    class Meta:
        name = "locateAndRepairLruItemElemType"
    ...
    locate_and_repair_sru_item: None | LocateAndRepairSruItem = field(
        default=None,
        metadata={
            "name": "locateAndRepairSruItem",
            "type": "Element",
...
@dataclass(kw_only=True)
class LruItemElemType:
    class Meta:
        name = "lruItemElemType"
...
@dataclass(kw_only=True)
class PossibleCauseGroupElemType:
    class Meta:
        name = "possibleCauseGroupElemType"
    ...
    wiring_possible_cause: list[WiringPossibleCause] = field(
        default_factory=list,
        metadata={
            "name": "wiringPossibleCause",
            "type": "Element",
    ...
    other_possible_cause: list[OtherPossibleCause] = field(
        default_factory=list,
        metadata={
            "name": "otherPossibleCause",
            "type": "Element",
...
@dataclass(kw_only=True)
class DetectedLruItem(DetectedLruItemElemType):
    class Meta:
        name = "detectedLruItem"


@dataclass(kw_only=True)
class FaultDescr(FaultDescrElemType):
    class Meta:
        name = "faultDescr"


@dataclass(kw_only=True)
class LocateAndRepairLruItem(LocateAndRepairLruItemElemType):
    class Meta:
        name = "locateAndRepairLruItem"


@dataclass(kw_only=True)
class LruItem(LruItemElemType):
    class Meta:
        name = "lruItem"


@dataclass(kw_only=True)
class PossibleCauseGroup(PossibleCauseGroupElemType):
    class Meta:
        name = "possibleCauseGroup"
...
@dataclass(kw_only=True)
class DetectionInfoElemType:
    class Meta:
        name = "detectionInfoElemType"

    detected_lru_item: DetectedLruItem = field(
        metadata={
            "name": "detectedLruItem",
            "type": "Element",
        }
    )
    detection_type: None | str = field(
        default=None,
        metadata={
            "name": "detectionType",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class DiagnosticProcessElemType:
    class Meta:
        name = "diagnosticProcessElemType"

    diagnostics_reason: None | DiagnosticsReason = field(
        default=None,
        metadata={
            "name": "diagnosticsReason",
            "type": "Element",
    ...
    locate_and_repair_lru_item: None | LocateAndRepairLruItem = field(
        default=None,
        metadata={
            "name": "locateAndRepairLruItem",
            "type": "Element",
...
@dataclass(kw_only=True)
class IsolateDetectedFaultElemType:
    class Meta:
        name = "isolateDetectedFaultElemType"

    fault_isolation_ref: None | FaultIsolationRef = field(
        default=None,
        metadata={
            "name": "faultIsolationRef",
            "type": "Element",
...
@dataclass(kw_only=True)
class LocateAndRepairElemType:
    class Meta:
        name = "locateAndRepairElemType"
...
@dataclass(kw_only=True)
class DetectionInfo(DetectionInfoElemType):
    class Meta:
        name = "detectionInfo"


@dataclass(kw_only=True)
class DiagnosticProcess(DiagnosticProcessElemType):
    class Meta:
        name = "diagnosticProcess"


@dataclass(kw_only=True)
class IsolateDetectedFault(IsolateDetectedFaultElemType):
    class Meta:
        name = "isolateDetectedFault"


@dataclass(kw_only=True)
class LocateAndRepair(LocateAndRepairElemType):
    class Meta:
        name = "locateAndRepair"
...
@dataclass(kw_only=True)
class AssocWarningMalfunctionElemType:
    class Meta:
        name = "assocWarningMalfunctionElemType"
    ...
    fault_descr: None | FaultDescr = field(
        default=None,
        metadata={
            "name": "faultDescr",
            "type": "Element",
    ...
    detection_info: None | DetectionInfo = field(
        default=None,
        metadata={
            "name": "detectionInfo",
            "type": "Element",
    ...
    fault_part_category: None | str = field(
        default=None,
        metadata={
            "name": "faultPartCategory",
            "type": "Attribute",
        },
    )
    sub_category: None | str = field(
        default=None,
        metadata={
            "name": "subCategory",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class DetectedFaultElemType:
    class Meta:
        name = "detectedFaultElemType"

    fault_descr: FaultDescr = field(
        metadata={
            "name": "faultDescr",
            "type": "Element",
        }
    ...
    isolate_detected_fault: None | IsolateDetectedFault = field(
        default=None,
        metadata={
            "name": "isolateDetectedFault",
            "type": "Element",
...
@dataclass(kw_only=True)
class IsolatedFaultElemType:
    class Meta:
        name = "isolatedFaultElemType"
    ...
    locate_and_repair: LocateAndRepair = field(
        metadata={
            "name": "locateAndRepair",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class IsolationInfoElemType:
    class Meta:
        name = "isolationInfoElemType"
    ...
    diagnostic_process: None | DiagnosticProcess = field(
        default=None,
        metadata={
            "name": "diagnosticProcess",
            "type": "Element",
...
@dataclass(kw_only=True)
class AssocWarningMalfunction(AssocWarningMalfunctionElemType):
    class Meta:
        name = "assocWarningMalfunction"
...
@dataclass(kw_only=True)
class BitMessage(AssocWarningMalfunctionElemType):
    class Meta:
        name = "bitMessage"
...
@dataclass(kw_only=True)
class DetectedFault(DetectedFaultElemType):
    class Meta:
        name = "detectedFault"


@dataclass(kw_only=True)
class IsolatedFault(IsolatedFaultElemType):
    class Meta:
        name = "isolatedFault"


@dataclass(kw_only=True)
class IsolationInfo(IsolationInfoElemType):
    class Meta:
        name = "isolationInfo"


@dataclass(kw_only=True)
class WarningMalfunction(AssocWarningMalfunctionElemType):
    class Meta:
        name = "warningMalfunction"


@dataclass(kw_only=True)
class AssocWarningMalfunctionAltsElemType:
    class Meta:
        name = "assocWarningMalfunctionAltsElemType"

    assoc_warning_malfunction: list[AssocWarningMalfunction] = field(
        default_factory=list,
        metadata={
            "name": "assocWarningMalfunction",
            "type": "Element",
...
@dataclass(kw_only=True)
class BitMessageAltsElemType:
    class Meta:
        name = "bitMessageAltsElemType"

    bit_message: list[BitMessage] = field(
        default_factory=list,
        metadata={
            "name": "bitMessage",
            "type": "Element",
...
@dataclass(kw_only=True)
class ContextAndIsolationInfoElemType:
    class Meta:
        name = "contextAndIsolationInfoElemType"

    fault_context: None | FaultContext = field(
        default=None,
        metadata={
            "name": "faultContext",
            "type": "Element",
    ...
    isolation_info: IsolationInfo = field(
        metadata={
            "name": "isolationInfo",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class DetectedFaultAltsElemType:
    class Meta:
        name = "detectedFaultAltsElemType"

    detected_fault: list[DetectedFault] = field(
        default_factory=list,
        metadata={
            "name": "detectedFault",
            "type": "Element",
...
@dataclass(kw_only=True)
class IsolatedFaultAltsElemType:
    class Meta:
        name = "isolatedFaultAltsElemType"

    isolated_fault: list[IsolatedFault] = field(
        default_factory=list,
        metadata={
            "name": "isolatedFault",
            "type": "Element",
...
@dataclass(kw_only=True)
class WarningMalfunctionAltsElemType:
    class Meta:
        name = "warningMalfunctionAltsElemType"

    warning_malfunction: list[WarningMalfunction] = field(
        default_factory=list,
        metadata={
            "name": "warningMalfunction",
            "type": "Element",
...
@dataclass(kw_only=True)
class AssocWarningMalfunctionAlts(AssocWarningMalfunctionAltsElemType):
    class Meta:
        name = "assocWarningMalfunctionAlts"
...
@dataclass(kw_only=True)
class BitMessageAlts(BitMessageAltsElemType):
    class Meta:
        name = "bitMessageAlts"
...
@dataclass(kw_only=True)
class ContextAndIsolationInfo(ContextAndIsolationInfoElemType):
    class Meta:
        name = "contextAndIsolationInfo"


@dataclass(kw_only=True)
class DetectedFaultAlts(DetectedFaultAltsElemType):
    class Meta:
        name = "detectedFaultAlts"


@dataclass(kw_only=True)
class IsolatedFaultAlts(IsolatedFaultAltsElemType):
    class Meta:
        name = "isolatedFaultAlts"
...
@dataclass(kw_only=True)
class WarningMalfunctionAlts(WarningMalfunctionAltsElemType):
    class Meta:
        name = "warningMalfunctionAlts"


@dataclass(kw_only=True)
class BasicCorrelatedFaultsElemType:
    class Meta:
        name = "basicCorrelatedFaultsElemType"
    ...
    warning_malfunction_alts: list[WarningMalfunctionAlts] = field(
        default_factory=list,
        metadata={
            "name": "warningMalfunctionAlts",
            "type": "Element",
    ...
    assoc_warning_malfunction_alts: list[AssocWarningMalfunctionAlts] = field(
        default_factory=list,
        metadata={
            "name": "assocWarningMalfunctionAlts",
            "type": "Element",
    ...
    bit_message_alts: list[BitMessageAlts] = field(
        default_factory=list,
        metadata={
            "name": "bitMessageAlts",
            "type": "Element",
...
@dataclass(kw_only=True)
class ObservedFaultElemType:
    class Meta:
        name = "observedFaultElemType"
    ...
    context_and_isolation_info: list[ContextAndIsolationInfo] = field(
        default_factory=list,
        metadata={
            "name": "contextAndIsolationInfo",
            "type": "Element",
...
@dataclass(kw_only=True)
class BasicCorrelatedFaults(BasicCorrelatedFaultsElemType):
    class Meta:
        name = "basicCorrelatedFaults"
...
@dataclass(kw_only=True)
class ObservedFault(ObservedFaultElemType):
    class Meta:
        name = "observedFault"
...
@dataclass(kw_only=True)
class CorrelatedFaultElemType:
    class Meta:
        name = "correlatedFaultElemType"

    basic_correlated_faults: BasicCorrelatedFaults = field(
        metadata={
            "name": "basicCorrelatedFaults",
            "type": "Element",
        }
    )
    isolate_detected_fault: IsolateDetectedFault = field(
        metadata={
            "name": "isolateDetectedFault",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class ObservedFaultAltsElemType:
    class Meta:
        name = "observedFaultAltsElemType"

    observed_fault: list[ObservedFault] = field(
        default_factory=list,
        metadata={
            "name": "observedFault",
            "type": "Element",
...
@dataclass(kw_only=True)
class CorrelatedFault(CorrelatedFaultElemType):
    class Meta:
...
@dataclass(kw_only=True)
class ObservedFaultAlts(ObservedFaultAltsElemType):
    class Meta:
        name = "observedFaultAlts"
...
@dataclass(kw_only=True)
class CorrelatedFaultAltsElemType:
    class Meta:
        name = "correlatedFaultAltsElemType"

    correlated_fault: list[CorrelatedFault] = field(
        default_factory=list,
        metadata={
            "name": "correlatedFault",
            "type": "Element",
...
@dataclass(kw_only=True)
class CorrelatedFaultAlts(CorrelatedFaultAltsElemType):
    class Meta:
        name = "correlatedFaultAlts"
...
@dataclass(kw_only=True)
class CloseRqmtsElemType:
    class Meta:
        name = "closeRqmtsElemType"
...
@dataclass(kw_only=True)
class CloseRqmts(CloseRqmtsElemType):
    class Meta:
        name = "closeRqmts"
...
@dataclass(kw_only=True)
class ActionAltsElemType:
    class Meta:
        name = "actionAltsElemType"
...
@dataclass(kw_only=True)
class ActionAlts(ActionAltsElemType):
    class Meta:
        name = "actionAlts"
...
@dataclass(kw_only=True)
class IsolationProcedureEndElemType:
    class Meta:
        name = "isolationProcedureEndElemType"
    ...
    action_alts: list[ActionAlts] = field(
        default_factory=list,
        metadata={
            "name": "actionAlts",
            "type": "Element",
...
@dataclass(kw_only=True)
class IsolationStepElemType:
    class Meta:
        name = "isolationStepElemType"
    ...
    isolation_step_question: None | IsolationStepQuestion = field(
        default=None,
        metadata={
            "name": "isolationStepQuestion",
            "type": "Element",
    ...
    isolation_step_answer: None | IsolationStepAnswer = field(
        default=None,
        metadata={
            "name": "isolationStepAnswer",
            "type": "Element",
...
@dataclass(kw_only=True)
class IsolationProcedureEnd(IsolationProcedureEndElemType):
    class Meta:
        name = "isolationProcedureEnd"


@dataclass(kw_only=True)
class IsolationStep(IsolationStepElemType):
    class Meta:
        name = "isolationStep"
...
@dataclass(kw_only=True)
class IsolationProcedureEndAltsElemType:
    class Meta:
        name = "isolationProcedureEndAltsElemType"

    isolation_procedure_end: list[IsolationProcedureEnd] = field(
        default_factory=list,
        metadata={
            "name": "isolationProcedureEnd",
            "type": "Element",
...
@dataclass(kw_only=True)
class IsolationStepAltsElemType:
    class Meta:
        name = "isolationStepAltsElemType"

    isolation_step: list[IsolationStep] = field(
        default_factory=list,
        metadata={
            "name": "isolationStep",
            "type": "Element",
...
@dataclass(kw_only=True)
class IsolationProcedureEndAlts(IsolationProcedureEndAltsElemType):
    class Meta:
        name = "isolationProcedureEndAlts"


@dataclass(kw_only=True)
class IsolationStepAlts(IsolationStepAltsElemType):
    class Meta:
        name = "isolationStepAlts"
...
@dataclass(kw_only=True)
class IsolationMainProcedureElemType:
    class Meta:
        name = "isolationMainProcedureElemType"
    ...
    isolation_step_alts: list[IsolationStepAlts] = field(
        default_factory=list,
        metadata={
            "name": "isolationStepAlts",
            "type": "Element",
    ...
    isolation_procedure_end_alts: list[IsolationProcedureEndAlts] = field(
        default_factory=list,
        metadata={
            "name": "isolationProcedureEndAlts",
            "type": "Element",
...
@dataclass(kw_only=True)
class IsolationMainProcedure(IsolationMainProcedureElemType):
    class Meta:
        name = "isolationMainProcedure"


@dataclass(kw_only=True)
class FaultReportingElemType:
    class Meta:
        name = "faultReportingElemType"
    ...
    preliminary_rqmts: None | PreliminaryRqmts = field(
        default=None,
        metadata={
            "name": "preliminaryRqmts",
            "type": "Element",
    ...
    isolated_fault_alts: list[IsolatedFaultAlts] = field(
        default_factory=list,
        metadata={
            "name": "isolatedFaultAlts",
            "type": "Element",
    ...
    detected_fault_alts: list[DetectedFaultAlts] = field(
        default_factory=list,
        metadata={
            "name": "detectedFaultAlts",
            "type": "Element",
    ...
    observed_fault_alts: list[ObservedFaultAlts] = field(
        default_factory=list,
        metadata={
            "name": "observedFaultAlts",
            "type": "Element",
    ...
    correlated_fault_alts: list[CorrelatedFaultAlts] = field(
        default_factory=list,
        metadata={
            "name": "correlatedFaultAlts",
            "type": "Element",
...
@dataclass(kw_only=True)
class IsolationProcedureElemType:
    class Meta:
        name = "isolationProcedureElemType"

    preliminary_rqmts: PreliminaryRqmts = field(
        metadata={
            "name": "preliminaryRqmts",
            "type": "Element",
        }
    )
    isolation_main_procedure: IsolationMainProcedure = field(
        metadata={
            "name": "isolationMainProcedure",
            "type": "Element",
        }
    )
    close_rqmts: CloseRqmts = field(
        metadata={
            "name": "closeRqmts",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class FaultReporting(FaultReportingElemType):
    class Meta:
        name = "faultReporting"


@dataclass(kw_only=True)
class IsolationProcedure(IsolationProcedureElemType):
    class Meta:
        name = "isolationProcedure"


@dataclass(kw_only=True)
class FaultIsolationProcedureElemType:
    class Meta:
        name = "faultIsolationProcedureElemType"

    fault: None | Fault = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    possible_cause_group: None | PossibleCauseGroup = field(
        default=None,
        metadata={
            "name": "possibleCauseGroup",
            "type": "Element",
    ...
    isolation_procedure: IsolationProcedure = field(
        metadata={
            "name": "isolationProcedure",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class FaultIsolationProcedure(FaultIsolationProcedureElemType):
    class Meta:
        name = "faultIsolationProcedure"


@dataclass(kw_only=True)
class FaultIsolationElemType:
    class Meta:
        name = "faultIsolationElemType"
    ...
    fault_isolation_procedure: list[FaultIsolationProcedure] = field(
        default_factory=list,
        metadata={
            "name": "faultIsolationProcedure",
            "type": "Element",
...
@dataclass(kw_only=True)
class FaultIsolation(FaultIsolationElemType):
    class Meta:
        name = "faultIsolation"
...
class ContentElemType:
    ...
    fault_reporting: None | FaultReporting = field(
        default=None,
        metadata={
            "name": "faultReporting",
            "type": "Element",
    ...
    fault_isolation: None | FaultIsolation = field(
        default=None,
        metadata={
            "name": "faultIsolation",
            "type": "Element",
