...
class AssociationTypeAttType(Enum):
    EXTREF = "extref"
    ALIAS = "alias"
...
@dataclass(kw_only=True)
class EnumerationElemType:
    class Meta:
        name = "enumerationElemType"

    applic_property_values: str = field(
        metadata={
    ...
    enumeration_label: None | str = field(
        default=None,
        metadata={
...
class ProductIdentifierAttType(Enum):
    PRIMARY = "primary"
    SECONDARY = "secondary"
    NO = "no"
...
class ValueDataTypeAttType(Enum):
    BOOLEAN = "boolean"
    STRING = "string"
    REAL = "real"
    INTEGER = "integer"
...
@dataclass(kw_only=True)
class Enumeration(EnumerationElemType):
    class Meta:
        name = "enumeration"
...
@dataclass(kw_only=True)
class ExternalProductAttributeElemType:
    class Meta:
        name = "externalProductAttributeElemType"
...
@dataclass(kw_only=True)
class ExternalProductAttribute(ExternalProductAttributeElemType):
    class Meta:
        name = "externalProductAttribute"
...
@dataclass(kw_only=True)
class CondCrossRefTableRefElemType:
    class Meta:
        name = "condCrossRefTableRefElemType"
...
@dataclass(kw_only=True)
class ProductCrossRefTableRefElemType:
    class Meta:
        name = "productCrossRefTableRefElemType"
...
@dataclass(kw_only=True)
class CondCrossRefTableRef(CondCrossRefTableRefElemType):
    class Meta:
        name = "condCrossRefTableRef"
...
@dataclass(kw_only=True)
class ProductCrossRefTableRef(ProductCrossRefTableRefElemType):
    class Meta:
        name = "productCrossRefTableRef"
...
@dataclass(kw_only=True)
class ExternalAssertElemType:
    class Meta:
        name = "externalAssertElemType"

    applic_cross_ref_table_ref: ApplicCrossRefTableRef = field(
        metadata={
            "name": "applicCrossRefTableRef",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class ExternalAssert(ExternalAssertElemType):
    class Meta:
        name = "externalAssert"
...
@dataclass(kw_only=True)
class AssociateElemType:
    class Meta:
        name = "associateElemType"

    external_assert: ExternalAssert = field(
        metadata={
            "name": "externalAssert",
            "type": "Element",
        }
    )
    association_type: AssociationTypeAttType = field(
        metadata={
...
@dataclass(kw_only=True)
class Associate(AssociateElemType):
    class Meta:
        name = "associate"
...
@dataclass(kw_only=True)
class ProductDefinitionRelationshipElemType:
    class Meta:
        name = "productDefinitionRelationshipElemType"
    ...
    associate: list[Associate] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
...
@dataclass(kw_only=True)
class ProductDefinitionRelationship(ProductDefinitionRelationshipElemType):
    class Meta:
        name = "productDefinitionRelationship"


@dataclass(kw_only=True)
class ApplicCrossRefTableCatalogElemType:
    class Meta:
        name = "applicCrossRefTableCatalogElemType"

    applic_cross_ref_table_ref: list[ApplicCrossRefTableRef] = field(
        default_factory=list,
        metadata={
            "name": "applicCrossRefTableRef",
            "type": "Element",
    ...
    product_definition_relationship: list[ProductDefinitionRelationship] = (
        field(
            default_factory=list,
            metadata={
                "name": "productDefinitionRelationship",
...
@dataclass(kw_only=True)
class ApplicCrossRefTableCatalog(ApplicCrossRefTableCatalogElemType):
    class Meta:
        name = "applicCrossRefTableCatalog"
...
@dataclass(kw_only=True)
class ProductAttributeElemType:
    class Meta:
        name = "productAttributeElemType"
    ...
    value_data_type: ValueDataTypeAttType = field(
        default=ValueDataTypeAttType.STRING,
        metadata={
            "name": "valueDataType",
            "type": "Attribute",
        },
    )
    value_pattern: None | str = field(
        default=None,
        metadata={
            "name": "valuePattern",
            "type": "Attribute",
    ...
    product_identifier: ProductIdentifierAttType = field(
        default=ProductIdentifierAttType.NO,
        metadata={
...
@dataclass(kw_only=True)
class ProductAttribute(ProductAttributeElemType):
    class Meta:
...
@dataclass(kw_only=True)
class ProductAttributeListElemType:
    class Meta:
        name = "productAttributeListElemType"

    product_attribute: list[ProductAttribute] = field(
        default_factory=list,
        metadata={
            "name": "productAttribute",
            "type": "Element",
    ...
    external_product_attribute: list[ExternalProductAttribute] = field(
        default_factory=list,
        metadata={
            "name": "externalProductAttribute",
            "type": "Element",
...
@dataclass(kw_only=True)
class ProductAttributeList(ProductAttributeListElemType):
    class Meta:
        name = "productAttributeList"


@dataclass(kw_only=True)
class ApplicCrossRefTableElemType:
    class Meta:
        name = "applicCrossRefTableElemType"

    applic_cross_ref_table_catalog: None | ApplicCrossRefTableCatalog = field(
        default=None,
        metadata={
            "name": "applicCrossRefTableCatalog",
            "type": "Element",
    ...
    product_attribute_list: None | ProductAttributeList = field(
        default=None,
        metadata={
            "name": "productAttributeList",
            "type": "Element",
    ...
    cond_cross_ref_table_ref: None | CondCrossRefTableRef = field(
        default=None,
        metadata={
            "name": "condCrossRefTableRef",
            "type": "Element",
    ...
    product_cross_ref_table_ref: None | ProductCrossRefTableRef = field(
        default=None,
        metadata={
            "name": "productCrossRefTableRef",
            "type": "Element",
...
@dataclass(kw_only=True)
class ApplicCrossRefTable(ApplicCrossRefTableElemType):
    class Meta:
        name = "applicCrossRefTable"
...
class ContentElemType:
    ...
    applic_cross_ref_table: ApplicCrossRefTable = field(
        metadata={
            "name": "applicCrossRefTable",
            "type": "Element",
        }
