...
class LimitUnitTypeAttType(Enum):
    LT01 = "lt01"
    LT02 = "lt02"
    LT03 = "lt03"
    LT04 = "lt04"
...
class MaintLevelCodeAttType(Enum):
    ML01 = "ml01"
    ML02 = "ml02"
    ML03 = "ml03"
    ML04 = "ml04"
...
class RelatedTaskDescrAttType(Enum):
    AFTER = "after"
    BEFORE = "before"
    COMPLIED = "complied"
    FINISHED = "finished"
...
@dataclass(kw_only=True)
class RemarkCodeElemType:
    class Meta:
        name = "remarkCodeElemType"
...
class SourceCriticalityAttType(Enum):
    SC01 = "sc01"
    SC02 = "sc02"
    SC03 = "sc03"
    SC04 = "sc04"
...
class SourceTypeCodeAttType(Enum):
    STC01 = "stc01"
    STC02 = "stc02"
    STC03 = "stc03"
    STC04 = "stc04"
...
class SupervisorLevelCodeAttType(Enum):
    SL01 = "sl01"
    SL02 = "sl02"
    SL03 = "sl03"
    SL04 = "sl04"
...
@dataclass(kw_only=True)
class TaskMarkerElemType:
    class Meta:
        name = "taskMarkerElemType"
...
class TimeLimitCategoryValueAttType(Enum):
    VALUE_1 = "1"
    VALUE_2 = "2"
...
@dataclass(kw_only=True)
class ToolsListCodeElemType:
    class Meta:
        name = "toolsListCodeElemType"
...
@dataclass(kw_only=True)
class TypeDesignationElemType:
    class Meta:
        name = "typeDesignationElemType"
...
@dataclass(kw_only=True)
class MaintLevelElemType:
    class Meta:
        name = "maintLevelElemType"

    maint_level_code: MaintLevelCodeAttType = field(
        metadata={
            "name": "maintLevelCode",
            "type": "Attribute",
        }
...
@dataclass(kw_only=True)
class RelatedTaskElemType:
    class Meta:
        name = "relatedTaskElemType"

    task_ident: str = field(
        metadata={
            "name": "taskIdent",
            "type": "Attribute",
        }
    )
    related_task_descr: RelatedTaskDescrAttType = field(
        metadata={
            "name": "relatedTaskDescr",
            "type": "Attribute",
        }
    )
...
@dataclass(kw_only=True)
class RemarkCode(RemarkCodeElemType):
    class Meta:
        name = "remarkCode"
...
@dataclass(kw_only=True)
class SourceTypeElemType:
    class Meta:
        name = "sourceTypeElemType"

    source_criticality: None | SourceCriticalityAttType = field(
        default=None,
        metadata={
    ...
    source_type_code: None | SourceTypeCodeAttType = field(
        default=None,
        metadata={
            "name": "sourceTypeCode",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class SupervisorLevelElemType:
    class Meta:
        name = "supervisorLevelElemType"

    supervisor_level_code: None | SupervisorLevelCodeAttType = field(
        default=None,
        metadata={
            "name": "supervisorLevelCode",
            "type": "Attribute",
        },
    )
    id: None | str = field(
...
@dataclass(kw_only=True)
class TaskMarker(TaskMarkerElemType):
    class Meta:
        name = "taskMarker"
...
@dataclass(kw_only=True)
class TimeLimitCategoryElemType:
    class Meta:
        name = "timeLimitCategoryElemType"

    time_limit_category_value: TimeLimitCategoryValueAttType = field(
        metadata={
            "name": "timeLimitCategoryValue",
            "type": "Attribute",
        }
    )
    change_type: None | ChangeTypeAttType = field(
...
@dataclass(kw_only=True)
class ToolsListCode(ToolsListCodeElemType):
    class Meta:
        name = "toolsListCode"
...
@dataclass(kw_only=True)
class TypeDesignation(TypeDesignationElemType):
    class Meta:
...
@dataclass(kw_only=True)
class MaintLevel(MaintLevelElemType):
    class Meta:
        name = "maintLevel"
...
@dataclass(kw_only=True)
class RelatedTask(RelatedTaskElemType):
    class Meta:
        name = "relatedTask"
...
@dataclass(kw_only=True)
class SourceType(SourceTypeElemType):
    class Meta:
        name = "sourceType"
...
@dataclass(kw_only=True)
class SupervisorLevel(SupervisorLevelElemType):
    class Meta:
        name = "supervisorLevel"
...
@dataclass(kw_only=True)
class TimeLimitCategory(TimeLimitCategoryElemType):
    class Meta:
        name = "timeLimitCategory"
...
@dataclass(kw_only=True)
class ComponentAssyElemType:
    class Meta:
        name = "componentAssyElemType"
    ...
    type_designation: list[TypeDesignation] = field(
        default_factory=list,
        metadata={
            "name": "typeDesignation",
            "type": "Element",
...
@dataclass(kw_only=True)
class MaintLevelGroupElemType:
    class Meta:
        name = "maintLevelGroupElemType"

    maint_level: list[MaintLevel] = field(
        default_factory=list,
        metadata={
            "name": "maintLevel",
            "type": "Element",
...
@dataclass(kw_only=True)
class RemarksRefsElemType:
    class Meta:
        name = "remarksRefsElemType"
...
@dataclass(kw_only=True)
class TaskDescrElemType:
    class Meta:
        name = "taskDescrElemType"
...
@dataclass(kw_only=True)
class ToolsRefsElemType:
    class Meta:
        name = "toolsRefsElemType"
...
@dataclass(kw_only=True)
class ComponentAssy(ComponentAssyElemType):
    class Meta:
        name = "componentAssy"
...
@dataclass(kw_only=True)
class MaintLevelGroup(MaintLevelGroupElemType):
    class Meta:
        name = "maintLevelGroup"
...
@dataclass(kw_only=True)
class RemarksRefs(RemarksRefsElemType):
    class Meta:
        name = "remarksRefs"
...
@dataclass(kw_only=True)
class TaskDescr(TaskDescrElemType):
    class Meta:
        name = "taskDescr"
...
@dataclass(kw_only=True)
class ToolsRefs(ToolsRefsElemType):
    class Meta:
        name = "toolsRefs"
...
@dataclass(kw_only=True)
class LimitTypeElemType:
    class Meta:
        name = "limitTypeElemType"
    ...
    limit_unit_type: None | LimitUnitTypeAttType = field(
        default=None,
        metadata={
            "name": "limitUnitType",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class RemarksGroupElemType:
    class Meta:
        name = "remarksGroupElemType"

    remark_code: RemarkCode = field(
        metadata={
            "name": "remarkCode",
            "type": "Element",
        }
...
class TaskElemType:
    ...
    task_title: None | TaskTitle = field(
        default=None,
        metadata={
            "name": "taskTitle",
            "type": "Element",
    ...
    task_descr: TaskDescr = field(
        metadata={
            "name": "taskDescr",
            "type": "Element",
        }
    )
    task_marker: None | TaskMarker = field(
        default=None,
        metadata={
            "name": "taskMarker",
            "type": "Element",
...
@dataclass(kw_only=True)
class LimitType(LimitTypeElemType):
    class Meta:
        name = "limitType"
...
@dataclass(kw_only=True)
class RemarksGroup(RemarksGroupElemType):
    class Meta:
        name = "remarksGroup"
...
@dataclass(kw_only=True)
class TimeLimitElemType:
    class Meta:
        name = "timeLimitElemType"

    limit_type: list[LimitType] = field(
        default_factory=list,
        metadata={
            "name": "limitType",
            "type": "Element",
...
@dataclass(kw_only=True)
class TimeLimit(TimeLimitElemType):
    class Meta:
        name = "timeLimit"
...
@dataclass(kw_only=True)
class RqmtSourceElemType:
    class Meta:
        name = "rqmtSourceElemType"
    ...
    source_of_rqmt: str = field(
        metadata={
            "name": "sourceOfRqmt",
            "type": "Attribute",
        }
    )
    approval: None | str = field(
        default=None,
        metadata={
            "type": "Attribute",
        },
...
@dataclass(kw_only=True)
class RqmtSource(RqmtSourceElemType):
    class Meta:
        name = "rqmtSource"
...
@dataclass(kw_only=True)
class GroupNumberElemType:
    class Meta:
        name = "groupNumberElemType"
...
@dataclass(kw_only=True)
class MaintFunctionElemType:
    class Meta:
        name = "maintFunctionElemType"
    ...
    function: FunctionAttType = field(
        metadata={
            "type": "Attribute",
        }
    )
...
@dataclass(kw_only=True)
class TaskItemElemType:
    class Meta:
        name = "taskItemElemType"
    ...
    task: None | Task = field(
        default=None,
        metadata={
            "type": "Element",
        },
    )
    task_seq_number: str = field(
        metadata={
            "name": "taskSeqNumber",
            "type": "Attribute",
        }
...
@dataclass(kw_only=True)
class GroupNumber(GroupNumberElemType):
    class Meta:
        name = "groupNumber"
...
@dataclass(kw_only=True)
class MaintFunction(MaintFunctionElemType):
    class Meta:
        name = "maintFunction"
...
@dataclass(kw_only=True)
class TaskItem(TaskItemElemType):
    class Meta:
        name = "taskItem"
...
@dataclass(kw_only=True)
class MaintQualifierElemType:
    class Meta:
        name = "maintQualifierElemType"

    maint_function: MaintFunction = field(
        metadata={
            "name": "maintFunction",
            "type": "Element",
        }
    )
    maint_level_group: MaintLevelGroup = field(
        metadata={
            "name": "maintLevelGroup",
            "type": "Element",
        }
    )
    tools_refs: None | ToolsRefs = field(
        default=None,
        metadata={
            "name": "toolsRefs",
            "type": "Element",
    ...
    remarks_refs: None | RemarksRefs = field(
        default=None,
        metadata={
            "name": "remarksRefs",
            "type": "Element",
...
@dataclass(kw_only=True)
class TaskGroupElemType:
    class Meta:
        name = "taskGroupElemType"

    task_item: list[TaskItem] = field(
        default_factory=list,
        metadata={
            "name": "taskItem",
            "type": "Element",
...
@dataclass(kw_only=True)
class ToolsListGroupElemType:
    class Meta:
        name = "toolsListGroupElemType"

    tools_list_code: ToolsListCode = field(
        metadata={
            "name": "toolsListCode",
            "type": "Element",
        }
    )
    maint_level: MaintLevel = field(
        metadata={
            "name": "maintLevel",
            "type": "Element",
        }
    ...
    nato_stock_number: NatoStockNumber = field(
        metadata={
            "name": "natoStockNumber",
            "type": "Element",
        }
    )
    tool_ref: ToolRef = field(
        metadata={
            "name": "toolRef",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class MaintQualifier(MaintQualifierElemType):
    class Meta:
        name = "maintQualifier"


@dataclass(kw_only=True)
class TaskGroup(TaskGroupElemType):
    class Meta:
        name = "taskGroup"


@dataclass(kw_only=True)
class ToolsListGroup(ToolsListGroupElemType):
    class Meta:
        name = "toolsListGroup"
...
@dataclass(kw_only=True)
class ComponentAssyGroupElemType:
    class Meta:
        name = "componentAssyGroupElemType"

    component_assy: ComponentAssy = field(
        metadata={
            "name": "componentAssy",
            "type": "Element",
        }
    )
    maint_qualifier: list[MaintQualifier] = field(
        default_factory=list,
        metadata={
            "name": "maintQualifier",
            "type": "Element",
...
@dataclass(kw_only=True)
class EquipGroupElemType:
    class Meta:
        name = "equipGroupElemType"

    equip: list[Equip] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
...
@dataclass(kw_only=True)
class InspectionElemType:
    class Meta:
        name = "inspectionElemType"
...
@dataclass(kw_only=True)
class ComponentAssyGroup(ComponentAssyGroupElemType):
    class Meta:
        name = "componentAssyGroup"
...
@dataclass(kw_only=True)
class EquipGroup(EquipGroupElemType):
    class Meta:
        name = "equipGroup"


@dataclass(kw_only=True)
class Inspection(InspectionElemType):
    class Meta:
        name = "inspection"
...
@dataclass(kw_only=True)
class InspectionDefinitionElemType:
    class Meta:
        name = "inspectionDefinitionElemType"
    ...
    task_group: None | TaskGroup = field(
        default=None,
        metadata={
            "name": "taskGroup",
            "type": "Element",
    ...
    rqmt_source: list[RqmtSource] = field(
        default_factory=list,
        metadata={
            "name": "rqmtSource",
            "type": "Element",
...
@dataclass(kw_only=True)
class MaintAllocationGroupElemType:
    class Meta:
        name = "maintAllocationGroupElemType"

    group_number: GroupNumber = field(
        metadata={
            "name": "groupNumber",
            "type": "Element",
        }
    )
    component_assy: None | ComponentAssy = field(
        default=None,
        metadata={
            "name": "componentAssy",
            "type": "Element",
    ...
    component_assy_group: list[ComponentAssyGroup] = field(
        default_factory=list,
        metadata={
            "name": "componentAssyGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class TimeLimitInfoElemType:
    class Meta:
        name = "timeLimitInfoElemType"

    equip_group: EquipGroup = field(
        metadata={
            "name": "equipGroup",
            "type": "Element",
        }
    ...
    time_limit_category: None | TimeLimitCategory = field(
        default=None,
        metadata={
            "name": "timeLimitCategory",
            "type": "Element",
    ...
    time_limit: list[TimeLimit] = field(
        default_factory=list,
        metadata={
            "name": "timeLimit",
            "type": "Element",
...
@dataclass(kw_only=True)
class InspectionDefinition(InspectionDefinitionElemType):
    class Meta:
        name = "inspectionDefinition"
...
@dataclass(kw_only=True)
class MaintAllocationGroup(MaintAllocationGroupElemType):
    class Meta:
        name = "maintAllocationGroup"
...
@dataclass(kw_only=True)
class TimeLimitInfo(TimeLimitInfoElemType):
    class Meta:
        name = "timeLimitInfo"
...
@dataclass(kw_only=True)
class MaintAllocationElemType:
    class Meta:
        name = "maintAllocationElemType"
    ...
    maint_allocation_group: list[MaintAllocationGroup] = field(
        default_factory=list,
        metadata={
            "name": "maintAllocationGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class RemarksListElemType:
    class Meta:
        name = "remarksListElemType"
    ...
    remarks_group: list[RemarksGroup] = field(
        default_factory=list,
        metadata={
            "name": "remarksGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class ToolsListElemType:
    class Meta:
        name = "toolsListElemType"
    ...
    tools_list_group: list[ToolsListGroup] = field(
        default_factory=list,
        metadata={
            "name": "toolsListGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class MaintAllocation(MaintAllocationElemType):
    class Meta:
        name = "maintAllocation"
...
@dataclass(kw_only=True)
class RemarksList(RemarksListElemType):
    class Meta:
        name = "remarksList"


@dataclass(kw_only=True)
class ToolsList(ToolsListElemType):
    class Meta:
        name = "toolsList"
...
@dataclass(kw_only=True)
class TaskDefinitionElemType:
    class Meta:
        name = "taskDefinitionElemType"
    ...
    equip_group: None | EquipGroup = field(
        default=None,
        metadata={
            "name": "equipGroup",
            "type": "Element",
    ...
    supervisor_level: None | SupervisorLevel = field(
        default=None,
        metadata={
            "name": "supervisorLevel",
            "type": "Element",
    ...
    related_task: list[RelatedTask] = field(
        default_factory=list,
        metadata={
            "name": "relatedTask",
            "type": "Element",
    ...
    task_code: None | TaskCodeAttType = field(
        default=None,
        metadata={
            "name": "taskCode",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class TaskDefinition(TaskDefinitionElemType):
    class Meta:
        name = "taskDefinition"
...
@dataclass(kw_only=True)
class TaskDefinitionAltsElemType:
    class Meta:
        name = "taskDefinitionAltsElemType"

    task_definition: list[TaskDefinition] = field(
        default_factory=list,
        metadata={
            "name": "taskDefinition",
            "type": "Element",
...
@dataclass(kw_only=True)
class TaskDefinitionAlts(TaskDefinitionAltsElemType):
    class Meta:
        name = "taskDefinitionAlts"
...
@dataclass(kw_only=True)
class MaintPlanningElemType:
    class Meta:
        name = "maintPlanningElemType"
    ...
    inspection_definition: list[InspectionDefinition] = field(
        default_factory=list,
        metadata={
            "name": "inspectionDefinition",
            "type": "Element",
    ...
    task_definition_alts: list[TaskDefinitionAlts] = field(
        default_factory=list,
        metadata={
            "name": "taskDefinitionAlts",
            "type": "Element",
    ...
    time_limit_info: list[TimeLimitInfo] = field(
        default_factory=list,
        metadata={
            "name": "timeLimitInfo",
            "type": "Element",
    ...
    maint_allocation: None | MaintAllocation = field(
        default=None,
        metadata={
            "name": "maintAllocation",
            "type": "Element",
    ...
    tools_list: None | ToolsList = field(
        default=None,
        metadata={
            "name": "toolsList",
            "type": "Element",
    ...
    remarks_list: None | RemarksList = field(
        default=None,
        metadata={
            "name": "remarksList",
            "type": "Element",
    ...
    maint_planning_type: None | str = field(
        default=None,
        metadata={
            "name": "maintPlanningType",
            "type": "Attribute",
        },
    )
...
@dataclass(kw_only=True)
class MaintPlanning(MaintPlanningElemType):
    class Meta:
        name = "maintPlanning"
...
class ContentElemType:
    ...
    maint_planning: MaintPlanning = field(
        metadata={
            "name": "maintPlanning",
            "type": "Element",
        }
