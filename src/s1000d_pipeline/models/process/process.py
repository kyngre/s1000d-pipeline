...
class CancelCaptionAttType(Enum):
    CA01 = "ca01"
    CA02 = "ca02"
    CA03 = "ca03"
    CA04 = "ca04"
...
class ChoiceSelectionAttType(Enum):
    SINGLE = "single"
    MULTIPLE = "multiple"


class ChoiceTypeAttType(Enum):
    SELECT = "select"
    PULLDOWN = "pulldown"
...
class MenuChoiceFlowAttType(Enum):
    LIST = "list"
    INLINE = "inline"
...
@dataclass(kw_only=True)
class NoAssertionsElemType:
    class Meta:
        name = "noAssertionsElemType"
...
class ResetCaptionAttType(Enum):
    RE01 = "re01"
    RE02 = "re02"
    RE03 = "re03"
    RE04 = "re04"
...
@dataclass(kw_only=True)
class ReturnedValueName:
    class Meta:
        name = "returnedValueName"

    value: str = field(default="")


@dataclass(kw_only=True)
class ReturnedValuePosition:
    class Meta:
        name = "returnedValuePosition"
...
class SubmitCaptionAttType(Enum):
    OK01 = "ok01"
    OK02 = "ok02"
    OK03 = "ok03"
    OK04 = "ok04"
...
class TextDisplayPositionAttType(Enum):
    TOP = "top"
    BOTTOM = "bottom"
    RIGHT = "right"
    LEFT = "left"
...
class VariableScopeAttType(Enum):
    LOCAL = "local"
...
@dataclass(kw_only=True)
class NoAssertions(NoAssertionsElemType):
    class Meta:
        name = "noAssertions"
...
@dataclass(kw_only=True)
class ReceiveByNameElemType:
    class Meta:
        name = "receiveByNameElemType"

    returned_value_name: ReturnedValueName = field(
        metadata={
            "name": "returnedValueName",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class ReceiveByPositionElemType:
    class Meta:
        name = "receiveByPositionElemType"

    returned_value_position: ReturnedValuePosition = field(
        metadata={
            "name": "returnedValuePosition",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class ReceiveValueElemType:
    class Meta:
        name = "receiveValueElemType"
...
@dataclass(kw_only=True)
class ReceiveByName(ReceiveByNameElemType):
    class Meta:
        name = "receiveByName"


@dataclass(kw_only=True)
class ReceiveByPosition(ReceiveByPositionElemType):
    class Meta:
        name = "receiveByPosition"


@dataclass(kw_only=True)
class ReceiveValue(ReceiveValueElemType):
    class Meta:
        name = "receiveValue"
...
@dataclass(kw_only=True)
class ExternalApplicationElemType:
    class Meta:
        name = "externalApplicationElemType"

    para_basic: ParaBasic = field(
        metadata={
            "name": "paraBasic",
            "type": "Element",
        }
    ...
    receive_value: list[ReceiveValue] = field(
        default_factory=list,
        metadata={
            "name": "receiveValue",
            "type": "Element",
    ...
    receive_by_name: list[ReceiveByName] = field(
        default_factory=list,
        metadata={
            "name": "receiveByName",
            "type": "Element",
    ...
    receive_by_position: list[ReceiveByPosition] = field(
        default_factory=list,
        metadata={
            "name": "receiveByPosition",
            "type": "Element",
...
@dataclass(kw_only=True)
class DefaultElemType:
    class Meta:
        name = "defaultElemType"
...
@dataclass(kw_only=True)
class EnabledStateElemType:
    class Meta:
        name = "enabledStateElemType"
...
@dataclass(kw_only=True)
class ExternalApplication(ExternalApplicationElemType):
    class Meta:
...
@dataclass(kw_only=True)
class InitializeElemType:
    class Meta:
        name = "initializeElemType"
...
@dataclass(kw_only=True)
class ValidateElemType:
    class Meta:
        name = "validateElemType"
...
@dataclass(kw_only=True)
class EnabledState(EnabledStateElemType):
    class Meta:
        name = "enabledState"
...
@dataclass(kw_only=True)
class Initialize(InitializeElemType):
    class Meta:
        name = "initialize"
...
@dataclass(kw_only=True)
class Validate(ValidateElemType):
    class Meta:
        name = "validate"
...
@dataclass(kw_only=True)
class VariablePreSetElemType:
    class Meta:
        name = "variablePreSetElemType"
...
@dataclass(kw_only=True)
class VariablePreSet(VariablePreSetElemType):
    class Meta:
        name = "variablePreSet"
...
@dataclass(kw_only=True)
class PromptElemType:
    class Meta:
        name = "promptElemType"

    para_basic: list[ParaBasic] = field(
        default_factory=list,
        metadata={
            "name": "paraBasic",
            "type": "Element",
    ...
    sub_script: list[SubScript] = field(
        default_factory=list,
        metadata={
            "name": "subScript",
            "type": "Element",
    ...
    super_script: list[SuperScript] = field(
        default_factory=list,
        metadata={
            "name": "superScript",
            "type": "Element",
    ...
    variable_ref: list[VariableRef] = field(
        default_factory=list,
        metadata={
            "name": "variableRef",
            "type": "Element",
    ...
    global_property_ref: list[GlobalPropertyRef] = field(
        default_factory=list,
        metadata={
            "name": "globalPropertyRef",
            "type": "Element",
    ...
    text_display_position: None | TextDisplayPositionAttType = field(
        default=None,
        metadata={
...
class MessageElemType:
    ...
    submit_caption: SubmitCaptionAttType = field(
        default=SubmitCaptionAttType.OK01,
        metadata={
            "name": "submitCaption",
            "type": "Attribute",
        },
    )
    cancel_caption: CancelCaptionAttType = field(
        default=CancelCaptionAttType.CA01,
        metadata={
            "name": "cancelCaption",
            "type": "Attribute",
        },
...
class DialogElemType:
    ...
    user_entry: list[UserEntry] = field(
        default_factory=list,
        metadata={
            "name": "userEntry",
            "type": "Element",
    ...
    menu: list[Menu] = field(
        default_factory=list,
        metadata={
            "type": "Element",
        },
    )
    push_button: list[PushButton] = field(
        default_factory=list,
        metadata={
            "name": "pushButton",
            "type": "Element",
    ...
    dialog_group: list[DialogGroup] = field(
        default_factory=list,
        metadata={
            "name": "dialogGroup",
            "type": "Element",
    ...
    reset_caption: None | ResetCaptionAttType = field(
        default=None,
        metadata={
            "name": "resetCaption",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class MessageAltsElemType:
    class Meta:
        name = "messageAltsElemType"
...
@dataclass(kw_only=True)
class Dialog(DialogElemType):
    class Meta:
        name = "dialog"


@dataclass(kw_only=True)
class MessageAlts(MessageAltsElemType):
    class Meta:
        name = "messageAlts"
...
@dataclass(kw_only=True)
class DialogAltsElemType:
    class Meta:
        name = "dialogAltsElemType"
...
@dataclass(kw_only=True)
class PushButtonElemType:
    class Meta:
        name = "pushButtonElemType"

    enabled_state: None | EnabledState = field(
        default=None,
        metadata={
            "name": "enabledState",
            "type": "Element",
    ...
    external_application: None | ExternalApplication = field(
        default=None,
        metadata={
            "name": "externalApplication",
            "type": "Element",
...
@dataclass(kw_only=True)
class DialogAlts(DialogAltsElemType):
    class Meta:
        name = "dialogAlts"
...
@dataclass(kw_only=True)
class PushButton(PushButtonElemType):
    class Meta:
        name = "pushButton"
...
@dataclass(kw_only=True)
class MenuChoiceElemType:
    class Meta:
        name = "menuChoiceElemType"
    ...
    no_assertions: None | NoAssertions = field(
        default=None,
        metadata={
            "name": "noAssertions",
            "type": "Element",
    ...
    menu_choice_default_flag: str = field(
        default="0",
        metadata={
            "name": "menuChoiceDefaultFlag",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
...
@dataclass(kw_only=True)
class UserEntryElemType:
    class Meta:
        name = "userEntryElemType"
    ...
    default: None | Default = field(
        default=None,
        metadata={
            "type": "Element",
        },
    )
    validate_value: None | Validate = field(
        default=None,
        metadata={
            "name": "validate",
            "type": "Element",
    ...
    data_entry_field_length: int = field(
        default=20,
        metadata={
            "name": "dataEntryFieldLength",
            "type": "Attribute",
        },
    )
    applic_ref_id: None | str = field(
...
@dataclass(kw_only=True)
class VariableElemType:
    class Meta:
        name = "variableElemType"
    ...
    dialog_alts: None | DialogAlts = field(
        default=None,
        metadata={
            "name": "dialogAlts",
            "type": "Element",
    ...
    initialize: None | Initialize = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    product_configuration_flag: str = field(
        default="0",
        metadata={
            "name": "productConfigurationFlag",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    value_type: ValueTypeAttType = field(
        default=ValueTypeAttType.INTEGER,
        metadata={
            "name": "valueType",
            "type": "Attribute",
        },
    )
    value_precision: None | str = field(
        default=None,
        metadata={
            "name": "valuePrecision",
            "type": "Attribute",
    ...
    variable_scope: VariableScopeAttType = field(
        default=VariableScopeAttType.LOCAL,
        metadata={
            "name": "variableScope",
            "type": "Attribute",
        },
...
@dataclass(kw_only=True)
class MenuChoice(MenuChoiceElemType):
    class Meta:
        name = "menuChoice"


@dataclass(kw_only=True)
class UserEntry(UserEntryElemType):
    class Meta:
        name = "userEntry"


@dataclass(kw_only=True)
class Variable(VariableElemType):
    class Meta:
        name = "variable"
...
class MenuElemType:
    ...
    prompt: None | Prompt = field(
        default=None,
        metadata={
            "type": "Element",
        },
    )
    menu_choice: list[MenuChoice] = field(
        default_factory=list,
        metadata={
            "name": "menuChoice",
            "type": "Element",
    ...
    choice_selection: ChoiceSelectionAttType = field(
        default=ChoiceSelectionAttType.SINGLE,
        metadata={
            "name": "choiceSelection",
            "type": "Attribute",
        },
    )
    choice_type: ChoiceTypeAttType = field(
        metadata={
            "name": "choiceType",
            "type": "Attribute",
        }
    )
    menu_choice_flow: MenuChoiceFlowAttType = field(
        default=MenuChoiceFlowAttType.LIST,
        metadata={
            "name": "menuChoiceFlow",
            "type": "Attribute",
        },
...
@dataclass(kw_only=True)
class VariableDeclarationsElemType:
    class Meta:
        name = "variableDeclarationsElemType"
...
@dataclass(kw_only=True)
class VariableDeclarations(VariableDeclarationsElemType):
    class Meta:
...
@dataclass(kw_only=True)
class DialogGroupElemType:
    class Meta:
        name = "dialogGroupElemType"
    ...
    dialog_separator: str = field(
        default="0",
        metadata={
            "name": "dialogSeparator",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
...
@dataclass(kw_only=True)
class DialogGroup(DialogGroupElemType):
    class Meta:
        name = "dialogGroup"
...
class DmNodeElemType:
    ...
    variable_pre_set: list[VariablePreSet] = field(
        default_factory=list,
        metadata={
            "name": "variablePreSet",
            "type": "Element",
    ...
    dialog_alts: list[DialogAlts] = field(
        default_factory=list,
        metadata={
            "name": "dialogAlts",
            "type": "Element",
    ...
    message_alts: list[MessageAlts] = field(
        default_factory=list,
        metadata={
            "name": "messageAlts",
            "type": "Element",
...
@dataclass(kw_only=True)
class DmNode(DmNodeElemType):
    class Meta:
        name = "dmNode"


@dataclass(kw_only=True)
class DmNodeAltsElemType:
    class Meta:
        name = "dmNodeAltsElemType"

    dm_node: list[DmNode] = field(
        default_factory=list,
        metadata={
            "name": "dmNode",
            "type": "Element",
...
@dataclass(kw_only=True)
class DmNodeAlts(DmNodeAltsElemType):
    class Meta:
        name = "dmNodeAlts"


@dataclass(kw_only=True)
class DmSeqGenericElemType:
    class Meta:
        name = "dmSeqGenericElemType"
    ...
    dm_node_alts: list[DmNodeAlts] = field(
        default_factory=list,
        metadata={
            "name": "dmNodeAlts",
            "type": "Element",
    ...
    dm_seq_alts: list[DmSeqAlts] = field(
        default_factory=list,
        metadata={
            "name": "dmSeqAlts",
            "type": "Element",
...
@dataclass(kw_only=True)
class DmElseSeq(DmSeqGenericElemType):
    class Meta:
        name = "dmElseSeq"


@dataclass(kw_only=True)
class DmSeq(DmSeqGenericElemType):
    class Meta:
        name = "dmSeq"


@dataclass(kw_only=True)
class DmThenSeq(DmSeqGenericElemType):
    class Meta:
        name = "dmThenSeq"
...
class DmIfElemType:
    ...
    dm_then_seq: DmThenSeq = field(
        metadata={
            "name": "dmThenSeq",
            "type": "Element",
        }
    )
    dm_else_seq: None | DmElseSeq = field(
        default=None,
        metadata={
            "name": "dmElseSeq",
            "type": "Element",
...
@dataclass(kw_only=True)
class DmLoopElemType:
    class Meta:
        name = "dmLoopElemType"

    variable_pre_set: None | VariablePreSet = field(
        default=None,
        metadata={
            "name": "variablePreSet",
            "type": "Element",
    ...
    assertion: None | Assertion = field(
        default=None,
        metadata={
            "type": "Element",
        },
...
@dataclass(kw_only=True)
class DmSeqAltsElemType:
    class Meta:
        name = "dmSeqAltsElemType"

    dm_seq: list[DmSeq] = field(
        default_factory=list,
        metadata={
            "name": "dmSeq",
            "type": "Element",
...
@dataclass(kw_only=True)
class ProcessElemType:
    class Meta:
        name = "processElemType"

    variable_declarations: None | VariableDeclarations = field(
        default=None,
        metadata={
            "name": "variableDeclarations",
            "type": "Element",
    ...
    close_rqmts: None | CloseRqmts = field(
        default=None,
        metadata={
            "name": "closeRqmts",
            "type": "Element",
...
@dataclass(kw_only=True)
class DmIf(DmIfElemType):
    class Meta:
        name = "dmIf"


@dataclass(kw_only=True)
class DmLoop(DmLoopElemType):
    class Meta:
        name = "dmLoop"


@dataclass(kw_only=True)
class DmSeqAlts(DmSeqAltsElemType):
    class Meta:
        name = "dmSeqAlts"


@dataclass(kw_only=True)
class Process(ProcessElemType):
    class Meta:
        name = "process"
