...
from s1000d_pipeline.models.condcrossreftable.rdf import Description
from s1000d_pipeline.models.condcrossreftable.xlink import (
    ActuateValue,
    ShowValue,
    TypeValue,
)
from s1000d_pipeline.models.condcrossreftable.xml import SpaceValue
...
@dataclass(kw_only=True)
class DependencyElemType:
    class Meta:
        name = "dependencyElemType"

    for_cond_values: str = field(
        metadata={
            "name": "forCondValues",
            "type": "Attribute",
            "pattern": r"[^~|\t\n\r]+(~[^~|\t\n\r]+)?(\|[^~|\t\n\r]+(~[^~|\t\n\r]+)?)*",
...
class IncorporationStatusAttType(Enum):
    NOEFFECT = "noeffect"
...
@dataclass(kw_only=True)
class CondRefElemType:
    class Meta:
        name = "condRefElemType"
...
@dataclass(kw_only=True)
class Dependency(DependencyElemType):
    class Meta:
        name = "dependency"
...
@dataclass(kw_only=True)
class ExternalCondElemType:
    class Meta:
        name = "externalCondElemType"
...
@dataclass(kw_only=True)
class IncorporationStatusElemType:
    class Meta:
        name = "incorporationStatusElemType"

    incorporation_status: IncorporationStatusAttType = field(
        metadata={
...
@dataclass(kw_only=True)
class ExternalCond(ExternalCondElemType):
    class Meta:
        name = "externalCond"
...
@dataclass(kw_only=True)
class IncorporationStatus(IncorporationStatusElemType):
    class Meta:
        name = "incorporationStatus"
...
@dataclass(kw_only=True)
class CondRefGroupElemType:
    class Meta:
        name = "condRefGroupElemType"

    cond_ref: list[CondRef] = field(
        default_factory=list,
        metadata={
            "name": "condRef",
            "type": "Element",
    ...
    cond_descr: list[CondDescr] = field(
        default_factory=list,
        metadata={
            "name": "condDescr",
            "type": "Element",
    ...
    cond_ref_group_type: str = field(
        metadata={
            "name": "condRefGroupType",
            "type": "Attribute",
        }
    )
    change_type: None | ChangeTypeAttType = field(
...
@dataclass(kw_only=True)
class CondTypeElemType:
    class Meta:
        name = "condTypeElemType"
...
@dataclass(kw_only=True)
class CondRefGroup(CondRefGroupElemType):
    class Meta:
        name = "condRefGroup"


@dataclass(kw_only=True)
class CondType(CondTypeElemType):
    class Meta:
        name = "condType"
...
@dataclass(kw_only=True)
class CondTypeListElemType:
    class Meta:
        name = "condTypeListElemType"

    cond_type: list[CondType] = field(
        default_factory=list,
        metadata={
            "name": "condType",
            "type": "Element",
...
@dataclass(kw_only=True)
class CondTypeList(CondTypeListElemType):
    class Meta:
        name = "condTypeList"
...
@dataclass(kw_only=True)
class DocumentIncorporationElemType:
    class Meta:
        name = "documentIncorporationElemType"
    ...
    incorporation_status: list[IncorporationStatus] = field(
        default_factory=list,
        metadata={
            "name": "incorporationStatus",
            "type": "Element",
...
@dataclass(kw_only=True)
class DocumentIncorporation(DocumentIncorporationElemType):
    class Meta:
        name = "documentIncorporation"
...
@dataclass(kw_only=True)
class CondIncorporationElemType:
    class Meta:
        name = "condIncorporationElemType"

    document_incorporation: list[DocumentIncorporation] = field(
        default_factory=list,
        metadata={
            "name": "documentIncorporation",
            "type": "Element",
    ...
    cond_issue_number: None | str = field(
        default=None,
        metadata={
            "name": "condIssueNumber",
            "type": "Attribute",
        },
    )
    change_type: None | ChangeTypeAttType = field(
...
@dataclass(kw_only=True)
class CondIncorporation(CondIncorporationElemType):
    class Meta:
        name = "condIncorporation"
...
@dataclass(kw_only=True)
class IncorporationElemType:
    class Meta:
        name = "incorporationElemType"

    cond_incorporation: list[CondIncorporation] = field(
        default_factory=list,
        metadata={
            "name": "condIncorporation",
            "type": "Element",
...
@dataclass(kw_only=True)
class Incorporation(IncorporationElemType):
    class Meta:
        name = "incorporation"
...
class CondElemType:
    ...
    cond_ref_group: list[CondRefGroup] = field(
        default_factory=list,
        metadata={
            "name": "condRefGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class CondListElemType:
    class Meta:
        name = "condListElemType"

    cond: list[Cond] = field(
        default_factory=list,
        metadata={
            "type": "Element",
        },
    )
    external_cond: list[ExternalCond] = field(
        default_factory=list,
        metadata={
            "name": "externalCond",
            "type": "Element",
...
@dataclass(kw_only=True)
class CondList(CondListElemType):
    class Meta:
        name = "condList"
...
@dataclass(kw_only=True)
class CondCrossRefTableElemType:
    class Meta:
        name = "condCrossRefTableElemType"

    cond_type_list: CondTypeList = field(
        metadata={
            "name": "condTypeList",
            "type": "Element",
        }
    )
    cond_list: CondList = field(
        metadata={
            "name": "condList",
            "type": "Element",
        }
    )
    incorporation: None | Incorporation = field(
        default=None,
        metadata={
            "type": "Element",
        },
...
@dataclass(kw_only=True)
class CondCrossRefTable(CondCrossRefTableElemType):
    class Meta:
        name = "condCrossRefTable"
...
class ContentElemType:
    ...
    cond_cross_ref_table: CondCrossRefTable = field(
        metadata={
            "name": "condCrossRefTable",
            "type": "Element",
        }
