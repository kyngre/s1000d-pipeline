...
class IcnInfoItemTypeAttType(Enum):
    IIIT01 = "iiit01"
    IIIT02 = "iiit02"
    IIIT03 = "iiit03"
    IIIT04 = "iiit04"
...
class IcnResourceFileTypeAttType(Enum):
    IRFT01 = "irft01"
    IRFT02 = "irft02"
    IRFT03 = "irft03"
    IRFT04 = "irft04"
...
class IcnSourceFileTypeAttType(Enum):
    ISFT01 = "isft01"
    ISFT02 = "isft02"
    ISFT03 = "isft03"
    ISFT04 = "isft04"
...
@dataclass(kw_only=True)
class ImfCodeElemType:
    class Meta:
        name = "imfCodeElemType"

    imf_ident_icn: str = field(
        metadata={
            "name": "imfIdentIcn",
            "type": "Attribute",
        }
...
@dataclass(kw_only=True)
class LegacyIdentElemType:
    class Meta:
        name = "legacyIdentElemType"

    legacy_origin: None | str = field(
        default=None,
        metadata={
            "name": "legacyOrigin",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class IcnKeywordGroupElemType:
    class Meta:
        name = "icnKeywordGroupElemType"

    icn_keyword: list[IcnKeyword] = field(
        default_factory=list,
        metadata={
            "name": "icnKeyword",
            "type": "Element",
...
@dataclass(kw_only=True)
class IcnTitleElemType:
    class Meta:
        name = "icnTitleElemType"
...
@dataclass(kw_only=True)
class LegacyIdent(LegacyIdentElemType):
    class Meta:
        name = "legacyIdent"
...
@dataclass(kw_only=True)
class IcnKeywordGroup(IcnKeywordGroupElemType):
    class Meta:
        name = "icnKeywordGroup"


@dataclass(kw_only=True)
class IcnTitle(IcnTitleElemType):
    class Meta:
        name = "icnTitle"


@dataclass(kw_only=True)
class ImfIdentElemType:
    class Meta:
        name = "imfIdentElemType"

    imf_code: ImfCode = field(
        metadata={
            "name": "imfCode",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class LegacyIdentGroupElemType:
    class Meta:
        name = "legacyIdentGroupElemType"

    legacy_ident: list[LegacyIdent] = field(
        default_factory=list,
        metadata={
            "name": "legacyIdent",
            "type": "Element",
...
@dataclass(kw_only=True)
class IcnInfoItemElemType:
    class Meta:
        name = "icnInfoItemElemType"
    ...
    icn_info_item_type: IcnInfoItemTypeAttType = field(
        metadata={
            "name": "icnInfoItemType",
            "type": "Attribute",
        }
    )
...
@dataclass(kw_only=True)
class ImfIdent(ImfIdentElemType):
    class Meta:
        name = "imfIdent"


@dataclass(kw_only=True)
class LegacyIdentGroup(LegacyIdentGroupElemType):
    class Meta:
        name = "legacyIdentGroup"
...
@dataclass(kw_only=True)
class IcnInfoItem(IcnInfoItemElemType):
    class Meta:
        name = "icnInfoItem"


@dataclass(kw_only=True)
class ImfAddressItemsElemType:
    class Meta:
        name = "imfAddressItemsElemType"

    icn_title: IcnTitle = field(
        metadata={
            "name": "icnTitle",
            "type": "Element",
        }
    )
    legacy_ident_group: None | LegacyIdentGroup = field(
        default=None,
        metadata={
            "name": "legacyIdentGroup",
            "type": "Element",
    ...
    icn_keyword_group: None | IcnKeywordGroup = field(
        default=None,
        metadata={
            "name": "icnKeywordGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class IcnInfoItemGroupElemType:
    class Meta:
        name = "icnInfoItemGroupElemType"

    icn_info_item: list[IcnInfoItem] = field(
        default_factory=list,
        metadata={
            "name": "icnInfoItem",
            "type": "Element",
...
@dataclass(kw_only=True)
class ImfAddressItems(ImfAddressItemsElemType):
    class Meta:
        name = "imfAddressItems"
...
@dataclass(kw_only=True)
class IcnInfoItemGroup(IcnInfoItemGroupElemType):
    class Meta:
        name = "icnInfoItemGroup"


@dataclass(kw_only=True)
class ImfAddressElemType:
    class Meta:
        name = "imfAddressElemType"

    imf_ident: ImfIdent = field(
        metadata={
            "name": "imfIdent",
            "type": "Element",
        }
    )
    imf_address_items: ImfAddressItems = field(
        metadata={
            "name": "imfAddressItems",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class ImfAddress(ImfAddressElemType):
    class Meta:
        name = "imfAddress"
...
@dataclass(kw_only=True)
class IcnObjectElemType:
    class Meta:
        name = "icnObjectElemType"

    icn_object: list[IcnObject] = field(
        default_factory=list,
        metadata={
            "name": "icnObject",
            "type": "Element",
    ...
    icn_object_ident: None | str = field(
        default=None,
        metadata={
            "name": "icnObjectIdent",
            "type": "Attribute",
    ...
    icn_object_name: None | str = field(
        default=None,
        metadata={
            "name": "icnObjectName",
            "type": "Attribute",
    ...
    icn_object_type: None | str = field(
        default=None,
        metadata={
            "name": "icnObjectType",
            "type": "Attribute",
    ...
    icn_object_title: None | str = field(
        default=None,
        metadata={
            "name": "icnObjectTitle",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class IcnObject(IcnObjectElemType):
    class Meta:
        name = "icnObject"
...
@dataclass(kw_only=True)
class IcnObjectGroupElemType:
    class Meta:
        name = "icnObjectGroupElemType"
...
@dataclass(kw_only=True)
class IcnSupportingFilesDescrElemType:
    class Meta:
        name = "icnSupportingFilesDescrElemType"
...
@dataclass(kw_only=True)
class IcnObjectGroup(IcnObjectGroupElemType):
    class Meta:
        name = "icnObjectGroup"


@dataclass(kw_only=True)
class IcnSupportingFilesDescr(IcnSupportingFilesDescrElemType):
    class Meta:
        name = "icnSupportingFilesDescr"
...
@dataclass(kw_only=True)
class IcnContentsElemType:
    class Meta:
        name = "icnContentsElemType"

    icn_object_group: None | IcnObjectGroup = field(
        default=None,
        metadata={
            "name": "icnObjectGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class IcnResourceFilesElemType:
    class Meta:
        name = "icnResourceFilesElemType"

    icn_supporting_files_descr: None | IcnSupportingFilesDescr = field(
        default=None,
        metadata={
            "name": "icnSupportingFilesDescr",
            "type": "Element",
    ...
    icn_resource_file_type: IcnResourceFileTypeAttType = field(
        metadata={
            "name": "icnResourceFileType",
            "type": "Attribute",
        }
    )
...
@dataclass(kw_only=True)
class IcnSourceFilesElemType:
    class Meta:
        name = "icnSourceFilesElemType"
    ...
    icn_source_file_type: IcnSourceFileTypeAttType = field(
        metadata={
            "name": "icnSourceFileType",
            "type": "Attribute",
        }
    )
...
@dataclass(kw_only=True)
class IcnContents(IcnContentsElemType):
    class Meta:
        name = "icnContents"


@dataclass(kw_only=True)
class IcnResourceFiles(IcnResourceFilesElemType):
    class Meta:
        name = "icnResourceFiles"


@dataclass(kw_only=True)
class IcnSourceFiles(IcnSourceFilesElemType):
    class Meta:
        name = "icnSourceFiles"
...
@dataclass(kw_only=True)
class IcnSupportingFilesElemType:
    class Meta:
        name = "icnSupportingFilesElemType"

    icn_source_files: list[IcnSourceFiles] = field(
        default_factory=list,
        metadata={
            "name": "icnSourceFiles",
            "type": "Element",
    ...
    icn_resource_files: list[IcnResourceFiles] = field(
        default_factory=list,
        metadata={
            "name": "icnResourceFiles",
            "type": "Element",
...
@dataclass(kw_only=True)
class IcnSupportingFiles(IcnSupportingFilesElemType):
    class Meta:
        name = "icnSupportingFiles"
...
@dataclass(kw_only=True)
class IcnVariationElemType:
    class Meta:
        name = "icnVariationElemType"

    icn_info_item_group: None | IcnInfoItemGroup = field(
        default=None,
        metadata={
            "name": "icnInfoItemGroup",
            "type": "Element",
    ...
    icn_contents: None | IcnContents = field(
        default=None,
        metadata={
            "name": "icnContents",
            "type": "Element",
    ...
    icn_supporting_files: None | IcnSupportingFiles = field(
        default=None,
        metadata={
            "name": "icnSupportingFiles",
            "type": "Element",
...
@dataclass(kw_only=True)
class IcnVariation(IcnVariationElemType):
    class Meta:
        name = "icnVariation"
...
@dataclass(kw_only=True)
class ImfContentElemType:
    class Meta:
        name = "imfContentElemType"

    icn_variation: list[IcnVariation] = field(
        default_factory=list,
        metadata={
            "name": "icnVariation",
            "type": "Element",
...
@dataclass(kw_only=True)
class ImfContent(ImfContentElemType):
    class Meta:
        name = "imfContent"
...
@dataclass(kw_only=True)
class ImfStatusElemType:
    class Meta:
        name = "imfStatusElemType"
    ...
    brex_dm_ref: None | BrexDmRef = field(
        default=None,
        metadata={
            "name": "brexDmRef",
            "type": "Element",
...
@dataclass(kw_only=True)
class ImfStatus(ImfStatusElemType):
    class Meta:
        name = "imfStatus"


@dataclass(kw_only=True)
class ImfIdentAndStatusSectionElemType:
    class Meta:
        name = "imfIdentAndStatusSectionElemType"

    imf_address: ImfAddress = field(
        metadata={
            "name": "imfAddress",
            "type": "Element",
        }
    )
    imf_status: ImfStatus = field(
        metadata={
            "name": "imfStatus",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class ImfIdentAndStatusSection(ImfIdentAndStatusSectionElemType):
    class Meta:
        name = "imfIdentAndStatusSection"


@dataclass(kw_only=True)
class IcnMetadataFileElemType:
    class Meta:
        name = "icnMetadataFileElemType"
    ...
    imf_ident_and_status_section: ImfIdentAndStatusSection = field(
        metadata={
            "name": "imfIdentAndStatusSection",
            "type": "Element",
        }
    )
    imf_content: None | ImfContent = field(
        default=None,
        metadata={
            "name": "imfContent",
            "type": "Element",
...
@dataclass(kw_only=True)
class IcnMetadataFile(IcnMetadataFileElemType):
    class Meta:
        name = "icnMetadataFile"
