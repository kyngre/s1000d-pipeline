...
class AssignElemType:
    ...
    applic_property_value: str = field(
        metadata={
            "name": "applicPropertyValue",
            "type": "Attribute",
            "pattern": r"[^|~]*",
        }
    )
...
@dataclass(kw_only=True)
class ProductElemType:
    class Meta:
        name = "productElemType"
...
@dataclass(kw_only=True)
class ProductCrossRefTableElemType:
    class Meta:
        name = "productCrossRefTableElemType"
...
@dataclass(kw_only=True)
class ProductCrossRefTable(ProductCrossRefTableElemType):
    class Meta:
        name = "productCrossRefTable"
...
class ContentElemType:
    ...
    product_cross_ref_table: ProductCrossRefTable = field(
        metadata={
            "name": "productCrossRefTable",
            "type": "Element",
        }
