...
class AnswerToEntryAttType(Enum):
    Y = "y"
    N = "n"
...
class DmlEntryTypeAttType(Enum):
    C = "c"
    D = "d"
    N = "n"
...
@dataclass(kw_only=True)
class InfoEntityRefElemType:
    class Meta:
        name = "infoEntityRefElemType"

    info_entity_ref_ident: str = field(
        metadata={
            "name": "infoEntityRefIdent",
            "type": "Attribute",
        }
    )
...
class ListDirectionAttType(Enum):
    SEND = "send"
    REPLY = "reply"
...
@dataclass(kw_only=True)
class InfoEntityRef(InfoEntityRefElemType):
    class Meta:
        name = "infoEntityRef"
...
@dataclass(kw_only=True)
class DmlAddressItemsElemType:
    class Meta:
        name = "dmlAddressItemsElemType"
...
@dataclass(kw_only=True)
class CommentRefIdentElemType:
    class Meta:
        name = "commentRefIdentElemType"
...
@dataclass(kw_only=True)
class DmlAddressItems(DmlAddressItemsElemType):
    class Meta:
        name = "dmlAddressItems"


@dataclass(kw_only=True)
class DmlIdentElemType:
    class Meta:
        name = "dmlIdentElemType"
...
@dataclass(kw_only=True)
class CommentRefIdent(CommentRefIdentElemType):
    class Meta:
        name = "commentRefIdent"
...
@dataclass(kw_only=True)
class DmlIdent(DmlIdentElemType):
    class Meta:
        name = "dmlIdent"
...
class AnswerElemType:
    ...
    answer_to_entry: AnswerToEntryAttType = field(
        default=AnswerToEntryAttType.Y,
        metadata={
            "name": "answerToEntry",
            "type": "Attribute",
        },
...
@dataclass(kw_only=True)
class CommentRefElemType:
    class Meta:
        name = "commentRefElemType"

    comment_ref_ident: CommentRefIdent = field(
        metadata={
            "name": "commentRefIdent",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class DmlAddressElemType:
    class Meta:
        name = "dmlAddressElemType"

    dml_ident: DmlIdent = field(
        metadata={
            "name": "dmlIdent",
            "type": "Element",
        }
    )
    dml_address_items: DmlAddressItems = field(
        metadata={
            "name": "dmlAddressItems",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class CommentRef(CommentRefElemType):
    class Meta:
        name = "commentRef"
...
@dataclass(kw_only=True)
class DmlAddress(DmlAddressElemType):
    class Meta:
        name = "dmlAddress"
...
@dataclass(kw_only=True)
class DmlEntryElemType:
    class Meta:
        name = "dmlEntryElemType"
    ...
    info_entity_ref: None | InfoEntityRef = field(
        default=None,
        metadata={
            "name": "infoEntityRef",
            "type": "Element",
    ...
    comment_ref: None | CommentRef = field(
        default=None,
        metadata={
            "name": "commentRef",
            "type": "Element",
    ...
    dml_entry_type: None | DmlEntryTypeAttType = field(
        default=None,
        metadata={
            "name": "dmlEntryType",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class DmlEntry(DmlEntryElemType):
    class Meta:
        name = "dmlEntry"
...
@dataclass(kw_only=True)
class DmlContentElemType:
    class Meta:
        name = "dmlContentElemType"

    dml_entry: list[DmlEntry] = field(
        default_factory=list,
        metadata={
            "name": "dmlEntry",
            "type": "Element",
...
@dataclass(kw_only=True)
class DmlContent(DmlContentElemType):
    class Meta:
        name = "dmlContent"
...
@dataclass(kw_only=True)
class DmlStatusElemType:
    class Meta:
        name = "dmlStatusElemType"
...
@dataclass(kw_only=True)
class DmlStatus(DmlStatusElemType):
    class Meta:
        name = "dmlStatus"
...
class IdentAndStatusSectionElemType:
    ...
    dml_address: DmlAddress = field(
        metadata={
            "name": "dmlAddress",
            "type": "Element",
        }
    )
    dml_status: DmlStatus = field(
        metadata={
            "name": "dmlStatus",
            "type": "Element",
        }
...
class DmlElemType:
    ...
    list_direction: None | ListDirectionAttType = field(
        default=None,
        metadata={
            "name": "listDirection",
            "type": "Attribute",
