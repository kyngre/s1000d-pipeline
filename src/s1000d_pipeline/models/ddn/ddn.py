...
@dataclass(kw_only=True)
class DispatchFileName:
    class Meta:
        name = "dispatchFileName"
...
@dataclass(kw_only=True)
class EntityControlNumber:
    class Meta:
        name = "entityControlNumber"
...
@dataclass(kw_only=True)
class MediaIdentElemType:
    class Meta:
        name = "mediaIdentElemType"
...
@dataclass(kw_only=True)
class MediaIdent(MediaIdentElemType):
    class Meta:
        name = "mediaIdent"
...
@dataclass(kw_only=True)
class DdnIdentElemType:
    class Meta:
        name = "ddnIdentElemType"
...
@dataclass(kw_only=True)
class DeliveryListItemElemType:
    class Meta:
        name = "deliveryListItemElemType"

    dispatch_file_name: DispatchFileName = field(
        metadata={
            "name": "dispatchFileName",
            "type": "Element",
        }
    )
    entity_control_number: None | EntityControlNumber = field(
        default=None,
        metadata={
            "name": "entityControlNumber",
            "type": "Element",
...
@dataclass(kw_only=True)
class DdnIdent(DdnIdentElemType):
    class Meta:
        name = "ddnIdent"


@dataclass(kw_only=True)
class DeliveryListItem(DeliveryListItemElemType):
    class Meta:
...
@dataclass(kw_only=True)
class DeliveryListElemType:
    class Meta:
        name = "deliveryListElemType"

    delivery_list_item: list[DeliveryListItem] = field(
        default_factory=list,
        metadata={
            "name": "deliveryListItem",
            "type": "Element",
...
@dataclass(kw_only=True)
class DeliveryList(DeliveryListElemType):
    class Meta:
        name = "deliveryList"
...
@dataclass(kw_only=True)
class DdnContentElemType:
    class Meta:
        name = "ddnContentElemType"

    media_ident: None | MediaIdent = field(
        default=None,
        metadata={
            "name": "mediaIdent",
            "type": "Element",
    ...
    delivery_list: None | DeliveryList = field(
        default=None,
        metadata={
            "name": "deliveryList",
            "type": "Element",
...
@dataclass(kw_only=True)
class DispatchFromElemType:
    class Meta:
        name = "dispatchFromElemType"
...
@dataclass(kw_only=True)
class DispatchToElemType:
    class Meta:
        name = "dispatchToElemType"
...
@dataclass(kw_only=True)
class DdnContent(DdnContentElemType):
    class Meta:
        name = "ddnContent"


@dataclass(kw_only=True)
class DispatchFrom(DispatchFromElemType):
    class Meta:
        name = "dispatchFrom"


@dataclass(kw_only=True)
class DispatchTo(DispatchToElemType):
    class Meta:
        name = "dispatchTo"
...
@dataclass(kw_only=True)
class DdnAddressItemsElemType:
    class Meta:
        name = "ddnAddressItemsElemType"
    ...
    dispatch_to: DispatchTo = field(
        metadata={
            "name": "dispatchTo",
            "type": "Element",
        }
    )
    dispatch_from: DispatchFrom = field(
        metadata={
            "name": "dispatchFrom",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class DdnAddressItems(DdnAddressItemsElemType):
    class Meta:
        name = "ddnAddressItems"
...
@dataclass(kw_only=True)
class DdnAddressElemType:
    class Meta:
        name = "ddnAddressElemType"

    ddn_ident: DdnIdent = field(
        metadata={
            "name": "ddnIdent",
            "type": "Element",
        }
    )
    ddn_address_items: DdnAddressItems = field(
        metadata={
            "name": "ddnAddressItems",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class DdnAddress(DdnAddressElemType):
    class Meta:
        name = "ddnAddress"
...
@dataclass(kw_only=True)
class DdnStatusElemType:
    class Meta:
        name = "ddnStatusElemType"
...
@dataclass(kw_only=True)
class DdnStatus(DdnStatusElemType):
    class Meta:
        name = "ddnStatus"
...
class IdentAndStatusSectionElemType:
    ...
    ddn_address: DdnAddress = field(
        metadata={
            "name": "ddnAddress",
            "type": "Element",
        }
    )
    ddn_status: DdnStatus = field(
        metadata={
            "name": "ddnStatus",
            "type": "Element",
        }
