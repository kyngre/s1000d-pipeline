...
class AllowedObjectFlagAttType(Enum):
    VALUE_0 = "0"
    VALUE_1 = "1"
    VALUE_2 = "2"
...
class ValueFormAttType(Enum):
    SINGLE = "single"
    RANGE = "range"
    PATTERN = "pattern"


class ValueTailoringAttType(Enum):
...
@dataclass(kw_only=True)
class NotationNameElemType:
    class Meta:
        name = "notationNameElemType"

    allowed_notation_flag: None | str = field(
        default=None,
        metadata={
            "name": "allowedNotationFlag",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
...
@dataclass(kw_only=True)
class ObjectPathElemType:
    class Meta:
        name = "objectPathElemType"

    allowed_object_flag: AllowedObjectFlagAttType = field(
        metadata={
            "name": "allowedObjectFlag",
            "type": "Attribute",
        }
    )
    id: None | str = field(
...
@dataclass(kw_only=True)
class ObjectValueElemType:
    class Meta:
        name = "objectValueElemType"

    value_tailoring: ValueTailoringAttType = field(
        default=ValueTailoringAttType.CLOSED,
        metadata={
            "name": "valueTailoring",
            "type": "Attribute",
        },
    )
    value_form: None | ValueFormAttType = field(
        default=None,
        metadata={
            "name": "valueForm",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class SnsAssyElemType:
    class Meta:
        name = "snsAssyElemType"

    sns_code: SnsCode = field(
        metadata={
            "name": "snsCode",
            "type": "Element",
        }
    )
    sns_title: SnsTitle = field(
        metadata={
            "name": "snsTitle",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class NotationName(NotationNameElemType):
    class Meta:
        name = "notationName"


@dataclass(kw_only=True)
class ObjectPath(ObjectPathElemType):
    class Meta:
        name = "objectPath"


@dataclass(kw_only=True)
class ObjectValue(ObjectValueElemType):
    class Meta:
        name = "objectValue"
...
@dataclass(kw_only=True)
class SnsSubSubSystemElemType:
    class Meta:
        name = "snsSubSubSystemElemType"
...
@dataclass(kw_only=True)
class SnsSubSubSystem(SnsSubSubSystemElemType):
    class Meta:
        name = "snsSubSubSystem"
...
@dataclass(kw_only=True)
class SnsSubSystemElemType:
    class Meta:
        name = "snsSubSystemElemType"
    ...
    sns_sub_sub_system: list[SnsSubSubSystem] = field(
        default_factory=list,
        metadata={
            "name": "snsSubSubSystem",
            "type": "Element",
...
@dataclass(kw_only=True)
class SnsSubSystem(SnsSubSystemElemType):
    class Meta:
        name = "snsSubSystem"
...
@dataclass(kw_only=True)
class SnsSystemElemType:
    class Meta:
        name = "snsSystemElemType"
    ...
    sns_sub_system: list[SnsSubSystem] = field(
        default_factory=list,
        metadata={
            "name": "snsSubSystem",
            "type": "Element",
...
@dataclass(kw_only=True)
class SnsSystem(SnsSystemElemType):
    class Meta:
        name = "snsSystem"
...
@dataclass(kw_only=True)
class SnsDescrElemType:
    class Meta:
        name = "snsDescrElemType"

    sns_system: list[SnsSystem] = field(
        default_factory=list,
        metadata={
            "name": "snsSystem",
            "type": "Element",
...
@dataclass(kw_only=True)
class SnsDescr(SnsDescrElemType):
    class Meta:
        name = "snsDescr"
...
@dataclass(kw_only=True)
class ObjectUseElemType:
    class Meta:
        name = "objectUseElemType"
...
@dataclass(kw_only=True)
class ObjectUse(ObjectUseElemType):
    class Meta:
        name = "objectUse"
...
@dataclass(kw_only=True)
class NonContextRuleElemType:
    class Meta:
        name = "nonContextRuleElemType"
...
@dataclass(kw_only=True)
class NotationRuleElemType:
    class Meta:
        name = "notationRuleElemType"
    ...
    notation_name: NotationName = field(
        metadata={
            "name": "notationName",
            "type": "Element",
        }
    )
    object_use: None | ObjectUse = field(
        default=None,
        metadata={
            "name": "objectUse",
            "type": "Element",
...
@dataclass(kw_only=True)
class SnsRulesElemType:
    class Meta:
        name = "snsRulesElemType"
...
@dataclass(kw_only=True)
class StructureObjectRuleElemType:
    class Meta:
        name = "structureObjectRuleElemType"
    ...
    object_value: list[ObjectValue] = field(
        default_factory=list,
        metadata={
            "name": "objectValue",
            "type": "Element",
...
@dataclass(kw_only=True)
class NonContextRule(NonContextRuleElemType):
    class Meta:
        name = "nonContextRule"


@dataclass(kw_only=True)
class NotationRule(NotationRuleElemType):
    class Meta:
        name = "notationRule"
...
@dataclass(kw_only=True)
class SnsRules(SnsRulesElemType):
    class Meta:
        name = "snsRules"


@dataclass(kw_only=True)
class StructureObjectRule(StructureObjectRuleElemType):
    class Meta:
        name = "structureObjectRule"
...
@dataclass(kw_only=True)
class NonContextRulesElemType:
    class Meta:
        name = "nonContextRulesElemType"

    non_context_rule: list[NonContextRule] = field(
        default_factory=list,
        metadata={
            "name": "nonContextRule",
            "type": "Element",
...
@dataclass(kw_only=True)
class NotationRuleListElemType:
    class Meta:
        name = "notationRuleListElemType"

    notation_rule: list[NotationRule] = field(
        default_factory=list,
        metadata={
            "name": "notationRule",
            "type": "Element",
...
@dataclass(kw_only=True)
class StructureObjectRuleGroupElemType:
    class Meta:
        name = "structureObjectRuleGroupElemType"

    structure_object_rule: list[StructureObjectRule] = field(
        default_factory=list,
        metadata={
            "name": "structureObjectRule",
            "type": "Element",
...
@dataclass(kw_only=True)
class NonContextRules(NonContextRulesElemType):
    class Meta:
        name = "nonContextRules"


@dataclass(kw_only=True)
class NotationRuleList(NotationRuleListElemType):
    class Meta:
        name = "notationRuleList"


@dataclass(kw_only=True)
class StructureObjectRuleGroup(StructureObjectRuleGroupElemType):
    class Meta:
        name = "structureObjectRuleGroup"
...
@dataclass(kw_only=True)
class ContextRulesElemType:
    class Meta:
        name = "contextRulesElemType"

    structure_object_rule_group: None | StructureObjectRuleGroup = field(
        default=None,
        metadata={
            "name": "structureObjectRuleGroup",
            "type": "Element",
    ...
    notation_rule_list: None | NotationRuleList = field(
        default=None,
        metadata={
            "name": "notationRuleList",
            "type": "Element",
...
@dataclass(kw_only=True)
class ContextRules(ContextRulesElemType):
    class Meta:
        name = "contextRules"
...
class BrexElemType:
    ...
    context_rules: list[ContextRules] = field(
        default_factory=list,
        metadata={
            "name": "contextRules",
            "type": "Element",
    ...
    non_context_rules: None | NonContextRules = field(
        default=None,
        metadata={
            "name": "nonContextRules",
            "type": "Element",
