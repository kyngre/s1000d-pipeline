...
@dataclass(kw_only=True)
class AccessDoorOrPanel:
    class Meta:
        name = "accessDoorOrPanel"
...
@dataclass(kw_only=True)
class AttenuationElemType:
    class Meta:
        name = "attenuationElemType"
...
@dataclass(kw_only=True)
class BlockGroupingValue:
    class Meta:
        name = "blockGroupingValue"
...
@dataclass(kw_only=True)
class CoaxialCableFlag:
    class Meta:
        name = "coaxialCableFlag"
...
@dataclass(kw_only=True)
class ConnectionListClass:
    class Meta:
        name = "connectionListClass"
...
@dataclass(kw_only=True)
class ContactDiameterElemType:
    class Meta:
        name = "contactDiameterElemType"
...
@dataclass(kw_only=True)
class ContactElemType:
    class Meta:
        name = "contactElemType"

    contact_ident: str = field(
        metadata={
            "name": "contactIdent",
            "type": "Attribute",
        }
    )
    contact_function: None | str = field(
        default=None,
        metadata={
    ...
    contact_part_number: None | str = field(
        default=None,
        metadata={
            "name": "contactPartNumber",
            "type": "Attribute",
        },
    )
    wire_installation_direction: None | str = field(
        default=None,
        metadata={
            "name": "wireInstallationDirection",
            "type": "Attribute",
        },
    )
...
@dataclass(kw_only=True)
class ContactOrderValue:
    class Meta:
        name = "contactOrderValue"
...
@dataclass(kw_only=True)
class ElectricalStateDescr:
    class Meta:
        name = "electricalStateDescr"
...
@dataclass(kw_only=True)
class FrequencyElemType:
    class Meta:
        name = "frequencyElemType"
...
@dataclass(kw_only=True)
class HarnessEnvironmentElemType:
    class Meta:
        name = "harnessEnvironmentElemType"

    high_vibration_flag: str = field(
        default="0",
        metadata={
            "name": "highVibrationFlag",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    hydraulic_flag: str = field(
        default="0",
        metadata={
            "name": "hydraulicFlag",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class HarnessVariantIdent:
    class Meta:
        name = "harnessVariantIdent"

    value: str = field(default="")


@dataclass(kw_only=True)
class HarnessVariantIssue:
    class Meta:
        name = "harnessVariantIssue"
...
@dataclass(kw_only=True)
class ImpedanceElemType:
    class Meta:
        name = "impedanceElemType"
...
@dataclass(kw_only=True)
class InstructionIdent:
    class Meta:
        name = "instructionIdent"
...
@dataclass(kw_only=True)
class MaxDiameterElemType:
    class Meta:
        name = "maxDiameterElemType"
...
@dataclass(kw_only=True)
class MaxHarnessSizeElemType:
    class Meta:
        name = "maxHarnessSizeElemType"
...
@dataclass(kw_only=True)
class MaxMountingPositions:
    class Meta:
        name = "maxMountingPositions"

    value: str = field(default="")


@dataclass(kw_only=True)
class MaxTemperatureElemType:
    class Meta:
        name = "maxTemperatureElemType"
...
@dataclass(kw_only=True)
class MinDiameterElemType:
    class Meta:
        name = "minDiameterElemType"
...
@dataclass(kw_only=True)
class MinHarnessSizeElemType:
    class Meta:
        name = "minHarnessSizeElemType"
...
@dataclass(kw_only=True)
class MinTemperatureElemType:
    class Meta:
        name = "minTemperatureElemType"
...
@dataclass(kw_only=True)
class NetworkAnalysisCode:
    class Meta:
        name = "networkAnalysisCode"
...
@dataclass(kw_only=True)
class OuterDiameterElemType:
    class Meta:
        name = "outerDiameterElemType"
...
@dataclass(kw_only=True)
class OuterJacketColor:
    class Meta:
        name = "outerJacketColor"
...
@dataclass(kw_only=True)
class PositionOnNextHigherAssyElemType:
    class Meta:
        name = "positionOnNextHigherAssyElemType"

    mount_position: None | str = field(
        default=None,
        metadata={
            "name": "mountPosition",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class PotentialConnectionsOrder:
    class Meta:
        name = "potentialConnectionsOrder"
...
@dataclass(kw_only=True)
class ResistanceElemType:
    class Meta:
        name = "resistanceElemType"
...
@dataclass(kw_only=True)
class ScreenElemType:
    class Meta:
        name = "screenElemType"

    screen_level: None | str = field(
        default=None,
        metadata={
            "name": "screenLevel",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class ShuntGroupingValue:
    class Meta:
        name = "shuntGroupingValue"
...
@dataclass(kw_only=True)
class TerminationModuleGroupingValue:
    class Meta:
        name = "terminationModuleGroupingValue"

    value: str = field(default="")


@dataclass(kw_only=True)
class ThermoCoupleMinus:
    class Meta:
        name = "thermoCoupleMinus"

    value: str = field(default="")


@dataclass(kw_only=True)
class ThermoCouplePlus:
    class Meta:
        name = "thermoCouplePlus"

    value: str = field(default="")


@dataclass(kw_only=True)
class TriaxialCableFlag:
    class Meta:
        name = "triaxialCableFlag"
...
@dataclass(kw_only=True)
class VoltageElemType:
    class Meta:
        name = "voltageElemType"
...
@dataclass(kw_only=True)
class WallThicknessElemType:
    class Meta:
        name = "wallThicknessElemType"
...
class WireGaugeTypeAttType(Enum):
    PROJ = "proj"
    AWG = "awg"
    MT = "mt"


class WireLengthTypeAttType(Enum):
    CRITICAL = "critical"
    ESTIMATED = "estimated"
    FINAL = "final"
...
@dataclass(kw_only=True)
class Attenuation(AttenuationElemType):
    class Meta:
        name = "attenuation"
...
@dataclass(kw_only=True)
class ChangeAuthorityElemType:
    class Meta:
        name = "changeAuthorityElemType"
...
@dataclass(kw_only=True)
class Contact(ContactElemType):
    class Meta:
        name = "contact"


@dataclass(kw_only=True)
class ContactDiameter(ContactDiameterElemType):
    class Meta:
        name = "contactDiameter"
...
@dataclass(kw_only=True)
class ElectricalPotentialElemType:
    class Meta:
        name = "electricalPotentialElemType"

    termination_module_grouping_value: (
        None | TerminationModuleGroupingValue
    ) = field(
        default=None,
        metadata={
            "name": "terminationModuleGroupingValue",
    ...
    block_grouping_value: None | BlockGroupingValue = field(
        default=None,
        metadata={
            "name": "blockGroupingValue",
            "type": "Element",
    ...
    shunt_grouping_value: None | ShuntGroupingValue = field(
        default=None,
        metadata={
            "name": "shuntGroupingValue",
            "type": "Element",
    ...
    contact_order_value: None | ContactOrderValue = field(
        default=None,
        metadata={
            "name": "contactOrderValue",
            "type": "Element",
...
@dataclass(kw_only=True)
class Frequency(FrequencyElemType):
    class Meta:
        name = "frequency"


@dataclass(kw_only=True)
class HarnessEnvironment(HarnessEnvironmentElemType):
    class Meta:
        name = "harnessEnvironment"


@dataclass(kw_only=True)
class HarnessIdentElemType:
    class Meta:
        name = "harnessIdentElemType"
...
@dataclass(kw_only=True)
class Impedance(ImpedanceElemType):
    class Meta:
        name = "impedance"
...
class LengthElemType:
    ...
    wire_length_type: None | WireLengthTypeAttType = field(
        default=None,
        metadata={
            "name": "wireLengthType",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class Mass(MassElemType):
    class Meta:
        name = "mass"


@dataclass(kw_only=True)
class MaxDiameter(MaxDiameterElemType):
    class Meta:
        name = "maxDiameter"


@dataclass(kw_only=True)
class MaxHarnessSize(MaxHarnessSizeElemType):
    class Meta:
        name = "maxHarnessSize"


@dataclass(kw_only=True)
class MaxTemperature(MaxTemperatureElemType):
    class Meta:
        name = "maxTemperature"


@dataclass(kw_only=True)
class MinDiameter(MinDiameterElemType):
    class Meta:
        name = "minDiameter"


@dataclass(kw_only=True)
class MinHarnessSize(MinHarnessSizeElemType):
    class Meta:
        name = "minHarnessSize"


@dataclass(kw_only=True)
class MinTemperature(MinTemperatureElemType):
    class Meta:
        name = "minTemperature"
...
@dataclass(kw_only=True)
class OuterDiameter(OuterDiameterElemType):
    class Meta:
        name = "outerDiameter"
...
@dataclass(kw_only=True)
class PositionOnNextHigherAssy(PositionOnNextHigherAssyElemType):
    class Meta:
        name = "positionOnNextHigherAssy"
...
@dataclass(kw_only=True)
class Resistance(ResistanceElemType):
    class Meta:
        name = "resistance"
...
@dataclass(kw_only=True)
class Voltage(VoltageElemType):
    class Meta:
        name = "voltage"


@dataclass(kw_only=True)
class WallThickness(WallThicknessElemType):
    class Meta:
        name = "wallThickness"


@dataclass(kw_only=True)
class WireGaugeElemType:
    class Meta:
        name = "wireGaugeElemType"

    wire_gauge_type: WireGaugeTypeAttType = field(
        metadata={
            "name": "wireGaugeType",
            "type": "Attribute",
        }
...
@dataclass(kw_only=True)
class WireIdentElemType:
    class Meta:
        name = "wireIdentElemType"

    circuit_ident: None | CircuitIdent = field(
        default=None,
        metadata={
            "name": "circuitIdent",
            "type": "Element",
    ...
    wire_number: WireNumber = field(
        metadata={
            "name": "wireNumber",
            "type": "Element",
        }
    )
    section_ident: None | SectionIdent = field(
        default=None,
        metadata={
            "name": "sectionIdent",
            "type": "Element",
...
@dataclass(kw_only=True)
class ChangeAuthority(ChangeAuthorityElemType):
    class Meta:
...
@dataclass(kw_only=True)
class ElectricalEquipConnectionElemType:
    class Meta:
        name = "electricalEquipConnectionElemType"
    ...
    connection_type: None | str = field(
        default=None,
        metadata={
            "name": "connectionType",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class ElectricalPotential(ElectricalPotentialElemType):
    class Meta:
        name = "electricalPotential"
...
@dataclass(kw_only=True)
class FrequencyAttenuationElemType:
    class Meta:
        name = "frequencyAttenuationElemType"
...
@dataclass(kw_only=True)
class HarnessIdent(HarnessIdentElemType):
    class Meta:
        name = "harnessIdent"


@dataclass(kw_only=True)
class HarnessSizeElemType:
    class Meta:
        name = "harnessSizeElemType"

    min_harness_size: None | MinHarnessSize = field(
        default=None,
        metadata={
            "name": "minHarnessSize",
            "type": "Element",
    ...
    max_harness_size: None | MaxHarnessSize = field(
        default=None,
        metadata={
            "name": "maxHarnessSize",
            "type": "Element",
...
@dataclass(kw_only=True)
class ScreenGroupElemType:
    class Meta:
        name = "screenGroupElemType"
...
@dataclass(kw_only=True)
class SleeveDiameterElemType:
    class Meta:
        name = "sleeveDiameterElemType"

    min_diameter: None | MinDiameter = field(
        default=None,
        metadata={
            "name": "minDiameter",
            "type": "Element",
    ...
    max_diameter: None | MaxDiameter = field(
        default=None,
        metadata={
            "name": "maxDiameter",
            "type": "Element",
...
@dataclass(kw_only=True)
class TemperatureElemType:
    class Meta:
        name = "temperatureElemType"

    min_temperature: None | MinTemperature = field(
        default=None,
        metadata={
            "name": "minTemperature",
            "type": "Element",
    ...
    max_temperature: None | MaxTemperature = field(
        default=None,
        metadata={
            "name": "maxTemperature",
            "type": "Element",
...
@dataclass(kw_only=True)
class TwistGroupElemType:
    class Meta:
        name = "twistGroupElemType"

    twist: list[Twist] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
...
@dataclass(kw_only=True)
class WireGauge(WireGaugeElemType):
    class Meta:
        name = "wireGauge"


@dataclass(kw_only=True)
class WireIdent(WireIdentElemType):
    class Meta:
        name = "wireIdent"
...
@dataclass(kw_only=True)
class AltIdentElemType:
    class Meta:
        name = "altIdentElemType"
    ...
    manufacturer_code: None | ManufacturerCode = field(
        default=None,
        metadata={
            "name": "manufacturerCode",
            "type": "Element",
...
@dataclass(kw_only=True)
class ConnectorAccessoriesElemType:
    class Meta:
        name = "connectorAccessoriesElemType"
...
@dataclass(kw_only=True)
class ElectricalEquipConnection(ElectricalEquipConnectionElemType):
    class Meta:
        name = "electricalEquipConnection"
...
@dataclass(kw_only=True)
class FrequencyAttenuation(FrequencyAttenuationElemType):
    class Meta:
        name = "frequencyAttenuation"


@dataclass(kw_only=True)
class HarnessSize(HarnessSizeElemType):
    class Meta:
        name = "harnessSize"
...
@dataclass(kw_only=True)
class ScreenGroup(ScreenGroupElemType):
    class Meta:
        name = "screenGroup"


@dataclass(kw_only=True)
class SleeveDiameter(SleeveDiameterElemType):
    class Meta:
        name = "sleeveDiameter"


@dataclass(kw_only=True)
class SleeveElemType:
    class Meta:
        name = "sleeveElemType"
    ...
    sleeve_material: None | str = field(
        default=None,
        metadata={
            "name": "sleeveMaterial",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class Temperature(TemperatureElemType):
    class Meta:
        name = "temperature"


@dataclass(kw_only=True)
class TwistGroup(TwistGroupElemType):
    class Meta:
        name = "twistGroup"


@dataclass(kw_only=True)
class WireCodeElemType:
    class Meta:
        name = "wireCodeElemType"

    wire_type: WireType = field(
        metadata={
            "name": "wireType",
            "type": "Element",
        }
    )
    wire_gauge: list[WireGauge] = field(
        default_factory=list,
        metadata={
            "name": "wireGauge",
            "type": "Element",
...
@dataclass(kw_only=True)
class WireConnectionCodeElemType:
    class Meta:
        name = "wireConnectionCodeElemType"

    screen_order: None | ScreenOrder = field(
        default=None,
        metadata={
            "name": "screenOrder",
            "type": "Element",
    ...
    special_connection: None | SpecialConnection = field(
        default=None,
        metadata={
            "name": "specialConnection",
            "type": "Element",
    ...
    electrical_potential: ElectricalPotential = field(
        metadata={
            "name": "electricalPotential",
            "type": "Element",
        }
    )
    potential_connections_order: None | PotentialConnectionsOrder = field(
        default=None,
        metadata={
            "name": "potentialConnectionsOrder",
            "type": "Element",
...
@dataclass(kw_only=True)
class AltIdent(AltIdentElemType):
    class Meta:
        name = "altIdent"
...
@dataclass(kw_only=True)
class ConnectorAccessories(ConnectorAccessoriesElemType):
    class Meta:
        name = "connectorAccessories"
...
@dataclass(kw_only=True)
class ElectricalEquipStateElemType:
    class Meta:
        name = "electricalEquipStateElemType"

    electrical_equip_connection: list[ElectricalEquipConnection] = field(
        default_factory=list,
        metadata={
            "name": "electricalEquipConnection",
            "type": "Element",
    ...
    electrical_state_descr: None | ElectricalStateDescr = field(
        default=None,
        metadata={
            "name": "electricalStateDescr",
            "type": "Element",
    ...
    initial_state_flag: None | str = field(
        default=None,
        metadata={
            "name": "initialStateFlag",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
...
@dataclass(kw_only=True)
class FrequencyCharacteristicsElemType:
    class Meta:
        name = "frequencyCharacteristicsElemType"

    impedance: Impedance = field(
        metadata={
            "type": "Element",
        }
    )
    frequency_attenuation: list[FrequencyAttenuation] = field(
        default_factory=list,
        metadata={
            "name": "frequencyAttenuation",
            "type": "Element",
...
@dataclass(kw_only=True)
class TransverseLinkElemType:
    class Meta:
        name = "transverseLinkElemType"
    ...
    content: list[object] = field(
        ...
        metadata={
            ...
            "choices": (
                {
                    "name": "electricalEquipConnection",
                    "type": ElectricalEquipConnection,
                },
            ),
        },
    )
...
@dataclass(kw_only=True)
class WireCode(WireCodeElemType):
    class Meta:
        name = "wireCode"


@dataclass(kw_only=True)
class WireConnectionCode(WireConnectionCodeElemType):
    class Meta:
        name = "wireConnectionCode"


@dataclass(kw_only=True)
class AltIdentGroupElemType:
    class Meta:
        name = "altIdentGroupElemType"

    alt_ident: list[AltIdent] = field(
        default_factory=list,
        metadata={
            "name": "altIdent",
            "type": "Element",
...
@dataclass(kw_only=True)
class ContactInfoElemType:
    class Meta:
        name = "contactInfoElemType"
    ...
    wire_connection_code: None | WireConnectionCode = field(
        default=None,
        metadata={
            "name": "wireConnectionCode",
            "type": "Element",
    ...
    network_analysis_code: None | NetworkAnalysisCode = field(
        default=None,
        metadata={
            "name": "networkAnalysisCode",
            "type": "Element",
    ...
    group_code: None | GroupCode = field(
        default=None,
        metadata={
            "name": "groupCode",
            "type": "Element",
...
@dataclass(kw_only=True)
class ElectricalEquipState(ElectricalEquipStateElemType):
    class Meta:
        name = "electricalEquipState"
...
@dataclass(kw_only=True)
class FrequencyCharacteristics(FrequencyCharacteristicsElemType):
    class Meta:
        name = "frequencyCharacteristics"
...
@dataclass(kw_only=True)
class SleeveGroupElemType:
    class Meta:
        name = "sleeveGroupElemType"

    sleeve: list[Sleeve] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
...
@dataclass(kw_only=True)
class TransverseLink(TransverseLinkElemType):
    class Meta:
        name = "transverseLink"


@dataclass(kw_only=True)
class AltIdentGroup(AltIdentGroupElemType):
    class Meta:
        name = "altIdentGroup"
...
@dataclass(kw_only=True)
class ContactInfo(ContactInfoElemType):
    class Meta:
        name = "contactInfo"
...
@dataclass(kw_only=True)
class ElectricalLogicElemType:
    class Meta:
        name = "electricalLogicElemType"

    electrical_equip_state: list[ElectricalEquipState] = field(
        default_factory=list,
        metadata={
            "name": "electricalEquipState",
            "type": "Element",
...
@dataclass(kw_only=True)
class SleeveGroup(SleeveGroupElemType):
    class Meta:
        name = "sleeveGroup"
...
@dataclass(kw_only=True)
class ElectricalLogic(ElectricalLogicElemType):
    class Meta:
        name = "electricalLogic"
...
@dataclass(kw_only=True)
class HarnessInfoElemType:
    class Meta:
        name = "harnessInfoElemType"
    ...
    alt_ident_group: None | AltIdentGroup = field(
        default=None,
        metadata={
            "name": "altIdentGroup",
            "type": "Element",
    ...
    harness_variant_ident: None | HarnessVariantIdent = field(
        default=None,
        metadata={
            "name": "harnessVariantIdent",
            "type": "Element",
    ...
    harness_variant_issue: None | HarnessVariantIssue = field(
        default=None,
        metadata={
            "name": "harnessVariantIssue",
            "type": "Element",
    ...
    harness_name: None | HarnessName = field(
        default=None,
        metadata={
            "name": "harnessName",
            "type": "Element",
    ...
    harness_environment: None | HarnessEnvironment = field(
        default=None,
        metadata={
            "name": "harnessEnvironment",
            "type": "Element",
    ...
    sleeve_group: None | SleeveGroup = field(
        default=None,
        metadata={
            "name": "sleeveGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class HarnessInfo(HarnessInfoElemType):
    class Meta:
        name = "harnessInfo"
...
class AssyElemType:
    ...
    instruction_ident: None | InstructionIdent = field(
        default=None,
        metadata={
            "name": "instructionIdent",
            "type": "Element",
...
@dataclass(kw_only=True)
class ChangeAuthorityDataElemType:
    class Meta:
        name = "changeAuthorityDataElemType"

    change_authority: ChangeAuthority = field(
        metadata={
            "name": "changeAuthority",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class EquipDescrRefElemType:
    class Meta:
        name = "equipDescrRefElemType"
...
@dataclass(kw_only=True)
class FinishingInfoElemType:
    class Meta:
        name = "finishingInfoElemType"
...
@dataclass(kw_only=True)
class FunctionalDescrRefElemType:
    class Meta:
        name = "functionalDescrRefElemType"
...
@dataclass(kw_only=True)
class IllustrationRefElemType:
    class Meta:
        name = "illustrationRefElemType"
...
@dataclass(kw_only=True)
class PreparationInfoElemType:
    class Meta:
        name = "preparationInfoElemType"
...
@dataclass(kw_only=True)
class Assy(AssyElemType):
    class Meta:
        name = "assy"


@dataclass(kw_only=True)
class ChangeAuthorityData(ChangeAuthorityDataElemType):
    class Meta:
...
@dataclass(kw_only=True)
class EquipDescrRef(EquipDescrRefElemType):
    class Meta:
        name = "equipDescrRef"


@dataclass(kw_only=True)
class FinishingInfo(FinishingInfoElemType):
    class Meta:
        name = "finishingInfo"


@dataclass(kw_only=True)
class FunctionalDescrRef(FunctionalDescrRefElemType):
    class Meta:
        name = "functionalDescrRef"
...
@dataclass(kw_only=True)
class IllustrationRef(IllustrationRefElemType):
    class Meta:
        name = "illustrationRef"


@dataclass(kw_only=True)
class PreparationInfo(PreparationInfoElemType):
    class Meta:
...
@dataclass(kw_only=True)
class AssyInstructionElemType:
    class Meta:
        name = "assyInstructionElemType"

    assy: list[Assy] = field(
        default_factory=list,
        metadata={
            "type": "Element",
        },
...
@dataclass(kw_only=True)
class ChangeAuthorityDataGroupElemType:
    class Meta:
        name = "changeAuthorityDataGroupElemType"

    change_authority_data: list[ChangeAuthorityData] = field(
        default_factory=list,
        metadata={
            "name": "changeAuthorityData",
            "type": "Element",
...
@dataclass(kw_only=True)
class ConduitElemType:
    class Meta:
        name = "conduitElemType"
    ...
    mass: None | Mass = field(
        default=None,
        metadata={
            "type": "Element",
        },
    )
    wire_color: None | WireColor = field(
        default=None,
        metadata={
            "name": "wireColor",
            "type": "Element",
    ...
    wall_thickness: None | WallThickness = field(
        default=None,
        metadata={
            "name": "wallThickness",
            "type": "Element",
    ...
    functional_descr_ref: None | FunctionalDescrRef = field(
        default=None,
        metadata={
            "name": "functionalDescrRef",
            "type": "Element",
    ...
    illustration_ref: None | IllustrationRef = field(
        default=None,
        metadata={
            "name": "illustrationRef",
            "type": "Element",
...
@dataclass(kw_only=True)
class ContactDescrElemType:
    class Meta:
        name = "contactDescrElemType"
    ...
    contact_diameter: None | ContactDiameter = field(
        default=None,
        metadata={
            "name": "contactDiameter",
            "type": "Element",
    ...
    finishing_info: list[FinishingInfo] = field(
        default_factory=list,
        metadata={
            "name": "finishingInfo",
            "type": "Element",
    ...
    thermo_couple_plus: None | ThermoCouplePlus = field(
        default=None,
        metadata={
            "name": "thermoCouplePlus",
            "type": "Element",
    ...
    thermo_couple_minus: None | ThermoCoupleMinus = field(
        default=None,
        metadata={
            "name": "thermoCoupleMinus",
            "type": "Element",
    ...
    special_terminal: None | SpecialTerminal = field(
        default=None,
        metadata={
            "name": "specialTerminal",
            "type": "Element",
    ...
    coaxial_cable_flag: None | CoaxialCableFlag = field(
        default=None,
        metadata={
            "name": "coaxialCableFlag",
            "type": "Element",
    ...
    triaxial_cable_flag: None | TriaxialCableFlag = field(
        default=None,
        metadata={
            "name": "triaxialCableFlag",
            "type": "Element",
...
@dataclass(kw_only=True)
class DistributionPartElemType:
    class Meta:
        name = "distributionPartElemType"
    ...
    contact_size: None | ContactSize = field(
        default=None,
        metadata={
            "name": "contactSize",
            "type": "Element",
    ...
    surface_protection: None | SurfaceProtection = field(
        default=None,
        metadata={
            "name": "surfaceProtection",
            "type": "Element",
...
@dataclass(kw_only=True)
class FeedThruElemType:
    class Meta:
        name = "feedThruElemType"

    functional_item_ref: FunctionalItemRef = field(
        metadata={
            "name": "functionalItemRef",
            "type": "Element",
        }
    )
    hole_ident: None | str = field(
        default=None,
        metadata={
            "name": "holeIdent",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class IdentSleeveElemType:
    class Meta:
        name = "identSleeveElemType"
...
@dataclass(kw_only=True)
class NextHigherAssyElemType:
    class Meta:
        name = "nextHigherAssyElemType"
...
@dataclass(kw_only=True)
class ShrinkSleeveElemType:
    class Meta:
        name = "shrinkSleeveElemType"
    ...
    sleeve_diameter: None | SleeveDiameter = field(
        default=None,
        metadata={
            "name": "sleeveDiameter",
            "type": "Element",
    ...
    harness_size: None | HarnessSize = field(
        default=None,
        metadata={
            "name": "harnessSize",
            "type": "Element",
...
@dataclass(kw_only=True)
class SiblingPlugIdentElemType:
    class Meta:
        name = "siblingPlugIdentElemType"
...
@dataclass(kw_only=True)
class SolderSleeveElemType:
    class Meta:
        name = "solderSleeveElemType"
...
@dataclass(kw_only=True)
class WireInstallationCodeElemType:
    class Meta:
        name = "wireInstallationCodeElemType"

    preparation_info: list[PreparationInfo] = field(
        default_factory=list,
        metadata={
            "name": "preparationInfo",
            "type": "Element",
...
@dataclass(kw_only=True)
class WireMaterialElemType:
    class Meta:
        name = "wireMaterialElemType"
    ...
    number_of_cores: None | NumberOfCores = field(
        default=None,
        metadata={
            "name": "numberOfCores",
            "type": "Element",
    ...
    outer_jacket_color: None | OuterJacketColor = field(
        default=None,
        metadata={
            "name": "outerJacketColor",
            "type": "Element",
    ...
    outer_diameter: None | OuterDiameter = field(
        default=None,
        metadata={
            "name": "outerDiameter",
            "type": "Element",
    ...
    resistance: None | Resistance = field(
        default=None,
        metadata={
            "type": "Element",
        },
    )
    voltage: None | Voltage = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    screen_count: None | ScreenCount = field(
        default=None,
        metadata={
            "name": "screenCount",
            "type": "Element",
    ...
    frequency_characteristics: None | FrequencyCharacteristics = field(
        default=None,
        metadata={
            "name": "frequencyCharacteristics",
            "type": "Element",
...
@dataclass(kw_only=True)
class AssyInstruction(AssyInstructionElemType):
    class Meta:
        name = "assyInstruction"


@dataclass(kw_only=True)
class ChangeAuthorityDataGroup(ChangeAuthorityDataGroupElemType):
    class Meta:
        name = "changeAuthorityDataGroup"


@dataclass(kw_only=True)
class Conduit(ConduitElemType):
    class Meta:
        name = "conduit"


@dataclass(kw_only=True)
class ContactDescr(ContactDescrElemType):
    class Meta:
        name = "contactDescr"


@dataclass(kw_only=True)
class DistributionPart(DistributionPartElemType):
    class Meta:
        name = "distributionPart"


@dataclass(kw_only=True)
class FeedThru(FeedThruElemType):
    class Meta:
        name = "feedThru"


@dataclass(kw_only=True)
class IdentSleeve(IdentSleeveElemType):
    class Meta:
        name = "identSleeve"


@dataclass(kw_only=True)
class NextHigherAssy(NextHigherAssyElemType):
    class Meta:
        name = "nextHigherAssy"
...
@dataclass(kw_only=True)
class ShrinkSleeve(ShrinkSleeveElemType):
    class Meta:
        name = "shrinkSleeve"


@dataclass(kw_only=True)
class SiblingPlugIdent(SiblingPlugIdentElemType):
    class Meta:
        name = "siblingPlugIdent"


@dataclass(kw_only=True)
class SolderSleeve(SolderSleeveElemType):
    class Meta:
        name = "solderSleeve"


@dataclass(kw_only=True)
class WireInstallationCode(WireInstallationCodeElemType):
    class Meta:
        name = "wireInstallationCode"


@dataclass(kw_only=True)
class WireMaterial(WireMaterialElemType):
    class Meta:
        name = "wireMaterial"


@dataclass(kw_only=True)
class AccessoryElemType:
    class Meta:
        name = "accessoryElemType"
    ...
    orientation: None | Orientation = field(
        default=None,
        metadata={
            "type": "Element",
        },
    )
    assy_instruction: None | AssyInstruction = field(
        default=None,
        metadata={
            "name": "assyInstruction",
            "type": "Element",
...
@dataclass(kw_only=True)
class ConduitGroupElemType:
    class Meta:
        name = "conduitGroupElemType"

    conduit: list[Conduit] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
...
@dataclass(kw_only=True)
class ContactDescrGroupElemType:
    class Meta:
        name = "contactDescrGroupElemType"

    contact_descr: list[ContactDescr] = field(
        default_factory=list,
        metadata={
            "name": "contactDescr",
            "type": "Element",
...
@dataclass(kw_only=True)
class DistributionPartGroupElemType:
    class Meta:
        name = "distributionPartGroupElemType"

    distribution_part: list[DistributionPart] = field(
        default_factory=list,
        metadata={
            "name": "distributionPart",
            "type": "Element",
...
@dataclass(kw_only=True)
class FromEquipElemType:
    class Meta:
        name = "fromEquipElemType"
    ...
    contact_info: None | ContactInfo = field(
        default=None,
        metadata={
            "name": "contactInfo",
            "type": "Element",
    ...
    screen_group: None | ScreenGroup = field(
        default=None,
        metadata={
            "name": "screenGroup",
            "type": "Element",
    ...
    twist_group: None | TwistGroup = field(
        default=None,
        metadata={
            "name": "twistGroup",
            "type": "Element",
    ...
    wire_installation_code: None | WireInstallationCode = field(
        default=None,
        metadata={
            "name": "wireInstallationCode",
            "type": "Element",
...
@dataclass(kw_only=True)
class IdentSleeveGroupElemType:
    class Meta:
        name = "identSleeveGroupElemType"

    ident_sleeve: list[IdentSleeve] = field(
        default_factory=list,
        metadata={
            "name": "identSleeve",
            "type": "Element",
...
@dataclass(kw_only=True)
class InstallationInfoElemType:
    class Meta:
        name = "installationInfoElemType"
    ...
    sibling_plug_ident: None | SiblingPlugIdent = field(
        default=None,
        metadata={
            "name": "siblingPlugIdent",
            "type": "Element",
    ...
    access_door_or_panel: None | AccessDoorOrPanel = field(
        default=None,
        metadata={
            "name": "accessDoorOrPanel",
            "type": "Element",
    ...
    next_higher_assy: None | NextHigherAssy = field(
        default=None,
        metadata={
            "name": "nextHigherAssy",
            "type": "Element",
    ...
    position_on_next_higher_assy: None | PositionOnNextHigherAssy = field(
        default=None,
        metadata={
            "name": "positionOnNextHigherAssy",
            "type": "Element",
...
@dataclass(kw_only=True)
class RoutingElemType:
    class Meta:
        name = "routingElemType"

    clipping_point: list[ClippingPoint] = field(
        default_factory=list,
        metadata={
            "name": "clippingPoint",
            "type": "Element",
...
@dataclass(kw_only=True)
class ShrinkSleeveGroupElemType:
    class Meta:
        name = "shrinkSleeveGroupElemType"

    shrink_sleeve: list[ShrinkSleeve] = field(
        default_factory=list,
        metadata={
            "name": "shrinkSleeve",
            "type": "Element",
...
@dataclass(kw_only=True)
class SolderSleeveGroupElemType:
    class Meta:
        name = "solderSleeveGroupElemType"

    solder_sleeve: list[SolderSleeve] = field(
        default_factory=list,
        metadata={
            "name": "solderSleeve",
            "type": "Element",
...
@dataclass(kw_only=True)
class ToEquipElemType:
    class Meta:
        name = "toEquipElemType"
...
@dataclass(kw_only=True)
class WireMaterialGroupElemType:
    class Meta:
        name = "wireMaterialGroupElemType"

    wire_material: list[WireMaterial] = field(
        default_factory=list,
        metadata={
            "name": "wireMaterial",
            "type": "Element",
...
@dataclass(kw_only=True)
class Accessory(AccessoryElemType):
    class Meta:
        name = "accessory"


@dataclass(kw_only=True)
class ConduitGroup(ConduitGroupElemType):
    class Meta:
        name = "conduitGroup"


@dataclass(kw_only=True)
class ContactDescrGroup(ContactDescrGroupElemType):
    class Meta:
        name = "contactDescrGroup"
...
@dataclass(kw_only=True)
class DistributionPartGroup(DistributionPartGroupElemType):
    class Meta:
        name = "distributionPartGroup"
...
@dataclass(kw_only=True)
class FromEquip(FromEquipElemType):
    class Meta:
        name = "fromEquip"


@dataclass(kw_only=True)
class IdentSleeveGroup(IdentSleeveGroupElemType):
    class Meta:
        name = "identSleeveGroup"


@dataclass(kw_only=True)
class InstallationInfo(InstallationInfoElemType):
    class Meta:
...
@dataclass(kw_only=True)
class Routing(RoutingElemType):
    class Meta:
        name = "routing"


@dataclass(kw_only=True)
class ShrinkSleeveGroup(ShrinkSleeveGroupElemType):
    class Meta:
        name = "shrinkSleeveGroup"


@dataclass(kw_only=True)
class SolderSleeveGroup(SolderSleeveGroupElemType):
    class Meta:
        name = "solderSleeveGroup"


@dataclass(kw_only=True)
class ToEquip(ToEquipElemType):
    class Meta:
        name = "toEquip"


@dataclass(kw_only=True)
class WireMaterialGroup(WireMaterialGroupElemType):
    class Meta:
        name = "wireMaterialGroup"


@dataclass(kw_only=True)
class AccessoryGroupElemType:
    class Meta:
        name = "accessoryGroupElemType"

    accessory: list[Accessory] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
...
@dataclass(kw_only=True)
class ConnectorElemType:
    class Meta:
        name = "connectorElemType"
    ...
    rack: None | Rack = field(
        default=None,
        metadata={
            "type": "Element",
        },
    )
    contact_count: None | ContactCount = field(
        default=None,
        metadata={
            "name": "contactCount",
            "type": "Element",
    ...
    contact_descr_group: None | ContactDescrGroup = field(
        default=None,
        metadata={
            "name": "contactDescrGroup",
            "type": "Element",
    ...
    electrical_logic: None | ElectricalLogic = field(
        default=None,
        metadata={
            "name": "electricalLogic",
            "type": "Element",
    ...
    connector_accessories: None | ConnectorAccessories = field(
        default=None,
        metadata={
            "name": "connectorAccessories",
            "type": "Element",
...
@dataclass(kw_only=True)
class ElectricalEquipElemType:
    class Meta:
        name = "electricalEquipElemType"
    ...
    max_mounting_positions: None | MaxMountingPositions = field(
        default=None,
        metadata={
            "name": "maxMountingPositions",
            "type": "Element",
    ...
    system_breakdown_code: None | SystemBreakdownCode = field(
        default=None,
        metadata={
            "name": "systemBreakdownCode",
            "type": "Element",
    ...
    transverse_link: None | TransverseLink = field(
        default=None,
        metadata={
            "name": "transverseLink",
            "type": "Element",
    ...
    connection_list_class: None | ConnectionListClass = field(
        default=None,
        metadata={
            "name": "connectionListClass",
            "type": "Element",
    ...
    equip_name: None | EquipName = field(
        default=None,
        metadata={
            "name": "equipName",
            "type": "Element",
    ...
    installation_info: list[InstallationInfo] = field(
        default_factory=list,
        metadata={
            "name": "installationInfo",
            "type": "Element",
    ...
    equip_descr_ref: None | EquipDescrRef = field(
        default=None,
        metadata={
            "name": "equipDescrRef",
            "type": "Element",
    ...
    change_info: None | ChangeInfoAttType = field(
        default=None,
        metadata={
            "name": "changeInfo",
            "type": "Attribute",
    ...
    equip_state: None | EquipStateAttType = field(
        default=None,
        metadata={
            "name": "equipState",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class HarnessElemType:
    class Meta:
        name = "harnessElemType"

    harness_ident: HarnessIdent = field(
        metadata={
            "name": "harnessIdent",
            "type": "Element",
        }
    )
    harness_info: None | HarnessInfo = field(
        default=None,
        metadata={
            "name": "harnessInfo",
            "type": "Element",
...
@dataclass(kw_only=True)
class WireConnectionElemType:
    class Meta:
        name = "wireConnectionElemType"

    from_equip: FromEquip = field(
        metadata={
            "name": "fromEquip",
            "type": "Element",
        }
    )
    to_equip: None | ToEquip = field(
        default=None,
        metadata={
            "name": "toEquip",
            "type": "Element",
...
@dataclass(kw_only=True)
class WireInfoElemType:
    class Meta:
        name = "wireInfoElemType"
    ...
    harness_ident: None | HarnessIdent = field(
        default=None,
        metadata={
            "name": "harnessIdent",
            "type": "Element",
    ...
    wire_seq_number: None | WireSeqNumber = field(
        default=None,
        metadata={
            "name": "wireSeqNumber",
            "type": "Element",
    ...
    signal_info: None | SignalInfo = field(
        default=None,
        metadata={
            "name": "signalInfo",
            "type": "Element",
    ...
    wire_route: None | WireRoute = field(
        default=None,
        metadata={
            "name": "wireRoute",
            "type": "Element",
    ...
    restriction: None | Restriction = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    change_authority_data_group: None | ChangeAuthorityDataGroup = field(
        default=None,
        metadata={
            "name": "changeAuthorityDataGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class AccessoryGroup(AccessoryGroupElemType):
    class Meta:
        name = "accessoryGroup"
...
@dataclass(kw_only=True)
class Connector(ConnectorElemType):
    class Meta:
        name = "connector"
...
@dataclass(kw_only=True)
class ElectricalEquip(ElectricalEquipElemType):
    class Meta:
        name = "electricalEquip"


@dataclass(kw_only=True)
class Harness(HarnessElemType):
    class Meta:
        name = "harness"


@dataclass(kw_only=True)
class WireConnection(WireConnectionElemType):
    class Meta:
        name = "wireConnection"


@dataclass(kw_only=True)
class WireInfo(WireInfoElemType):
    class Meta:
        name = "wireInfo"


@dataclass(kw_only=True)
class ConnectorGroupElemType:
    class Meta:
        name = "connectorGroupElemType"
...
@dataclass(kw_only=True)
class ElectricalEquipAltsElemType:
    class Meta:
        name = "electricalEquipAltsElemType"

    electrical_equip: list[ElectricalEquip] = field(
        default_factory=list,
        metadata={
            "name": "electricalEquip",
            "type": "Element",
...
@dataclass(kw_only=True)
class HarnessAltsElemType:
    class Meta:
        name = "harnessAltsElemType"

    harness: list[Harness] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
...
class WireElemType:
    ...
    wire_ident: WireIdent = field(
        metadata={
            "name": "wireIdent",
            "type": "Element",
        }
    )
    wire_connection: WireConnection = field(
        metadata={
            "name": "wireConnection",
            "type": "Element",
        }
    )
    wire_info: None | WireInfo = field(
        default=None,
        metadata={
            "name": "wireInfo",
            "type": "Element",
    ...
    wire_state: None | WireStateAttType = field(
        default=None,
        metadata={
            "name": "wireState",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class ConnectorGroup(ConnectorGroupElemType):
    class Meta:
        name = "connectorGroup"
...
@dataclass(kw_only=True)
class ElectricalEquipAlts(ElectricalEquipAltsElemType):
    class Meta:
        name = "electricalEquipAlts"
...
@dataclass(kw_only=True)
class HarnessAlts(HarnessAltsElemType):
    class Meta:
        name = "harnessAlts"


@dataclass(kw_only=True)
class Wire(WireElemType):
    class Meta:
        name = "wire"
...
@dataclass(kw_only=True)
class ElectricalEquipGroupElemType:
    class Meta:
        name = "electricalEquipGroupElemType"
    ...
    electrical_equip_alts: list[ElectricalEquipAlts] = field(
        default_factory=list,
        metadata={
            "name": "electricalEquipAlts",
            "type": "Element",
...
@dataclass(kw_only=True)
class HarnessGroupElemType:
    class Meta:
        name = "harnessGroupElemType"
    ...
    harness_alts: list[HarnessAlts] = field(
        default_factory=list,
        metadata={
            "name": "harnessAlts",
            "type": "Element",
...
@dataclass(kw_only=True)
class StandardPartGroupElemType:
    class Meta:
        name = "standardPartGroupElemType"

    connector_group: None | ConnectorGroup = field(
        default=None,
        metadata={
            "name": "connectorGroup",
            "type": "Element",
    ...
    distribution_part_group: None | DistributionPartGroup = field(
        default=None,
        metadata={
            "name": "distributionPartGroup",
            "type": "Element",
    ...
    accessory_group: None | AccessoryGroup = field(
        default=None,
        metadata={
            "name": "accessoryGroup",
            "type": "Element",
    ...
    solder_sleeve_group: None | SolderSleeveGroup = field(
        default=None,
        metadata={
            "name": "solderSleeveGroup",
            "type": "Element",
    ...
    shrink_sleeve_group: None | ShrinkSleeveGroup = field(
        default=None,
        metadata={
            "name": "shrinkSleeveGroup",
            "type": "Element",
    ...
    ident_sleeve_group: None | IdentSleeveGroup = field(
        default=None,
        metadata={
            "name": "identSleeveGroup",
            "type": "Element",
    ...
    conduit_group: None | ConduitGroup = field(
        default=None,
        metadata={
            "name": "conduitGroup",
            "type": "Element",
    ...
    wire_material_group: None | WireMaterialGroup = field(
        default=None,
        metadata={
            "name": "wireMaterialGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class WireAltsElemType:
    class Meta:
        name = "wireAltsElemType"
...
@dataclass(kw_only=True)
class ElectricalEquipGroup(ElectricalEquipGroupElemType):
    class Meta:
        name = "electricalEquipGroup"


@dataclass(kw_only=True)
class HarnessGroup(HarnessGroupElemType):
    class Meta:
        name = "harnessGroup"
...
@dataclass(kw_only=True)
class StandardPartGroup(StandardPartGroupElemType):
    class Meta:
        name = "standardPartGroup"
...
@dataclass(kw_only=True)
class WireAlts(WireAltsElemType):
    class Meta:
        name = "wireAlts"
...
@dataclass(kw_only=True)
class WireGroupElemType:
    class Meta:
        name = "wireGroupElemType"
...
@dataclass(kw_only=True)
class WireGroup(WireGroupElemType):
    class Meta:
        name = "wireGroup"
...
@dataclass(kw_only=True)
class WiringDataElemType:
    class Meta:
        name = "wiringDataElemType"

    wire_group: None | WireGroup = field(
        default=None,
        metadata={
            "name": "wireGroup",
            "type": "Element",
    ...
    harness_group: None | HarnessGroup = field(
        default=None,
        metadata={
            "name": "harnessGroup",
            "type": "Element",
    ...
    electrical_equip_group: None | ElectricalEquipGroup = field(
        default=None,
        metadata={
            "name": "electricalEquipGroup",
            "type": "Element",
    ...
    standard_part_group: None | StandardPartGroup = field(
        default=None,
        metadata={
            "name": "standardPartGroup",
            "type": "Element",
...
@dataclass(kw_only=True)
class WiringData(WiringDataElemType):
    class Meta:
        name = "wiringData"
