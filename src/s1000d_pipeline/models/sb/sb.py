...
class GenericPropertyTypeAttType(Enum):
    GPT01 = "gpt01"
    GPT02 = "gpt02"
    GPT03 = "gpt03"
    GPT04 = "gpt04"
...
class LimitTypeValueAttType(Enum):
    PO = "po"
    OC = "oc"
    PE = "pe"
...
class ReleaseEventAttType(Enum):
    BEFORE = "before"
    WITH = "with"
    AFTER = "after"
...
@dataclass(kw_only=True)
class SamplingElemType:
    class Meta:
        name = "samplingElemType"

    sampling_value: None | int = field(
        default=None,
        metadata={
            "name": "samplingValue",
            "type": "Attribute",
    ...
    sampling_ratio: None | Decimal = field(
        default=None,
        metadata={
            "name": "samplingRatio",
            "type": "Attribute",
...
class SbComplianceCategoryAttType(Enum):
    SBCC01 = "sbcc01"
    SBCC02 = "sbcc02"
    SBCC03 = "sbcc03"
    SBCC04 = "sbcc04"
...
class SbConcurrentStatusAttType(Enum):
    PREVIOUS = "previous"
    NOT_PREVIOUS = "notPrevious"
    PREVIOUS_OR_PARALLEL = "previousOrParallel"


class SbImpactTypeAttType(Enum):
    SBIT01 = "sbit01"
    SBIT02 = "sbit02"
    SBIT03 = "sbit03"
    SBIT04 = "sbit04"
...
class SbMaterialTypeAttType(Enum):
    SBMT01 = "sbmt01"
    SBMT02 = "sbmt02"
    SBMT03 = "sbmt03"
    SBMT04 = "sbmt04"
...
class SbModificationClassificationAttType(Enum):
    MAJOR = "major"
    MINOR = "minor"


class SbReplacementTypeAttType(Enum):
    NOMINAL = "nominal"
    CONDITIONAL = "conditional"


class SbSupplierValueAttType(Enum):
    MANUFACTURER = "manufacturer"
    SUPPLIER = "supplier"
    ANY = "any"


class SbTaskCategoryAttType(Enum):
    SBTC01 = "sbtc01"
    SBTC02 = "sbtc02"
    SBTC03 = "sbtc03"
    SBTC04 = "sbtc04"
...
class SbTimeComplianceTypeAttType(Enum):
    SBTCT01 = "sbtct01"
    SBTCT02 = "sbtct02"
    SBTCT03 = "sbtct03"
    SBTCT04 = "sbtct04"
...
@dataclass(kw_only=True)
class GenericPropertyElemType:
    class Meta:
        name = "genericPropertyElemType"
    ...
    generic_property_type: GenericPropertyTypeAttType = field(
        metadata={
            "name": "genericPropertyType",
            "type": "Attribute",
        }
    )
    generic_property_flag: None | str = field(
        default=None,
        metadata={
            "name": "genericPropertyFlag",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
...
@dataclass(kw_only=True)
class InspectionTypeElemType:
    class Meta:
        name = "inspectionTypeElemType"

    inspection_type_category: str = field(
        metadata={
            "name": "inspectionTypeCategory",
            "type": "Attribute",
        }
    )
    id: None | str = field(
...
@dataclass(kw_only=True)
class Sampling(SamplingElemType):
    class Meta:
        name = "sampling"


@dataclass(kw_only=True)
class SbAlteredToPartDescrElemType:
    class Meta:
        name = "sbAlteredToPartDescrElemType"
...
@dataclass(kw_only=True)
class SbApprovalElemType:
    class Meta:
        name = "sbApprovalElemType"
    ...
    sb_approval_ident: str = field(
        metadata={
            "name": "sbApprovalIdent",
            "type": "Attribute",
        }
    )
    control_authority_refs: list[str] = field(
...
@dataclass(kw_only=True)
class SbComplianceElemType:
    class Meta:
        name = "sbComplianceElemType"
    ...
    sb_compliance_category: SbComplianceCategoryAttType = field(
        metadata={
            "name": "sbComplianceCategory",
            "type": "Attribute",
        }
    )
    control_authority_refs: list[str] = field(
...
@dataclass(kw_only=True)
class SbProductModificationElemType:
    class Meta:
        name = "sbProductModificationElemType"
    ...
    sb_modification_ident: None | str = field(
        default=None,
        metadata={
            "name": "sbModificationIdent",
            "type": "Attribute",
        },
    )
    sb_modification_classification: (
        None | SbModificationClassificationAttType
    ) = field(
        default=None,
        metadata={
            "name": "sbModificationClassification",
            "type": "Attribute",
        },
    )
    control_authority_refs: list[str] = field(
...
@dataclass(kw_only=True)
class SbTaskTypeElemType:
    class Meta:
        name = "sbTaskTypeElemType"
    ...
    sb_task_category: SbTaskCategoryAttType = field(
        metadata={
            "name": "sbTaskCategory",
            "type": "Attribute",
        }
...
@dataclass(kw_only=True)
class GenericProperty(GenericPropertyElemType):
    class Meta:
...
@dataclass(kw_only=True)
class InspectionType(InspectionTypeElemType):
    class Meta:
        name = "inspectionType"
...
@dataclass(kw_only=True)
class SbAlteredToPartDescr(SbAlteredToPartDescrElemType):
    class Meta:
        name = "sbAlteredToPartDescr"


@dataclass(kw_only=True)
class SbApproval(SbApprovalElemType):
    class Meta:
        name = "sbApproval"


@dataclass(kw_only=True)
class SbCompliance(SbComplianceElemType):
    class Meta:
        name = "sbCompliance"


@dataclass(kw_only=True)
class SbOriginalIssueDateElemType:
    class Meta:
        name = "sbOriginalIssueDateElemType"
...
@dataclass(kw_only=True)
class SbProductModification(SbProductModificationElemType):
    class Meta:
        name = "sbProductModification"


@dataclass(kw_only=True)
class SbTaskType(SbTaskTypeElemType):
    class Meta:
        name = "sbTaskType"
...
@dataclass(kw_only=True)
class GenericPropertyGroupElemType:
    class Meta:
        name = "genericPropertyGroupElemType"

    generic_property: list[GenericProperty] = field(
        default_factory=list,
        metadata={
            "name": "genericProperty",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbMaterialSetRefElemType:
    class Meta:
        name = "sbMaterialSetRefElemType"
    ...
    sb_material_type: None | SbMaterialTypeAttType = field(
        default=None,
        metadata={
            "name": "sbMaterialType",
            "type": "Attribute",
    ...
    sb_material_ident: None | str = field(
        default=None,
        metadata={
            "name": "sbMaterialIdent",
            "type": "Attribute",
        },
    )
    sb_material_issue: None | str = field(
        default=None,
        metadata={
            "name": "sbMaterialIssue",
            "type": "Attribute",
        },
    )
    security_classification: None | SecurityClassificationAttType = field(
...
@dataclass(kw_only=True)
class SbOriginalIssueDate(SbOriginalIssueDateElemType):
    class Meta:
        name = "sbOriginalIssueDate"


@dataclass(kw_only=True)
class SbProductModificationListElemType:
    class Meta:
        name = "sbProductModificationListElemType"

    no_info: None | NoInfo = field(
        default=None,
        metadata={
            "name": "noInfo",
            "type": "Element",
    ...
    sb_product_modification: list[SbProductModification] = field(
        default_factory=list,
        metadata={
            "name": "sbProductModification",
            "type": "Element",
...
@dataclass(kw_only=True)
class GenericPropertyGroup(GenericPropertyGroupElemType):
    class Meta:
        name = "genericPropertyGroup"
...
@dataclass(kw_only=True)
class SbMaterialSetRef(SbMaterialSetRefElemType):
    class Meta:
        name = "sbMaterialSetRef"


@dataclass(kw_only=True)
class SbProductModificationList(SbProductModificationListElemType):
    class Meta:
        name = "sbProductModificationList"
...
@dataclass(kw_only=True)
class LimitRangeFromElemType:
    class Meta:
        name = "limitRangeFromElemType"
...
@dataclass(kw_only=True)
class LimitRangeToElemType:
    class Meta:
        name = "limitRangeToElemType"
...
@dataclass(kw_only=True)
class SbMaterialDescrElemType:
    class Meta:
        name = "sbMaterialDescrElemType"

    sb_material_set_ref: SbMaterialSetRef = field(
        metadata={
            "name": "sbMaterialSetRef",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class LimitRangeFrom(LimitRangeFromElemType):
    class Meta:
        name = "limitRangeFrom"


@dataclass(kw_only=True)
class LimitRangeTo(LimitRangeToElemType):
    class Meta:
        name = "limitRangeTo"
...
@dataclass(kw_only=True)
class SbMaterialDescr(SbMaterialDescrElemType):
    class Meta:
        name = "sbMaterialDescr"
...
@dataclass(kw_only=True)
class LimitRangeElemType:
    class Meta:
        name = "limitRangeElemType"

    limit_range_from: None | LimitRangeFrom = field(
        default=None,
        metadata={
            "name": "limitRangeFrom",
            "type": "Element",
    ...
    limit_range_to: list[LimitRangeTo] = field(
        default_factory=list,
        metadata={
            "name": "limitRangeTo",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbAvailabilityElemType:
    class Meta:
        name = "sbAvailabilityElemType"
...
@dataclass(kw_only=True)
class SbImpactElemType:
    class Meta:
        name = "sbImpactElemType"
    ...
    sb_impact_type: SbImpactTypeAttType = field(
        metadata={
            "name": "sbImpactType",
            "type": "Attribute",
        }
...
@dataclass(kw_only=True)
class SbPriceInfoElemType:
    class Meta:
        name = "sbPriceInfoElemType"
...
@dataclass(kw_only=True)
class SbTimeGenericElemType:
    class Meta:
        name = "sbTimeGenericElemType"
...
@dataclass(kw_only=True)
class LimitRange(LimitRangeElemType):
    class Meta:
        name = "limitRange"
...
@dataclass(kw_only=True)
class SbAvailability(SbAvailabilityElemType):
    class Meta:
        name = "sbAvailability"


@dataclass(kw_only=True)
class SbDuration(SbTimeGenericElemType):
    class Meta:
        name = "sbDuration"


@dataclass(kw_only=True)
class SbEstimatedTime(SbTimeGenericElemType):
    class Meta:
        name = "sbEstimatedTime"


@dataclass(kw_only=True)
class SbImpact(SbImpactElemType):
    class Meta:
        name = "sbImpact"


@dataclass(kw_only=True)
class SbPriceInfo(SbPriceInfoElemType):
    class Meta:
        name = "sbPriceInfo"
...
@dataclass(kw_only=True)
class SbImpactListElemType:
    class Meta:
        name = "sbImpactListElemType"
...
@dataclass(kw_only=True)
class SbImpactList(SbImpactListElemType):
    class Meta:
        name = "sbImpactList"
...
@dataclass(kw_only=True)
class SbProcurementAddressElemType:
    class Meta:
        name = "sbProcurementAddressElemType"
    ...
    footnote_remarks: list[FootnoteRemarks] = field(
        default_factory=list,
        metadata={
            "name": "footnoteRemarks",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbProcurementAddress(SbProcurementAddressElemType):
    class Meta:
        name = "sbProcurementAddress"
...
@dataclass(kw_only=True)
class SbProcurementInfoElemType:
    class Meta:
        name = "sbProcurementInfoElemType"

    sb_price_info: None | SbPriceInfo = field(
        default=None,
        metadata={
            "name": "sbPriceInfo",
            "type": "Element",
    ...
    sb_availability: None | SbAvailability = field(
        default=None,
        metadata={
            "name": "sbAvailability",
            "type": "Element",
    ...
    sb_procurement_address: None | SbProcurementAddress = field(
        default=None,
        metadata={
            "name": "sbProcurementAddress",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbProcurementInfo(SbProcurementInfoElemType):
    class Meta:
        name = "sbProcurementInfo"
...
@dataclass(kw_only=True)
class SbApprovedDmElemType:
    class Meta:
        name = "sbApprovedDmElemType"
...
@dataclass(kw_only=True)
class SbConcurrentSbInfoElemType:
    class Meta:
        name = "sbConcurrentSbInfoElemType"
    ...
    sb_concurrent_status: SbConcurrentStatusAttType = field(
        metadata={
            "name": "sbConcurrentStatus",
            "type": "Attribute",
        }
    )
    control_authority_refs: list[str] = field(
...
@dataclass(kw_only=True)
class SbDrawingRefElemType:
    class Meta:
        name = "sbDrawingRefElemType"
...
@dataclass(kw_only=True)
class SbExternalMaterialSetGenericElemType:
    class Meta:
        name = "sbExternalMaterialSetGenericElemType"
    ...
    sb_procurable_flag: None | str = field(
        default=None,
        metadata={
            "name": "sbProcurableFlag",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
    sb_supplier_value: None | SbSupplierValueAttType = field(
        default=None,
        metadata={
            "name": "sbSupplierValue",
            "type": "Attribute",
        },
    )
    security_classification: None | SecurityClassificationAttType = field(
...
@dataclass(kw_only=True)
class SbRefGenericElemType:
    class Meta:
        name = "sbRefGenericElemType"
...
@dataclass(kw_only=True)
class SbReplacementSbElemType:
    class Meta:
        name = "sbReplacementSbElemType"
...
@dataclass(kw_only=True)
class TriggerElemType:
    class Meta:
        name = "triggerElemType"
    ...
    occurrence_trigger: None | str = field(
        default=None,
        metadata={
            "name": "occurrenceTrigger",
            "type": "Attribute",
        },
    )
    release_event: None | ReleaseEventAttType = field(
        default=None,
        metadata={
            "name": "releaseEvent",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class SbApprovedDm(SbApprovedDmElemType):
    class Meta:
        name = "sbApprovedDm"


@dataclass(kw_only=True)
class SbConcurrentSbInfo(SbConcurrentSbInfoElemType):
    class Meta:
        name = "sbConcurrentSbInfo"


@dataclass(kw_only=True)
class SbCondition(SbRefGenericElemType):
    class Meta:
        name = "sbCondition"


@dataclass(kw_only=True)
class SbDrawingRef(SbDrawingRefElemType):
    class Meta:
        name = "sbDrawingRef"


@dataclass(kw_only=True)
class SbExternalSpareSet(SbExternalMaterialSetGenericElemType):
    class Meta:
        name = "sbExternalSpareSet"


@dataclass(kw_only=True)
class SbExternalSupplySet(SbExternalMaterialSetGenericElemType):
    class Meta:
        name = "sbExternalSupplySet"


@dataclass(kw_only=True)
class SbExternalSupportEquipSet(SbExternalMaterialSetGenericElemType):
    class Meta:
        name = "sbExternalSupportEquipSet"


@dataclass(kw_only=True)
class SbInstructionRef(SbRefGenericElemType):
    class Meta:
        name = "sbInstructionRef"


@dataclass(kw_only=True)
class SbReplacementSb(SbReplacementSbElemType):
    class Meta:
        name = "sbReplacementSb"
...
class LimitElemType:
    ...
    inspection_type: list[InspectionType] = field(
        default_factory=list,
        metadata={
            "name": "inspectionType",
            "type": "Element",
    ...
    limit_range: list[LimitRange] = field(
        default_factory=list,
        metadata={
            "name": "limitRange",
            "type": "Element",
    ...
    limit_type_value: LimitTypeValueAttType = field(
        default=LimitTypeValueAttType.PE,
        metadata={
            "name": "limitTypeValue",
            "type": "Attribute",
        },
    )
    limit_cond: None | str = field(
        default=None,
        metadata={
            "name": "limitCond",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class SbAlteredToPartElemType:
    class Meta:
        name = "sbAlteredToPartElemType"
    ...
    sb_altered_to_part_descr: None | SbAlteredToPartDescr = field(
        default=None,
        metadata={
            "name": "sbAlteredToPartDescr",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbConcurrentSbListElemType:
    class Meta:
        name = "sbConcurrentSbListElemType"
    ...
    sb_concurrent_sb_info: list[SbConcurrentSbInfo] = field(
        default_factory=list,
        metadata={
            "name": "sbConcurrentSbInfo",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbRemovedSpareDescrElemType:
    class Meta:
        name = "sbRemovedSpareDescrElemType"
...
@dataclass(kw_only=True)
class SbTimeInfoElemType:
    class Meta:
        name = "sbTimeInfoElemType"

    sb_condition: None | SbCondition = field(
        default=None,
        metadata={
            "name": "sbCondition",
            "type": "Element",
    ...
    sb_duration: SbDuration = field(
        metadata={
            "name": "sbDuration",
            "type": "Element",
        }
    )
    sb_estimated_time: SbEstimatedTime = field(
        metadata={
            "name": "sbEstimatedTime",
            "type": "Element",
        }
    ...
    sb_aggregation_level_flag: None | str = field(
        default=None,
        metadata={
            "name": "sbAggregationLevelFlag",
            "type": "Attribute",
            "pattern": r"[01]",
        },
    )
...
@dataclass(kw_only=True)
class SbAlteredToPart(SbAlteredToPartElemType):
    class Meta:
        name = "sbAlteredToPart"


@dataclass(kw_only=True)
class SbConcurrentSbList(SbConcurrentSbListElemType):
    class Meta:
        name = "sbConcurrentSbList"


@dataclass(kw_only=True)
class SbRemovedSpareDescr(SbRemovedSpareDescrElemType):
    class Meta:
        name = "sbRemovedSpareDescr"


@dataclass(kw_only=True)
class SbTimeInfo(SbTimeInfoElemType):
    class Meta:
        name = "sbTimeInfo"
...
@dataclass(kw_only=True)
class SbIndustrySupportElemType:
    class Meta:
        name = "sbIndustrySupportElemType"
...
@dataclass(kw_only=True)
class SbReplacementElemType:
    class Meta:
        name = "sbReplacementElemType"
    ...
    sb_altered_to_part: list[SbAlteredToPart] = field(
        default_factory=list,
        metadata={
            "name": "sbAlteredToPart",
            "type": "Element",
    ...
    sb_drawing_ref: list[SbDrawingRef] = field(
        default_factory=list,
        metadata={
            "name": "sbDrawingRef",
            "type": "Element",
    ...
    sb_material_set_ref: list[SbMaterialSetRef] = field(
        default_factory=list,
        metadata={
            "name": "sbMaterialSetRef",
            "type": "Element",
    ...
    sb_replacement_type: None | SbReplacementTypeAttType = field(
        default=None,
        metadata={
            "name": "sbReplacementType",
            "type": "Attribute",
        },
    )
    security_classification: None | SecurityClassificationAttType = field(
...
@dataclass(kw_only=True)
class SbTimeAssessmentElemType:
    class Meta:
        name = "sbTimeAssessmentElemType"
    ...
    sb_time_info: list[SbTimeInfo] = field(
        default_factory=list,
        metadata={
            "name": "sbTimeInfo",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbTimeComplianceElemType:
    class Meta:
        name = "sbTimeComplianceElemType"
    ...
    sb_time_compliance_type: SbTimeComplianceTypeAttType = field(
        metadata={
            "name": "sbTimeComplianceType",
            "type": "Attribute",
        }
    )
    control_authority_refs: list[str] = field(
...
@dataclass(kw_only=True)
class SbIndustrySupport(SbIndustrySupportElemType):
    class Meta:
        name = "sbIndustrySupport"


@dataclass(kw_only=True)
class SbReplacement(SbReplacementElemType):
    class Meta:
        name = "sbReplacement"


@dataclass(kw_only=True)
class SbTimeAssessment(SbTimeAssessmentElemType):
    class Meta:
        name = "sbTimeAssessment"


@dataclass(kw_only=True)
class SbTimeCompliance(SbTimeComplianceElemType):
    class Meta:
        name = "sbTimeCompliance"
...
@dataclass(kw_only=True)
class SbIndividualSpareElemType:
    class Meta:
        name = "sbIndividualSpareElemType"

    embedded_spare_descr: EmbeddedSpareDescr = field(
        metadata={
            "name": "embeddedSpareDescr",
            "type": "Element",
        }
    ...
    sb_procurement_info: None | SbProcurementInfo = field(
        default=None,
        metadata={
            "name": "sbProcurementInfo",
            "type": "Element",
    ...
    sb_industry_support: None | SbIndustrySupport = field(
        default=None,
        metadata={
            "name": "sbIndustrySupport",
            "type": "Element",
    ...
    sb_instruction_ref: None | SbInstructionRef = field(
        default=None,
        metadata={
            "name": "sbInstructionRef",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbIndividualSupplyElemType:
    class Meta:
        name = "sbIndividualSupplyElemType"

    embedded_supply_descr: EmbeddedSupplyDescr = field(
        metadata={
            "name": "embeddedSupplyDescr",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class SbIndividualSupportEquipElemType:
    class Meta:
        name = "sbIndividualSupportEquipElemType"

    embedded_support_equip_descr: EmbeddedSupportEquipDescr = field(
        metadata={
            "name": "embeddedSupportEquipDescr",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class SbInterchangeElemType:
    class Meta:
        name = "sbInterchangeElemType"

    sb_replacement: list[SbReplacement] = field(
        default_factory=list,
        metadata={
            "name": "sbReplacement",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbLimitElemType:
    class Meta:
        name = "sbLimitElemType"

    sb_instruction_ref: list[SbInstructionRef] = field(
        default_factory=list,
        metadata={
            "name": "sbInstructionRef",
            "type": "Element",
    ...
    sb_time_compliance: list[SbTimeCompliance] = field(
        default_factory=list,
        metadata={
            "name": "sbTimeCompliance",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbMaterialSetElemType:
    class Meta:
        name = "sbMaterialSetElemType"
    ...
    sb_material_descr: list[SbMaterialDescr] = field(
        default_factory=list,
        metadata={
            "name": "sbMaterialDescr",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbIndividualSpare(SbIndividualSpareElemType):
    class Meta:
        name = "sbIndividualSpare"


@dataclass(kw_only=True)
class SbIndividualSupply(SbIndividualSupplyElemType):
    class Meta:
        name = "sbIndividualSupply"


@dataclass(kw_only=True)
class SbIndividualSupportEquip(SbIndividualSupportEquipElemType):
    class Meta:
        name = "sbIndividualSupportEquip"


@dataclass(kw_only=True)
class SbInterchange(SbInterchangeElemType):
    class Meta:
        name = "sbInterchange"


@dataclass(kw_only=True)
class SbLimit(SbLimitElemType):
    class Meta:
        name = "sbLimit"


@dataclass(kw_only=True)
class SbMaterialSet(SbMaterialSetElemType):
    class Meta:
        name = "sbMaterialSet"
...
@dataclass(kw_only=True)
class SbAccomplishmentLimitElemType:
    class Meta:
        name = "sbAccomplishmentLimitElemType"
...
@dataclass(kw_only=True)
class SbIndividualRemovedSpareElemType:
    class Meta:
        name = "sbIndividualRemovedSpareElemType"

    sb_removed_spare_descr: SbRemovedSpareDescr = field(
        metadata={
            "name": "sbRemovedSpareDescr",
            "type": "Element",
        }
    ...
    generic_property_group: None | GenericPropertyGroup = field(
        default=None,
        metadata={
            "name": "genericPropertyGroup",
            "type": "Element",
    ...
    sb_interchange: None | SbInterchange = field(
        default=None,
        metadata={
            "name": "sbInterchange",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbSpareSetElemType:
    class Meta:
        name = "sbSpareSetElemType"
    ...
    sb_individual_spare: list[SbIndividualSpare] = field(
        default_factory=list,
        metadata={
            "name": "sbIndividualSpare",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbSupplySetElemType:
    class Meta:
        name = "sbSupplySetElemType"
    ...
    sb_individual_supply: list[SbIndividualSupply] = field(
        default_factory=list,
        metadata={
            "name": "sbIndividualSupply",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbSupportEquipSetElemType:
    class Meta:
        name = "sbSupportEquipSetElemType"
    ...
    sb_individual_support_equip: list[SbIndividualSupportEquip] = field(
        default_factory=list,
        metadata={
            "name": "sbIndividualSupportEquip",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbAccomplishmentLimit(SbAccomplishmentLimitElemType):
    class Meta:
        name = "sbAccomplishmentLimit"


@dataclass(kw_only=True)
class SbIndividualRemovedSpare(SbIndividualRemovedSpareElemType):
    class Meta:
        name = "sbIndividualRemovedSpare"


@dataclass(kw_only=True)
class SbSpareSet(SbSpareSetElemType):
    class Meta:
        name = "sbSpareSet"


@dataclass(kw_only=True)
class SbSupplySet(SbSupplySetElemType):
    class Meta:
        name = "sbSupplySet"


@dataclass(kw_only=True)
class SbSupportEquipSet(SbSupportEquipSetElemType):
    class Meta:
        name = "sbSupportEquipSet"
...
@dataclass(kw_only=True)
class SbRemovedSpareSetElemType:
    class Meta:
        name = "sbRemovedSpareSetElemType"
    ...
    sb_individual_removed_spare: list[SbIndividualRemovedSpare] = field(
        default_factory=list,
        metadata={
            "name": "sbIndividualRemovedSpare",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbRemovedSpareSet(SbRemovedSpareSetElemType):
    class Meta:
        name = "sbRemovedSpareSet"
...
@dataclass(kw_only=True)
class SbMaterialSetListElemType:
    class Meta:
        name = "sbMaterialSetListElemType"
    ...
    sb_material_set: list[SbMaterialSet] = field(
        default_factory=list,
        metadata={
            "name": "sbMaterialSet",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbRemovedSparesListElemType:
    class Meta:
        name = "sbRemovedSparesListElemType"
    ...
    sb_removed_spare_set: list[SbRemovedSpareSet] = field(
        default_factory=list,
        metadata={
            "name": "sbRemovedSpareSet",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbSparesListElemType:
    class Meta:
        name = "sbSparesListElemType"
    ...
    sb_spare_set: list[SbSpareSet] = field(
        default_factory=list,
        metadata={
            "name": "sbSpareSet",
            "type": "Element",
    ...
    sb_external_spare_set: list[SbExternalSpareSet] = field(
        default_factory=list,
        metadata={
            "name": "sbExternalSpareSet",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbSuppliesListElemType:
    class Meta:
        name = "sbSuppliesListElemType"
    ...
    sb_supply_set: list[SbSupplySet] = field(
        default_factory=list,
        metadata={
            "name": "sbSupplySet",
            "type": "Element",
    ...
    sb_external_supply_set: list[SbExternalSupplySet] = field(
        default_factory=list,
        metadata={
            "name": "sbExternalSupplySet",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbSupportEquipsListElemType:
    class Meta:
        name = "sbSupportEquipsListElemType"
    ...
    sb_support_equip_set: list[SbSupportEquipSet] = field(
        default_factory=list,
        metadata={
            "name": "sbSupportEquipSet",
            "type": "Element",
    ...
    sb_external_support_equip_set: list[SbExternalSupportEquipSet] = field(
        default_factory=list,
        metadata={
            "name": "sbExternalSupportEquipSet",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbMaterialSetList(SbMaterialSetListElemType):
    class Meta:
        name = "sbMaterialSetList"


@dataclass(kw_only=True)
class SbRemovedSparesList(SbRemovedSparesListElemType):
    class Meta:
        name = "sbRemovedSparesList"


@dataclass(kw_only=True)
class SbSparesList(SbSparesListElemType):
    class Meta:
        name = "sbSparesList"


@dataclass(kw_only=True)
class SbSuppliesList(SbSuppliesListElemType):
    class Meta:
        name = "sbSuppliesList"


@dataclass(kw_only=True)
class SbSupportEquipsList(SbSupportEquipsListElemType):
    class Meta:
        name = "sbSupportEquipsList"
...
@dataclass(kw_only=True)
class ProceduralStepElemType:
    class Meta:
        name = "proceduralStepElemType"
    ...
    procedural_step: list[ProceduralStep] = field(
        default_factory=list,
        metadata={
            "name": "proceduralStep",
            "type": "Element",
    ...
    procedural_step_alts: list[ProceduralStepAlts] = field(
        default_factory=list,
        metadata={
            "name": "proceduralStepAlts",
            "type": "Element",
        },
    )
    applic_ref_id: None | str = field(
...
@dataclass(kw_only=True)
class ProceduralStep(ProceduralStepElemType):
    class Meta:
        name = "proceduralStep"
...
@dataclass(kw_only=True)
class ProceduralStepAltsElemType:
    class Meta:
        name = "proceduralStepAltsElemType"
...
@dataclass(kw_only=True)
class ProceduralStepAlts(ProceduralStepAltsElemType):
    class Meta:
        name = "proceduralStepAlts"
...
@dataclass(kw_only=True)
class MainProcedureElemType:
    class Meta:
        name = "mainProcedureElemType"
...
@dataclass(kw_only=True)
class MainProcedure(MainProcedureElemType):
    class Meta:
        name = "mainProcedure"


@dataclass(kw_only=True)
class SbTopicContent(DescriptionElemType):
    class Meta:
        name = "sbTopicContent"


@dataclass(kw_only=True)
class SbAccomplishmentInstructionsElemType:
    class Meta:
        name = "sbAccomplishmentInstructionsElemType"
    ...
    main_procedure: None | MainProcedure = field(
        default=None,
        metadata={
            "name": "mainProcedure",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbManagementInfoElemType:
    class Meta:
        name = "sbManagementInfoElemType"
    ...
    sb_compliance: SbCompliance = field(
        metadata={
            "name": "sbCompliance",
            "type": "Element",
        }
    )
    sb_task_type: SbTaskType = field(
        metadata={
            "name": "sbTaskType",
            "type": "Element",
        }
    )
    sb_product_modification_list: None | SbProductModificationList = field(
        default=None,
        metadata={
            "name": "sbProductModificationList",
            "type": "Element",
    ...
    sb_impact_list: None | SbImpactList = field(
        default=None,
        metadata={
            "name": "sbImpactList",
            "type": "Element",
    ...
    sb_concurrent_sb_list: None | SbConcurrentSbList = field(
        default=None,
        metadata={
            "name": "sbConcurrentSbList",
            "type": "Element",
    ...
    sb_accomplishment_limit: None | SbAccomplishmentLimit = field(
        default=None,
        metadata={
            "name": "sbAccomplishmentLimit",
            "type": "Element",
    ...
    sb_time_assessment: None | SbTimeAssessment = field(
        default=None,
        metadata={
            "name": "sbTimeAssessment",
            "type": "Element",
    ...
    sb_original_issue_date: SbOriginalIssueDate = field(
        metadata={
            "name": "sbOriginalIssueDate",
            "type": "Element",
        }
    )
    sb_approval: None | SbApproval = field(
        default=None,
        metadata={
            "name": "sbApproval",
            "type": "Element",
    ...
    sb_approved_dm: None | SbApprovedDm = field(
        default=None,
        metadata={
            "name": "sbApprovedDm",
            "type": "Element",
    ...
    sb_replacement_sb: None | SbReplacementSb = field(
        default=None,
        metadata={
            "name": "sbReplacementSb",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbMaterialInfoContentElemType:
    class Meta:
        name = "sbMaterialInfoContentElemType"
    ...
    sb_material_set_list: SbMaterialSetList = field(
        metadata={
            "name": "sbMaterialSetList",
            "type": "Element",
        }
    )
    sb_support_equips_list: SbSupportEquipsList = field(
        metadata={
            "name": "sbSupportEquipsList",
            "type": "Element",
        }
    )
    sb_supplies_list: SbSuppliesList = field(
        metadata={
            "name": "sbSuppliesList",
            "type": "Element",
        }
    )
    sb_spares_list: SbSparesList = field(
        metadata={
            "name": "sbSparesList",
            "type": "Element",
        }
    )
    sb_removed_spares_list: SbRemovedSparesList = field(
        metadata={
            "name": "sbRemovedSparesList",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class SbTopicElemType:
    class Meta:
        name = "sbTopicElemType"
    ...
    sb_topic_content: None | SbTopicContent = field(
        default=None,
        metadata={
            "name": "sbTopicContent",
            "type": "Element",
    ...
    sb_topic_type: SbTopicTypeAttType = field(
        metadata={
            "name": "sbTopicType",
            "type": "Attribute",
        }
...
@dataclass(kw_only=True)
class SbAccomplishmentInstructions(SbAccomplishmentInstructionsElemType):
    class Meta:
        name = "sbAccomplishmentInstructions"


@dataclass(kw_only=True)
class SbManagementInfo(SbManagementInfoElemType):
    class Meta:
        name = "sbManagementInfo"


@dataclass(kw_only=True)
class SbMaterialInfoContent(SbMaterialInfoContentElemType):
    class Meta:
        name = "sbMaterialInfoContent"


@dataclass(kw_only=True)
class SbTopic(SbTopicElemType):
    class Meta:
        name = "sbTopic"


@dataclass(kw_only=True)
class SbMaterialInfoElemType:
    class Meta:
        name = "sbMaterialInfoElemType"
    ...
    sb_material_info_content: None | SbMaterialInfoContent = field(
        default=None,
        metadata={
            "name": "sbMaterialInfoContent",
            "type": "Element",
...
@dataclass(kw_only=True)
class SbTopicSetGenericElemType:
    class Meta:
        name = "sbTopicSetGenericElemType"
...
@dataclass(kw_only=True)
class SbAdditionalInfo(SbTopicSetGenericElemType):
    class Meta:
        name = "sbAdditionalInfo"


@dataclass(kw_only=True)
class SbMaterialInfo(SbMaterialInfoElemType):
    class Meta:
        name = "sbMaterialInfo"


@dataclass(kw_only=True)
class SbPlanningInfo(SbTopicSetGenericElemType):
    class Meta:
        name = "sbPlanningInfo"


@dataclass(kw_only=True)
class SbRevisionInfo(SbTopicSetGenericElemType):
    class Meta:
        name = "sbRevisionInfo"


@dataclass(kw_only=True)
class SbSummary(SbTopicSetGenericElemType):
    class Meta:
        name = "sbSummary"
...
class SbElemType:
    ...
    sb_management_info: None | SbManagementInfo = field(
        default=None,
        metadata={
            "name": "sbManagementInfo",
            "type": "Element",
    ...
    sb_revision_info: None | SbRevisionInfo = field(
        default=None,
        metadata={
            "name": "sbRevisionInfo",
            "type": "Element",
    ...
    sb_summary: None | SbSummary = field(
        default=None,
        metadata={
            "name": "sbSummary",
            "type": "Element",
    ...
    sb_planning_info: None | SbPlanningInfo = field(
        default=None,
        metadata={
            "name": "sbPlanningInfo",
            "type": "Element",
    ...
    sb_material_info: None | SbMaterialInfo = field(
        default=None,
        metadata={
            "name": "sbMaterialInfo",
            "type": "Element",
    ...
    sb_accomplishment_instructions: None | SbAccomplishmentInstructions = (
        field(
            default=None,
            metadata={
                "name": "sbAccomplishmentInstructions",
    ...
    sb_additional_info: None | SbAdditionalInfo = field(
        default=None,
        metadata={
            "name": "sbAdditionalInfo",
            "type": "Element",
