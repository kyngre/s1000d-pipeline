...
class AttachStoreShipPartCodeAttType(Enum):
    VALUE_1 = "1"
    VALUE_2 = "2"
    VALUE_3 = "3"
...
@dataclass(kw_only=True)
class GenericPartDataValue:
    class Meta:
        name = "genericPartDataValue"
...
class OperationTypeAttType(Enum):
    OP01 = "op01"
    OP02 = "op02"
    OP03 = "op03"
    OP04 = "op04"
...
class ReasonForSelectionValueAttType(Enum):
    VALUE_0 = "0"
    VALUE_1 = "1"
    VALUE_2 = "2"
    VALUE_3 = "3"
...
class SelectOrManufactureValueAttType(Enum):
    F = "f"
    T = "t"
    M = "m"
    R = "r"
...
@dataclass(kw_only=True)
class AttachStoreShipPartElemType:
    class Meta:
        name = "attachStoreShipPartElemType"

    attach_store_ship_part_code: AttachStoreShipPartCodeAttType = field(
        metadata={
            "name": "attachStoreShipPartCode",
            "type": "Attribute",
        }
    )
    id: None | str = field(
...
@dataclass(kw_only=True)
class CategoryOneContainerLocationElemType:
    class Meta:
        name = "categoryOneContainerLocationElemType"
...
@dataclass(kw_only=True)
class DescrForLocationElemType:
    class Meta:
        name = "descrForLocationElemType"
...
@dataclass(kw_only=True)
class EffectivityElemType:
    class Meta:
        name = "effectivityElemType"
...
@dataclass(kw_only=True)
class GenericPartDataElemType:
    class Meta:
        name = "genericPartDataElemType"

    generic_part_data_value: GenericPartDataValue = field(
        metadata={
            "name": "genericPartDataValue",
            "type": "Element",
        }
    )
    generic_part_data_name: str = field(
        metadata={
            "name": "genericPartDataName",
            "type": "Attribute",
        }
    )
    change_type: None | ChangeTypeAttType = field(
...
@dataclass(kw_only=True)
class IlsNumberElemType:
    class Meta:
        name = "ilsNumberElemType"
...
@dataclass(kw_only=True)
class InitialProvisioningProjectElemType:
    class Meta:
        name = "initialProvisioningProjectElemType"

    initial_provisioning_project_number: str = field(
        metadata={
            "name": "initialProvisioningProjectNumber",
            "type": "Attribute",
        }
    )
    initial_provisioning_project_number_subject: str = field(
        metadata={
            "name": "initialProvisioningProjectNumberSubject",
            "type": "Attribute",
        }
    )
    file_ident: None | FileIdentAttType = field(
        default=None,
        metadata={
            "name": "fileIdent",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class InitialProvisioningProjectRefElemType:
    class Meta:
        name = "initialProvisioningProjectRefElemType"
...
@dataclass(kw_only=True)
class InterchangeabilityElemType:
    class Meta:
        name = "interchangeabilityElemType"
...
@dataclass(kw_only=True)
class NotIllustratedElemType:
    class Meta:
        name = "notIllustratedElemType"
...
@dataclass(kw_only=True)
class QuantityPerNextHigherAssyElemType:
    class Meta:
        name = "quantityPerNextHigherAssyElemType"
...
@dataclass(kw_only=True)
class ReasonForSelectionElemType:
    class Meta:
        name = "reasonForSelectionElemType"

    reason_for_selection_value: ReasonForSelectionValueAttType = field(
        metadata={
            "name": "reasonForSelectionValue",
            "type": "Attribute",
        }
    )
    id: None | str = field(
...
@dataclass(kw_only=True)
class RemovalOrInstallationQuantityElemType:
    class Meta:
        name = "removalOrInstallationQuantityElemType"
...
@dataclass(kw_only=True)
class RestrictedOperationNoteElemType:
    class Meta:
        name = "restrictedOperationNoteElemType"

    operation_type: None | OperationTypeAttType = field(
        default=None,
        metadata={
            "name": "operationType",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class SelectOrManufactureElemType:
    class Meta:
        name = "selectOrManufactureElemType"
...
@dataclass(kw_only=True)
class ServiceElemType:
    class Meta:
        name = "serviceElemType"
...
@dataclass(kw_only=True)
class SourceMaintRecoverabilityElemType:
    class Meta:
        name = "sourceMaintRecoverabilityElemType"
...
@dataclass(kw_only=True)
class TotalQuantityElemType:
    class Meta:
        name = "totalQuantityElemType"
...
@dataclass(kw_only=True)
class UsableOnCodeAssyElemType:
    class Meta:
        name = "usableOnCodeAssyElemType"
...
@dataclass(kw_only=True)
class UsableOnCodeEquipElemType:
    class Meta:
        name = "usableOnCodeEquipElemType"
...
@dataclass(kw_only=True)
class AttachStoreShipPart(AttachStoreShipPartElemType):
    class Meta:
        name = "attachStoreShipPart"
...
@dataclass(kw_only=True)
class CategoryOneContainerLocation(CategoryOneContainerLocationElemType):
    class Meta:
        name = "categoryOneContainerLocation"
...
@dataclass(kw_only=True)
class DescrForLocation(DescrForLocationElemType):
    class Meta:
        name = "descrForLocation"
...
@dataclass(kw_only=True)
class Effectivity(EffectivityElemType):
    class Meta:
        name = "effectivity"
...
@dataclass(kw_only=True)
class GenericPartData(GenericPartDataElemType):
    class Meta:
        name = "genericPartData"
...
@dataclass(kw_only=True)
class IlsNumber(IlsNumberElemType):
    class Meta:
        name = "ilsNumber"
...
@dataclass(kw_only=True)
class InitialProvisioningProject(InitialProvisioningProjectElemType):
    class Meta:
        name = "initialProvisioningProject"


@dataclass(kw_only=True)
class InitialProvisioningProjectRef(InitialProvisioningProjectRefElemType):
    class Meta:
        name = "initialProvisioningProjectRef"
...
@dataclass(kw_only=True)
class Interchangeability(InterchangeabilityElemType):
    class Meta:
...
@dataclass(kw_only=True)
class NotIllustrated(NotIllustratedElemType):
    class Meta:
        name = "notIllustrated"
...
@dataclass(kw_only=True)
class QuantityPerNextHigherAssy(QuantityPerNextHigherAssyElemType):
    class Meta:
        name = "quantityPerNextHigherAssy"
...
@dataclass(kw_only=True)
class ReasonForSelection(ReasonForSelectionElemType):
    class Meta:
        name = "reasonForSelection"


@dataclass(kw_only=True)
class RemovalOrInstallationQuantity(RemovalOrInstallationQuantityElemType):
    class Meta:
        name = "removalOrInstallationQuantity"
...
@dataclass(kw_only=True)
class RestrictedOperationNote(RestrictedOperationNoteElemType):
    class Meta:
        name = "restrictedOperationNote"
...
@dataclass(kw_only=True)
class SelectOrManufacture(SelectOrManufactureElemType):
    class Meta:
        name = "selectOrManufacture"


@dataclass(kw_only=True)
class Service(ServiceElemType):
    class Meta:
        name = "service"
...
@dataclass(kw_only=True)
class SourceMaintRecoverability(SourceMaintRecoverabilityElemType):
    class Meta:
        name = "sourceMaintRecoverability"
...
@dataclass(kw_only=True)
class TotalQuantity(TotalQuantityElemType):
    class Meta:
        name = "totalQuantity"
...
@dataclass(kw_only=True)
class UsableOnCodeAssy(UsableOnCodeAssyElemType):
    class Meta:
        name = "usableOnCodeAssy"


@dataclass(kw_only=True)
class UsableOnCodeEquip(UsableOnCodeEquipElemType):
    class Meta:
        name = "usableOnCodeEquip"
...
@dataclass(kw_only=True)
class ApplicabilitySegmentElemType:
    class Meta:
        name = "applicabilitySegmentElemType"

    usable_on_code_equip: list[UsableOnCodeEquip] = field(
        default_factory=list,
        metadata={
            "name": "usableOnCodeEquip",
            "type": "Element",
    ...
    usable_on_code_assy: list[UsableOnCodeAssy] = field(
        default_factory=list,
        metadata={
            "name": "usableOnCodeAssy",
            "type": "Element",
    ...
    interchangeability: None | Interchangeability = field(
        default=None,
        metadata={
            "type": "Element",
        },
    )
    restricted_operation_note: list[RestrictedOperationNote] = field(
        default_factory=list,
        metadata={
            "name": "restrictedOperationNote",
            "type": "Element",
...
@dataclass(kw_only=True)
class GenericPartDataGroupElemType:
    class Meta:
        name = "genericPartDataGroupElemType"

    generic_part_data: list[GenericPartData] = field(
        default_factory=list,
        metadata={
            "name": "genericPartData",
            "type": "Element",
...
@dataclass(kw_only=True)
class ModelVersionElemType:
    class Meta:
        name = "modelVersionElemType"
    ...
    model_version_value: str = field(
        metadata={
            "name": "modelVersionValue",
            "type": "Attribute",
        }
    )
    change_type: None | ChangeTypeAttType = field(
...
@dataclass(kw_only=True)
class SelectOrManufactureFromIdentElemType:
    class Meta:
        name = "selectOrManufactureFromIdentElemType"

    select_or_manufacture: None | SelectOrManufacture = field(
        default=None,
        metadata={
            "name": "selectOrManufacture",
            "type": "Element",
    ...
    select_or_manufacture_value: SelectOrManufactureValueAttType = field(
        metadata={
            "name": "selectOrManufactureValue",
            "type": "Attribute",
        }
    )
    id: None | str = field(
...
@dataclass(kw_only=True)
class ApplicabilitySegment(ApplicabilitySegmentElemType):
    class Meta:
        name = "applicabilitySegment"
...
@dataclass(kw_only=True)
class GenericPartDataGroup(GenericPartDataGroupElemType):
    class Meta:
        name = "genericPartDataGroup"
...
@dataclass(kw_only=True)
class ModelVersion(ModelVersionElemType):
    class Meta:
        name = "modelVersion"
...
@dataclass(kw_only=True)
class SelectOrManufactureFromIdent(SelectOrManufactureFromIdentElemType):
    class Meta:
        name = "selectOrManufactureFromIdent"
...
@dataclass(kw_only=True)
class LocationRcmdElemType:
    class Meta:
        name = "locationRcmdElemType"
    ...
    source_maint_recoverability: SourceMaintRecoverability = field(
        metadata={
            "name": "sourceMaintRecoverability",
            "type": "Element",
        }
...
@dataclass(kw_only=True)
class LocationRcmd(LocationRcmdElemType):
    class Meta:
        name = "locationRcmd"
...
@dataclass(kw_only=True)
class LocationRcmdSegmentElemType:
    class Meta:
        name = "locationRcmdSegmentElemType"

    location_rcmd: list[LocationRcmd] = field(
        default_factory=list,
        metadata={
            "name": "locationRcmd",
            "type": "Element",
...
@dataclass(kw_only=True)
class LocationRcmdSegment(LocationRcmdSegmentElemType):
    class Meta:
        name = "locationRcmdSegment"
...
@dataclass(kw_only=True)
class ReferToElemType:
    class Meta:
        name = "referToElemType"

    initial_provisioning_project_ref: list[InitialProvisioningProjectRef] = (
        field(
            default_factory=list,
            metadata={
                "name": "initialProvisioningProjectRef",
    ...
    ref_type: None | RefTypeAttType = field(
        default=None,
        metadata={
            "name": "refType",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class ZoneGroupElemType:
    class Meta:
        name = "zoneGroupElemType"
...
@dataclass(kw_only=True)
class ZoneGroup(ZoneGroupElemType):
    class Meta:
        name = "zoneGroup"
...
@dataclass(kw_only=True)
class PartLocationSegmentElemType:
    class Meta:
        name = "partLocationSegmentElemType"

    attach_store_ship_part: None | AttachStoreShipPart = field(
        default=None,
        metadata={
            "name": "attachStoreShipPart",
            "type": "Element",
    ...
    not_illustrated: None | NotIllustrated = field(
        default=None,
        metadata={
            "name": "notIllustrated",
            "type": "Element",
    ...
    select_or_manufacture_from_ident: None | SelectOrManufactureFromIdent = (
        field(
            default=None,
            metadata={
                "name": "selectOrManufactureFromIdent",
    ...
    descr_for_location: None | DescrForLocation = field(
        default=None,
        metadata={
            "name": "descrForLocation",
            "type": "Element",
...
@dataclass(kw_only=True)
class PartLocationSegment(PartLocationSegmentElemType):
    class Meta:
        name = "partLocationSegment"
...
@dataclass(kw_only=True)
class PartSegmentElemType:
    class Meta:
        name = "partSegmentElemType"
...
@dataclass(kw_only=True)
class PartSegment(PartSegmentElemType):
    class Meta:
        name = "partSegment"


@dataclass(kw_only=True)
class ItemSeqNumberElemType:
    class Meta:
        name = "itemSeqNumberElemType"

    reason_for_selection: None | ReasonForSelection = field(
        default=None,
        metadata={
            "name": "reasonForSelection",
            "type": "Element",
    ...
    quantity_per_next_higher_assy: QuantityPerNextHigherAssy = field(
        metadata={
            "name": "quantityPerNextHigherAssy",
            "type": "Element",
        }
    ...
    removal_or_installation_quantity: None | RemovalOrInstallationQuantity = (
        field(
            default=None,
            metadata={
                "name": "removalOrInstallationQuantity",
    ...
    part_ref: PartRef = field(
        metadata={
            "name": "partRef",
            "type": "Element",
        }
    )
    part_segment: None | PartSegment = field(
        default=None,
        metadata={
            "name": "partSegment",
            "type": "Element",
    ...
    part_location_segment: None | PartLocationSegment = field(
        default=None,
        metadata={
            "name": "partLocationSegment",
            "type": "Element",
    ...
    applicability_segment: None | ApplicabilitySegment = field(
        default=None,
        metadata={
            "name": "applicabilitySegment",
            "type": "Element",
    ...
    category_one_container_location: None | CategoryOneContainerLocation = (
        field(
            default=None,
            metadata={
                "name": "categoryOneContainerLocation",
    ...
    location_rcmd_segment: list[LocationRcmdSegment] = field(
        default_factory=list,
        metadata={
            "name": "locationRcmdSegment",
            "type": "Element",
    ...
    ils_number: list[IlsNumber] = field(
        default_factory=list,
        metadata={
            "name": "ilsNumber",
            "type": "Element",
    ...
    generic_part_data_group: None | GenericPartDataGroup = field(
        default=None,
        metadata={
            "name": "genericPartDataGroup",
            "type": "Element",
    ...
    item_seq_number_value: str = field(
        metadata={
            "name": "itemSeqNumberValue",
            "type": "Attribute",
        }
    ...
    part_characteristic: list[str] = field(
        default_factory=list,
        metadata={
            "name": "partCharacteristic",
            "type": "Attribute",
            "pattern": r"pc\d{2}( pc\d{2})*",
            "tokens": True,
        },
    )
    part_status: None | PartStatusAttType = field(
        default=None,
        metadata={
            "name": "partStatus",
            "type": "Attribute",
...
@dataclass(kw_only=True)
class ItemSeqNumber(ItemSeqNumberElemType):
    class Meta:
        name = "itemSeqNumber"
...
@dataclass(kw_only=True)
class CatalogSeqNumberElemType:
    class Meta:
        name = "catalogSeqNumberElemType"
    ...
    item_seq_number: list[ItemSeqNumber] = field(
        default_factory=list,
        metadata={
            "name": "itemSeqNumber",
            "type": "Element",
...
@dataclass(kw_only=True)
class CatalogSeqNumber(CatalogSeqNumberElemType):
    class Meta:
...
@dataclass(kw_only=True)
class IllustratedPartsCatalogElemType:
    class Meta:
        name = "illustratedPartsCatalogElemType"
    ...
    initial_provisioning_project: None | InitialProvisioningProject = field(
        default=None,
        metadata={
            "name": "initialProvisioningProject",
            "type": "Element",
    ...
    zone_group: None | ZoneGroup = field(
        default=None,
        metadata={
            "name": "zoneGroup",
            "type": "Element",
    ...
    catalog_seq_number: list[CatalogSeqNumber] = field(
        default_factory=list,
        metadata={
            "name": "catalogSeqNumber",
            "type": "Element",
...
@dataclass(kw_only=True)
class IllustratedPartsCatalog(IllustratedPartsCatalogElemType):
    class Meta:
        name = "illustratedPartsCatalog"
...
class ContentElemType:
    ...
    illustrated_parts_catalog: IllustratedPartsCatalog = field(
        metadata={
            "name": "illustratedPartsCatalog",
            "type": "Element",
        }
