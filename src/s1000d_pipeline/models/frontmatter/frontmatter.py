...
@dataclass(kw_only=True)
class BarCodeSymbolElemType:
    class Meta:
        name = "barCodeSymbolElemType"
...
class BarCodeSymbologyAttType(Enum):
    BCS01 = "bcs01"
    BCS02 = "bcs02"
    BCS03 = "bcs03"
    BCS04 = "bcs04"
...
class FrontMatterInfoTypeAttType(Enum):
    FMI01 = "fmi01"
    FMI02 = "fmi02"
    FMI03 = "fmi03"
    FMI04 = "fmi04"
...
class FrontMatterTypeAttType(Enum):
    FM01 = "fm01"
    FM02 = "fm02"
    FM03 = "fm03"
    FM04 = "fm04"
...
@dataclass(kw_only=True)
class BarCodeCodeElemType:
    class Meta:
        name = "barCodeCodeElemType"

    bar_code_value: str = field(
        metadata={
            "name": "barCodeValue",
            "type": "Attribute",
        }
    )
    bar_code_symbology: BarCodeSymbologyAttType = field(
        metadata={
...
@dataclass(kw_only=True)
class BarCodeSymbol(BarCodeSymbolElemType):
    class Meta:
        name = "barCodeSymbol"
...
@dataclass(kw_only=True)
class BarCodeCode(BarCodeCodeElemType):
    class Meta:
        name = "barCodeCode"
...
@dataclass(kw_only=True)
class BarCodeElemType:
    class Meta:
        name = "barCodeElemType"

    bar_code_code: None | BarCodeCode = field(
        default=None,
        metadata={
            "name": "barCodeCode",
            "type": "Element",
    ...
    bar_code_symbol: None | BarCodeSymbol = field(
        default=None,
        metadata={
            "name": "barCodeSymbol",
            "type": "Element",
...
@dataclass(kw_only=True)
class ModelNameElemType:
    class Meta:
        name = "modelNameElemType"
...
@dataclass(kw_only=True)
class ProductIntroNameElemType:
    class Meta:
        name = "productIntroNameElemType"
...
@dataclass(kw_only=True)
class ProductNameElemType:
    class Meta:
        name = "productNameElemType"
...
@dataclass(kw_only=True)
class EnterpriseLogo(LogoElemType):
    class Meta:
        name = "enterpriseLogo"
...
@dataclass(kw_only=True)
class ModelName(ModelNameElemType):
    class Meta:
        name = "modelName"
...
@dataclass(kw_only=True)
class ProductIntroName(ProductIntroNameElemType):
    class Meta:
        name = "productIntroName"


@dataclass(kw_only=True)
class ProductName(ProductNameElemType):
    class Meta:
        name = "productName"


@dataclass(kw_only=True)
class PublisherLogo(LogoElemType):
    class Meta:
        name = "publisherLogo"
...
@dataclass(kw_only=True)
class ProductModelElemType:
    class Meta:
        name = "productModelElemType"
    ...
    ident_number: None | IdentNumber = field(
        default=None,
        metadata={
            "name": "identNumber",
            "type": "Element",
    ...
    end_item_code: None | EndItemCode = field(
        default=None,
        metadata={
            "name": "endItemCode",
            "type": "Element",
...
@dataclass(kw_only=True)
class ProductModel(ProductModelElemType):
    class Meta:
        name = "productModel"
...
@dataclass(kw_only=True)
class ProductAndModelElemType:
    class Meta:
        name = "productAndModelElemType"
    ...
    product_model: list[ProductModel] = field(
        default_factory=list,
        metadata={
            "name": "productModel",
            "type": "Element",
...
@dataclass(kw_only=True)
class ProductAndModel(ProductAndModelElemType):
    class Meta:
...
@dataclass(kw_only=True)
class ReducedListItemParaElemType:
    class Meta:
        name = "reducedListItemParaElemType"
...
@dataclass(kw_only=True)
class ReducedListItemPara(ReducedListItemParaElemType):
    class Meta:
        name = "reducedListItemPara"
...
@dataclass(kw_only=True)
class ReducedRandomListItemElemType:
    class Meta:
        name = "reducedRandomListItemElemType"

    reduced_list_item_para: list[ReducedListItemPara] = field(
        default_factory=list,
        metadata={
            "name": "reducedListItemPara",
            "type": "Element",
...
@dataclass(kw_only=True)
class TocEntryElemType:
    class Meta:
        name = "tocEntryElemType"
    ...
    number_of_pages: list[NumberOfPages] = field(
        default_factory=list,
        metadata={
            "name": "numberOfPages",
            "type": "Element",
...
@dataclass(kw_only=True)
class ReducedRandomListItem(ReducedRandomListItemElemType):
    class Meta:
        name = "reducedRandomListItem"


@dataclass(kw_only=True)
class TocEntry(TocEntryElemType):
    class Meta:
        name = "tocEntry"
...
@dataclass(kw_only=True)
class FrontMatterDmEntryElemType:
    class Meta:
        name = "frontMatterDmEntryElemType"

    simple_para: None | SimplePara = field(
        default=None,
        metadata={
            "name": "simplePara",
            "type": "Element",
    ...
    reason_for_update: None | ReasonForUpdate = field(
        default=None,
        metadata={
            "name": "reasonForUpdate",
            "type": "Element",
    ...
    number_of_pages: None | NumberOfPages = field(
        default=None,
        metadata={
            "name": "numberOfPages",
            "type": "Element",
...
@dataclass(kw_only=True)
class FrontMatterExternalPubEntryElemType:
    class Meta:
        name = "frontMatterExternalPubEntryElemType"
...
@dataclass(kw_only=True)
class FrontMatterPmEntryElemType:
    class Meta:
        name = "frontMatterPmEntryElemType"
...
@dataclass(kw_only=True)
class ProductIllustrationElemType:
    class Meta:
        name = "productIllustrationElemType"
...
@dataclass(kw_only=True)
class ReducedRandomListElemType:
    class Meta:
        name = "reducedRandomListElemType"

    reduced_random_list_item: list[ReducedRandomListItem] = field(
        default_factory=list,
        metadata={
            "name": "reducedRandomListItem",
            "type": "Element",
...
@dataclass(kw_only=True)
class TocListElemType:
    class Meta:
        name = "tocListElemType"
...
@dataclass(kw_only=True)
class FrontMatterDmEntry(FrontMatterDmEntryElemType):
    class Meta:
        name = "frontMatterDmEntry"


@dataclass(kw_only=True)
class FrontMatterExternalPubEntry(FrontMatterExternalPubEntryElemType):
    class Meta:
        name = "frontMatterExternalPubEntry"


@dataclass(kw_only=True)
class FrontMatterPmEntry(FrontMatterPmEntryElemType):
    class Meta:
        name = "frontMatterPmEntry"


@dataclass(kw_only=True)
class ProductIllustration(ProductIllustrationElemType):
    class Meta:
        name = "productIllustration"


@dataclass(kw_only=True)
class ReducedRandomList(ReducedRandomListElemType):
    class Meta:
        name = "reducedRandomList"


@dataclass(kw_only=True)
class TocList(TocListElemType):
    class Meta:
        name = "tocList"
...
@dataclass(kw_only=True)
class ReducedParaElemType:
    class Meta:
        name = "reducedParaElemType"
...
@dataclass(kw_only=True)
class ReducedPara(ReducedParaElemType):
    class Meta:
        name = "reducedPara"
...
@dataclass(kw_only=True)
class FrontMatterInfoElemType:
    class Meta:
        name = "frontMatterInfoElemType"
    ...
    reduced_para: list[ReducedPara] = field(
        default_factory=list,
        metadata={
            "name": "reducedPara",
            "type": "Element",
    ...
    front_matter_info_type: None | FrontMatterInfoTypeAttType = field(
        default=None,
        metadata={
            "name": "frontMatterInfoType",
            "type": "Attribute",
        },
    )
...
@dataclass(kw_only=True)
class FrontMatterSubListElemType:
    class Meta:
        name = "frontMatterSubListElemType"
    ...
    front_matter_dm_entry: list[FrontMatterDmEntry] = field(
        default_factory=list,
        metadata={
            "name": "frontMatterDmEntry",
            "type": "Element",
    ...
    front_matter_pm_entry: list[FrontMatterPmEntry] = field(
        default_factory=list,
        metadata={
            "name": "frontMatterPmEntry",
            "type": "Element",
    ...
    front_matter_external_pub_entry: list[FrontMatterExternalPubEntry] = field(
        default_factory=list,
        metadata={
            "name": "frontMatterExternalPubEntry",
            "type": "Element",
...
@dataclass(kw_only=True)
class FrontMatterTableOfContentElemType:
    class Meta:
        name = "frontMatterTableOfContentElemType"
...
@dataclass(kw_only=True)
class FrontMatterInfo(FrontMatterInfoElemType):
    class Meta:
        name = "frontMatterInfo"


@dataclass(kw_only=True)
class FrontMatterSubList(FrontMatterSubListElemType):
    class Meta:
        name = "frontMatterSubList"


@dataclass(kw_only=True)
class FrontMatterTableOfContent(FrontMatterTableOfContentElemType):
    class Meta:
        name = "frontMatterTableOfContent"


@dataclass(kw_only=True)
class FrontMatterListElemType:
    class Meta:
        name = "frontMatterListElemType"
    ...
    front_matter_sub_list: list[FrontMatterSubList] = field(
        default_factory=list,
        metadata={
            "name": "frontMatterSubList",
            "type": "Element",
    ...
    front_matter_type: FrontMatterTypeAttType = field(
        metadata={
...
@dataclass(kw_only=True)
class FrontMatterList(FrontMatterListElemType):
    class Meta:
        name = "frontMatterList"
...
@dataclass(kw_only=True)
class FrontMatterTitlePageElemType:
    class Meta:
        name = "frontMatterTitlePageElemType"

    product_intro_name: None | ProductIntroName = field(
        default=None,
        metadata={
            "name": "productIntroName",
            "type": "Element",
    ...
    external_pub_code: list[ExternalPubCode] = field(
        default_factory=list,
        metadata={
            "name": "externalPubCode",
            "type": "Element",
    ...
    product_and_model: list[ProductAndModel] = field(
        default_factory=list,
        metadata={
            "name": "productAndModel",
            "type": "Element",
    ...
    data_restrictions: None | DataRestrictions = field(
        default=None,
        metadata={
            "name": "dataRestrictions",
            "type": "Element",
    ...
    product_illustration: None | ProductIllustration = field(
        default=None,
        metadata={
            "name": "productIllustration",
            "type": "Element",
    ...
    enterprise_logo: None | EnterpriseLogo = field(
        default=None,
        metadata={
            "name": "enterpriseLogo",
            "type": "Element",
    ...
    publisher_logo: None | PublisherLogo = field(
        default=None,
        metadata={
            "name": "publisherLogo",
            "type": "Element",
    ...
    front_matter_info: list[FrontMatterInfo] = field(
        default_factory=list,
        metadata={
            "name": "frontMatterInfo",
            "type": "Element",
...
@dataclass(kw_only=True)
class FrontMatterTitlePage(FrontMatterTitlePageElemType):
    class Meta:
        name = "frontMatterTitlePage"


@dataclass(kw_only=True)
class FrontMatterElemType:
    class Meta:
        name = "frontMatterElemType"

    front_matter_title_page: None | FrontMatterTitlePage = field(
        default=None,
        metadata={
            "name": "frontMatterTitlePage",
            "type": "Element",
    ...
    front_matter_table_of_content: None | FrontMatterTableOfContent = field(
        default=None,
        metadata={
            "name": "frontMatterTableOfContent",
            "type": "Element",
    ...
    front_matter_list: None | FrontMatterList = field(
        default=None,
        metadata={
            "name": "frontMatterList",
            "type": "Element",
...
@dataclass(kw_only=True)
class FrontMatter(FrontMatterElemType):
    class Meta:
        name = "frontMatter"
